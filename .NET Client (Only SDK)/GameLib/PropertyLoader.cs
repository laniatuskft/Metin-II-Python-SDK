...
public class CPropertyLoader : CDir
{
		public CPropertyLoader()
		{
		...
		public void SetPropertyManager(CPropertyManager pPropertyManager)
		{
			m_pPropertyManager = pPropertyManager;
		}

		public uint RegisterFile(string c_szPathName, string c_szFileName)
		{
			string strFileName = "";
			...
			string stExt = "";
			GetFileExtension(strFileName, strFileName.Length, stExt);

			stl_lowers(stExt);
			stl_lowers(strFileName);
			StringPath(strFileName);

			if (0 == string.CompareOrdinal(strFileName, "property/reserve"))
			{
				m_pPropertyManager.LoadReservedCRC(strFileName);
				return 1;
			}
			else
			{
				...
				if (m_pPropertyManager.Register(strFileName, pProperty))
				{
		...
		public virtual bool OnFolder(string c_szFilter, string c_szPathName, string c_szFileName)
		{
			string stPathName = "";
			...
			PropertyLoader.Create(c_szFilter, stPathName);
			return true;
		}

		public virtual bool OnFile(string c_szPathName, string c_szFileName)
		{
			RegisterFile(c_szPathName, c_szFileName);
			return true;
		}

		protected CPropertyManager m_pPropertyManager;
}
