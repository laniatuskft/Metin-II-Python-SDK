...
public class CEmptyEventHandler : IEventHandler
{
		public CEmptyEventHandler()
		{
		}
		...
		public virtual void OnUseSkill(in SState c_rkState, uint uMotSkill, uint uMotLoopCount)
		{
		}

		public virtual void OnHit(uint uMotAttack, CActorInstance rkActorVictim, bool isSendPacket)
		{
		}
