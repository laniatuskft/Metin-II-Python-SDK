...
namespace prt
{
	...
	public class TPropertyBuilding
	{
		public string strName = "";
		public string strFileName = "";
		public string strAttributeDataFileName = "";
		public bool isShadowFlag;
	}

	public class TPropertyEffect
	{
		public string strName = "";
		public string strFileName = "";
	}

	public enum EAmbiencePlayType
	{
	...
	public class TPropertyAmbience
	{
		public string strName = "";
		public string strPlayType = "";

		public float fPlayInterval;
		public float fPlayIntervalVariation;
		public float fMaxVolumeAreaPercentage;
		public List<string> AmbienceSoundVector = new List<string>();
	}

	public class TPropertyDungeonBlock
	{
		public string strName = "";
		public string strFileName = "";
		public string strAttributeDataFileName = "";
...
public class SEnvironmentData
{
	public bool[] bDirLightsEnable = new bool[ENV_DIRLIGHT_NUM];
	public D3DLIGHT8[] DirLights = Arrays.InitializeWithDefaultInstances<D3DLIGHT8>(ENV_DIRLIGHT_NUM);
	public D3DMATERIAL8 Material = new D3DMATERIAL8();
	public bool bFogEnable;
	public bool bDensityFog;
...
//Original Metin2 CPlus Line: float GetFogNearDistance() const;
	public float GetFogNearDistance()
	{
		return m_fFogNearDistance;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: float GetFogFarDistance() const;
	public float GetFogFarDistance()
	{
		return m_fFogFarDistance;
	}

	public D3DXCOLOR FogColor = new D3DXCOLOR();

	public bool bFilteringEnable;
	public D3DXCOLOR FilteringColor = new D3DXCOLOR();
	public byte byFilteringAlphaSrc;
	public byte byFilteringAlphaDest;

	public float fWindStrength;
	public float fWindRandom;

	public _D3DVECTOR v3SkyBoxScale = new _D3DVECTOR();
	public bool bSkyBoxTextureRenderMode;

	public byte bySkyBoxGradientLevelUpper;
	public byte bySkyBoxGradientLevelLower;

	public string[] strSkyBoxFaceFileName = Arrays.InitializeStringArrayWithDefaultInstances(6);


	public D3DXVECTOR2 v2CloudScale = new D3DXVECTOR2();
	public float fCloudHeight;
	public D3DXVECTOR2 v2CloudTextureScale = new D3DXVECTOR2();
	public D3DXVECTOR2 v2CloudSpeed = new D3DXVECTOR2();
	public string strCloudTextureFileName = "";
	public TGradientColor CloudGradientColor = new TGradientColor();

	public List<TGradientColor> SkyBoxGradientColorVector = new List<TGradientColor>();

	public bool bLensFlareEnable;
	public D3DXCOLOR LensFlareBrightnessColor = new D3DXCOLOR();
	public float fLensFlareMaxBrightness;

	public bool bMainFlareEnable;
	public string strMainFlareTextureFileName = "";
	public float fMainFlareSize;

	public bool bReserve;
}


public class SScreenPosition
{
	public int x;
	public int y;
}

public class SCellPosition
{
	public SCellPosition()
	{
		this.x = 0;
		this.y = 0;
	}

	public SCellPosition(int x, int y)
	{
		this.x = x;
		this.y = y;
	}
