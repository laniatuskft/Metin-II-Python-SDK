...
public class IMobProto : CSingleton<IMobProto>
{
		public IMobProto()
		{
		}
...
//		virtual bool FindRaceType(uint eRace, ref uint puType);
}

//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
public class CActorInstance : IActorInstance, IFlyTargetableObject
{
...
//				static IEventHandler GetEmptyPtr();
				...
				public class SState
				{
					public TPixelPosition kPPosSelf = new TPixelPosition();
					public float fAdvRotSelf;
				}
				...
				public abstract void OnSyncing(in SState c_rkState);
				public abstract void OnWaiting(in SState c_rkState);
				public abstract void OnMoving(in SState c_rkState);
				public abstract void OnMove(in SState c_rkState);
				public abstract void OnStop(in SState c_rkState);
				public abstract void OnWarp(in SState c_rkState);
				public abstract void OnSetAffect(uint uAffect);
				public abstract void OnResetAffect(uint uAffect);
				public abstract void OnClearAffects();

				public abstract void OnAttack(in SState c_rkState, ushort wMotionIndex);
				public abstract void OnUseSkill(in SState c_rkState, uint uMotSkill, uint uMotLoopCount);

				public abstract void OnHit(uint uSkill, CActorInstance rkActorVictim, bool isSendPacket);

				public abstract void OnChangeShape();
		}

		private static IBackground GetBackground()
		{
...
//		static bool IsDirLine();
		...
		public class SReservingMotionNode
		{
			public EMotionPushType iMotionType = new EMotionPushType();

			public float fStartTime;
			public float fBlendTime;
			public float fDuration;
			public float fSpeedRatio;

			public uint dwMotionKey;
		}

		public class SCurrentMotionNode
		{
			public EMotionPushType iMotionType = new EMotionPushType();
			public uint dwMotionKey;

			public uint dwcurFrame;
		...
		public class SMotionEventInstance
		{
			public int iType;
			public int iMotionEventIndex;
			public float fStartingTime;

			public readonly CRaceMotionData.TMotionEventData c_pMotionData;
		}


		public class SCollisionPointInstance
		{
			public readonly NRaceData.TCollisionData c_pCollisionData;
			public bool isAttached;
			public uint dwModelIndex;
			public uint dwBoneIndex;
			public List<CDynamicSphereInstance> SphereInstanceVector = new List<CDynamicSphereInstance>();
		}

		public class SSplashArea
		{
			public bool isEnableHitProcess;
			public uint uSkill;
			public MOTION_KEY MotionKey = new MOTION_KEY();
			public float fDisappearingTime;
			public readonly NMotionEvent.SMotionEventDataAttack c_pAttackingEvent;
			public List<CDynamicSphereInstance> SphereInstanceVector = new List<CDynamicSphereInstance>();

			public THittedInstanceMap HittedInstanceMap = new THittedInstanceMap();
		}

		public class SHittingData
		{
			public byte byAttackingType;
			public uint dwMotionKey;
			public byte byEventIndex;
		}

		public enum EAttachEffect
		{
			EFFECT_LIFE_NORMAL,
		...
		public class TAttachingEffect
		{
			public uint dwEffectIndex;
			public int iBoneIndex;
			public uint dwModelIndex;
			public _D3DMATRIX matTranslation = new _D3DMATRIX();
			public bool isAttaching;

			public int iLifeType;
...
//		static void ShowDirectionLine(bool isVisible);
		...
		public void INSTANCEBASE_Transform()
		{
			if (m_pkHorse)
			{
		...
		public void INSTANCEBASE_Deform()
		{
			Deform();
			TraceProcess();
		}
		...
		public void Stop(float fBlendingTime = 0.15f)
		{
			__ClearMotion();
		...
		public void SetParalysis(bool isParalysis)
		{
			m_isParalysis = isParalysis;
		}

		public void SetFaint(bool isFaint)
		{
			m_isFaint = isFaint;
		}
		...
		public void SetResistFallen(bool isResistFallen)
		{
			m_isResistFallen = isResistFallen;
		}

		public void SetAttackSpeed(float fAtkSpd)
		{
			m_fAtkSpd = fAtkSpd;
		}

		public void SetMoveSpeed(float fMovSpd)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetMaterialAlpha(uint dwAlpha);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetMaterialColor(uint dwColor);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetEventHandler(IEventHandler pkEventHandler);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool SetRace(uint eRace);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetHair(uint eHair);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetVirtualID(uint dwVID);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetShape(uint eShape, float fSpecular = 0.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ChangeMaterial(string c_szFileName);

		public void SetComboType(ushort wComboType)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AttachWeapon(uint dwItemIndex, uint dwParentPartIndex = CRaceData::PART_MAIN, uint dwPartIndex = CRaceData::PART_WEAPON);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AttachWeapon(uint dwParentPartIndex, uint dwPartIndex, CItemData pItemData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AttachAcce(uint dwParentPartIndex, uint dwPartIndex, CItemData pItemData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AttachAcce(uint dwItemIndex, uint dwParentPartIndex, uint dwPartIndex);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void RefreshActorInstance();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint GetPartItemID(uint dwPartIndex);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetAttachingBoneName(uint dwPartIndex, string[] c_szBoneName);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdateAttachingInstances();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void DettachEffect(uint dwEID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint AttachEffectByName(uint dwParentPartIndex, string c_pszBoneName, string c_pszEffectFileName);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint AttachEffectByID(uint dwParentPartIndex, string c_pszBoneName, uint dwEffectID, _D3DVECTOR c_pv3Position = NULL, float fParticleScale = 1.0f, _D3DVECTOR c_pv3MeshScale = NULL);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint AttachSmokeEffect(uint eSmoke);
...
//		int GetMotionMode();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetLoopMotion(uint dwMotion, float fBlendTime = 0.1f, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool InterceptOnceMotion(uint dwMotion, float fBlendTime = 0.1f, uint uSkill = 0, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool InterceptLoopMotion(uint dwMotion, float fBlendTime = 0.1f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool PushOnceMotion(uint dwMotion, float fBlendTime = 0.1f, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool PushLoopMotion(uint dwMotion, float fBlendTime = 0.1f, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool CreateCollisionInstancePiece(uint dwAttachingModelIndex, NRaceData::TAttachingData c_pAttachingData, SCollisionPointInstance pPointInstance);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdatePointInstance();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdatePointInstance(SCollisionPointInstance pPointInstance);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool CheckCollisionDetection(System.Collections.Generic.List<CDynamicSphereInstance> c_pAttackingSphereVector, _D3DVECTOR pv3Position);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		virtual bool TestCollisionWithDynamicSphere(in CDynamicSphereInstance dsi);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool AvoidObject(in CGraphicObjectInstance c_rkBGObj);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool IsBlockObject(in CGraphicObjectInstance c_rkBGObj);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void BlockMovement();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool __TestObjectCollision(CGraphicObjectInstance c_pObjectInstance);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetBlendingPosition(in TPixelPosition c_rPosition, float fBlendingTime = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool ComboAttack(uint wMotionIndex, float fDirRot, float fBlendTime = 0.1f);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetBattleHitEffect(uint dwID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetBattleAttachEffect(uint dwID);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		_D3DVECTOR GetMovementVectorRef();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		_D3DVECTOR GetPositionVectorRef();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetCurPixelPosition(in TPixelPosition c_rkPPosCur);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetAtkPixelPosition(in TPixelPosition c_rkPPosAtk);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetSrcPixelPosition(in TPixelPosition c_rkPPosSrc);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetDstPixelPosition(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetDstPixelPositionZ(float z);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		TPixelPosition NEW_GetAtkPixelPositionRef();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		TPixelPosition NEW_GetCurPixelPositionRef();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		TPixelPosition NEW_GetSrcPixelPositionRef();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		TPixelPosition NEW_GetDstPixelPositionRef();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		TPixelPosition NEW_GetLastPixelPositionRef();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void GetPixelPosition(TPixelPosition pPixelPosition);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetPixelPosition(in TPixelPosition c_rPixelPos);
...
//		void LookAtFromXY(float x, float y, CActorInstance pDestInstance);
		...
		public void SetReachScale(float fScale)
		{
			m_fReachScale = fScale;
		}

		public void SetOwner(uint dwOwnerVID)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void MotionEventProcess(uint dwcurTime, int iIndex, CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetAddColor(in D3DXCOLOR c_rColor);
...
//		void RenderToShadowMap();
		...
		protected void __AdjustCollisionMovement(CGraphicObjectInstance c_pGraphicObjectInstance)
		{
			if (m_pkHorse)
			{
		...
		public void AdjustDynamicCollisionMovement(CActorInstance c_pActorInstance)
		{
			if (m_pkHorse)
			{
			...
			else
			{
				...
				for (; itMain != m_BodyPointInstanceList.end(); ++itMain)
				{
					...
					for (uint LaniatusDefVariables = 0; LaniatusDefVariables < c_rMainSphereVector.Count; ++i)
					{
						...
						{
							CSphereCollisionInstance s = new CSphereCollisionInstance();
							...
							_D3DVECTOR v3Delta = s.GetCollisionMovementAdjust(c_rMainSphere);
							m_v3Movement += v3Delta;
							c_rMainSphere.v3Position += v3Delta;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetWeaponTraceTexture(string szTextureName);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//		void UpdateAttribute();
		public bool IntersectDefendingSphere()
		{
			...
			{
				List<CDynamicSphereInstance> rSphereInstanceVector = it.SphereInstanceVector;

				List<CDynamicSphereInstance>.Enumerator it2 = rSphereInstanceVector.GetEnumerator();
				while (it2.MoveNext())
				{
					CDynamicSphereInstance rInstance = it2.Current;
					_D3DVECTOR v3SpherePosition = rInstance.v3Position;
					float fRadius = rInstance.fRadius;

					_D3DVECTOR v3Orig = new _D3DVECTOR();
					_D3DVECTOR v3Dir = new _D3DVECTOR();
					float fRange;
					ms_Ray.GetStartPoint(v3Orig);
					ms_Ray.GetDirection(v3Dir, fRange);

					_D3DVECTOR v3Distance = v3Orig - v3SpherePosition;
...
//		void HideAllAttachingEffect();
		public void ClearAttachingEffect()
		{
			__ClearAttachingEffect();
		}
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool IsFishing();
		public void SetFishingPosition(_D3DVECTOR rv3Position)
		{
			m_v3FishingPosition = rv3Position;
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		virtual _D3DVECTOR OnGetFlyTargetPosition();
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AddFlyTarget(in CFlyTarget cr_FlyTarget);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetFlyTarget(in CFlyTarget cr_FlyTarget);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//		bool CanChangeTarget();
		...
		protected IFlyEventHandler m_pFlyEventHandler;

		public void MountHorse(CActorInstance pkHorse)
		{
			m_pkHorse = pkHorse;
...
//		void ComboProcess();
		...
		public void AccumulationMovement()
		{
			if (m_pkTree)
			{
				return;
...
//		void __MotionEventProcess(bool isPC);
		public void __AccumulationMovement(float fRot)
		{
			...
			_D3DMATRIX s_matRotationZ = new _D3DMATRIX();
			D3DXMatrixRotationZ(s_matRotationZ, ((fRot) * (((float) 3.141592654f) / 180.0f)));
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __Shake(uint dwDuration);

		protected CFlyTarget m_kFlyTarget = new CFlyTarget();
		protected CFlyTarget m_kBackupFlyTarget = new CFlyTarget();
		protected LinkedList<CFlyTarget> m_kQue_kFlyTarget = new LinkedList<CFlyTarget>();
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float GetMotionDuration(uint dwMotionKey);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool InterceptMotion(EMotionPushType iMotionType, ushort wMotion, float fBlendTime = 0.1f, uint uSkill = 0, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void PushMotion(EMotionPushType iMotionType, uint dwMotionKey, float fBlendTime, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventEffectEvent(CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventEffectToTargetEvent(CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventSpecialAttacking(int iMotionEventIndex, CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventSound(CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventFly(CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventWarp(CRaceMotionData::TMotionEventData c_pData);
#if ENABLE_WOLFMAN
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventUnk11(uint dwcurFrame, int iIndex, CRaceMotionData::TMotionEventData c_pData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessMotionEventUnk12(uint dwcurFrame, int iIndex, CRaceMotionData::TMotionEventData c_pData);
#endif

		protected void AddMovement(float fx, float fy, float fz)
		{
			m_v3Movement.x += fx;
			m_v3Movement.y += fy;
			m_v3Movement.z += fz;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool __IsLeftHandWeapon(uint type);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool __IsRightHandWeapon(uint type);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool __IsWeaponTrace(uint weaponType);

		protected void __InitializeMovement()
		{
			m_v3Movement.x = 0.0f;
			m_v3Movement.y = 0.0f;
			m_v3Movement.z = 0.0f;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __ProcessDataAttackSuccess(in NRaceData::TAttackData c_rAttackData, CActorInstance rVictim, in _D3DVECTOR c_rv3Position, uint uiSkill = 0, bool isSendPacket = TRUE);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __ProcessMotionEventAttackSuccess(uint dwMotionKey, byte byEventIndex, CActorInstance rVictim);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __ProcessMotionAttackSuccess(uint dwMotionKey, CActorInstance rVictim);
...
//		void __SetFallingDirection(float fx, float fy);
		...
		protected class SSetMotionData
		{
			public MOTION_KEY dwMotKey = new MOTION_KEY();
			public float fSpeedRatio;
			public float fBlendTime;
			public int iLoopCount;
			public uint uSkill;

			public SSetMotionData()
			{
				iLoopCount = 0;
				dwMotKey = 0;
				fSpeedRatio = 1.0f;
		...
		protected float __GetAttackSpeed()
		{
			return m_fAtkSpd;
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint __SetMotion(in SSetMotionData c_rkSetMotData, uint dwRandMotKey = 0);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __ClearMotion();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool __BindMotionData(uint dwMotionKey);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//		bool __IsStandUpMotion();
		protected bool __IsMountingHorse()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		ushort __GetCurrentMotionIndex();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint __GetCurrentMotionKey();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		int __GetLoopCount();
		protected ushort __GetCurrentComboType()
		{
			if (IsBowMode())
			{
				return 0;
...
//		bool __IsHiding();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool __IsMovingSkill(ushort wSkillNumber);

		protected float __GetReachScale()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		_D3DVECTOR __GetFlyTargetPosition();
...
//		void __HideWeaponTrace();
		...
		protected void OnUpdateCollisionData(List<CStaticCollisionData> pscdVector)
		{
...
//Original Metin2 CPlus Line: const CStaticCollisionData & c_rColliData = *it;
//# Laniatus Games Studio Inc. | TODO TASK: Iterators are only converted within the context of 'while' and 'for' loops:
				CStaticCollisionData c_rColliData = it;
				_D3DMATRIX c_rMatrix = GetTransform();
				AddCollision(c_rColliData, c_rMatrix);
			}
		}

		protected void OnUpdateHeighInstance(CAttributeInstance pAttributeInstance)
		{
			Debug.Assert(pAttributeInstance);
			SetHeightInstance(pAttributeInstance);
		}

		protected bool OnGetObjectHeight(float fX, float fY, ref float pfHeight)
		{
		...
		protected LinkedList<SReservingMotionNode> m_MotionDeque = new LinkedList<SReservingMotionNode>();
		protected SCurrentMotionNode m_kCurMotNode = new SCurrentMotionNode();
		protected ushort m_wcurMotionMode;

		protected LinkedList<SCollisionPointInstance> m_BodyPointInstanceList = new LinkedList<SCollisionPointInstance>();
		protected LinkedList<SCollisionPointInstance> m_DefendingPointInstanceList = new LinkedList<SCollisionPointInstance>();
		protected SSplashArea m_kSplashArea = new SSplashArea();
		protected CAttributeInstance m_pAttributeInstance;

		protected List<CWeaponTrace> m_WeaponTraceVector = new List<CWeaponTrace>();
		protected CPhysicsObject m_PhysicsObject = new CPhysicsObject();

		protected uint m_dwcurComboIndex;

		protected uint m_eActorType;

		protected uint m_eRace;
		protected uint m_eShape;
		protected uint m_eHair;
		protected bool m_isPreInput;
		protected bool m_isNextPreInput;
		protected uint m_dwcurComboBackMotionIndex;

		protected ushort m_wcurComboType;

		protected float m_fAtkDirRot;

		protected CRaceData m_pkCurRaceData;
		protected CRaceMotionData m_pkCurRaceMotionData;

		protected float m_fInvisibleTime;
		protected bool m_isHiding;

		protected bool m_isResistFallen;
		protected bool m_isSleep;
		protected bool m_isFaint;
		protected bool m_isParalysis;
		protected bool m_isStun;
		protected bool m_isRealDead;
		protected bool m_isWalking;
		protected bool m_isMain;

		protected uint m_dwBattleHitEffectID;
		protected uint m_dwBattleAttachEffectID;

		protected _D3DVECTOR m_v3FishingPosition = new _D3DVECTOR();
		protected int m_iFishingEffectID;

		protected float m_x;
		protected float m_y;
		protected float m_z;
		protected _D3DVECTOR m_v3Pos = new _D3DVECTOR();
		protected _D3DVECTOR m_v3Movement = new _D3DVECTOR();
		protected bool m_bNeedUpdateCollision;

		protected uint m_dwShakeTime;

		protected float m_fReachScale;
		protected float m_fMovSpd;
		protected float m_fAtkSpd;

		protected float m_fcurRotation;
		protected float m_rotBegin;
		protected float m_rotEnd;
		protected float m_rotEndTime;
		protected float m_rotBeginTime;
		protected float m_rotBlendTime;
		protected float m_fAdvancingRotation;
		protected float m_rotX;
		protected float m_rotY;

		protected float m_fOwnerBaseTime;

		protected int m_iRenderMode;
		protected D3DXCOLOR m_AddColor = new D3DXCOLOR();
		protected float m_fAlphaValue;

		protected uint[] m_adwPartItemID = new uint[CRaceData.PART_MAX_NUM];

		protected LinkedList<TAttachingEffect> m_AttachingEffectList = new LinkedList<TAttachingEffect>();
		protected bool m_bEffectInitialized;

		protected uint m_dwMtrlColor;
		protected uint m_dwMtrlAlpha;

		protected TPixelPosition m_kPPosCur = new TPixelPosition();
		protected TPixelPosition m_kPPosSrc = new TPixelPosition();
		protected TPixelPosition m_kPPosDst = new TPixelPosition();
		protected TPixelPosition m_kPPosAtk = new TPixelPosition();

		protected TPixelPosition m_kPPosLast = new TPixelPosition();

		protected readonly SortedDictionary<NRaceData.THitData , SortedDictionary<CActorInstance, float>> m_HitDataMap = new SortedDictionary<NRaceData.THitData , SortedDictionary<CActorInstance, float>>();

		protected CActorInstance m_pkHorse;
		protected CSpeedTreeWrapper m_pkTree;


		protected uint m_dwSelfVID;
		protected uint m_dwOwnerVID;


		protected void __InitializeStateData()
		{
		...
		protected void __InitializeMotionData()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		protected void __InitializeRotationData()
		{
			m_fAtkDirRot = 0.0f;
			m_fcurRotation = 0.0f;
			m_rotBegin = 0.0f;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __OnAttack(ushort wMotionIndex);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//		void __InitializeCollisionData();
		...
		protected bool m_canSkipCollision;

		protected class SBlendAlpha
		{
			public float m_fBaseTime;
			public float m_fBaseAlpha;
			public float m_fDuration;
			public float m_fDstAlpha;

			public uint m_iOldRenderMode;
			public bool m_isBlending;
		}
		protected SBlendAlpha m_kBlendAlpha = new SBlendAlpha();
...
//		bool __IsSyncing();
		...
		public void __CreateTree(string c_szFileName)
		{
			__DestroyTree();
		...
		public void __SetTreePosition(float fx, float fy, float fz)
		{
			if (!m_pkTree)
			{
				return;
		...
		protected IEventHandler m_pkEventHandler;

		protected static bool ms_isDirLine;

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetQuiverEquipped(bool bEquipped);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool IsEqippedQuiver() const
		public bool IsEqippedQuiver()
		{
			return m_bIsQuiverEquipped;
		}
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetQuiverEffectID(uint dwEffectID);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: uint GetQuiverEffectID() const
		public uint GetQuiverEffectID()
		{
			return m_dwQuiverEffectID;
		}

		protected bool m_bIsQuiverEquipped;
		protected uint m_dwQuiverEffectID;

		public void SetShowMonsterEffects(bool show)
		{
			m_bShowMonsterEffects = show;
		}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool IsShowMonsterEffects() const
		public bool IsShowMonsterEffects()
		{
			return m_bShowMonsterEffects;
		}
		protected bool m_bShowMonsterEffects;
