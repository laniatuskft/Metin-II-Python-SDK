...
public class CMonsterAreaInfo
{
	public enum EMonsterAreaInfoType
	{
		MONSTERAREAINFOTYPE_INVALID,
		MONSTERAREAINFOTYPE_MONSTER,
		MONSTERAREAINFOTYPE_GROUP
	}
	public enum EMonsterDir
	{
		DIR_RANDOM = 0,
		DIR_NORTH,
		DIR_NORTHEAST,
	...
	public void SetOrigin(int lOriginX, int lOriginY)
	{
		m_lOriginX = lOriginX;
		m_lOriginY = lOriginY;
		SetLRTB();
	...
	public void GetOrigin(ref int plOriginX, ref int plOriginY)
	{
		plOriginX = m_lOriginX;
		plOriginY = m_lOriginY;
	}

	public void SetSize(int lSizeX, int lSizeY)
	{
		m_lSizeX = lSizeX;
		m_lSizeY = lSizeY;
		SetLRTB();
	...
	public void GetSize(ref int plSizeX, ref int plSizeY)
	{
		plSizeX = m_lSizeX;
		plSizeY = m_lSizeY;
	}
	...
	public void SetMonsterAreaInfoType(EMonsterAreaInfoType eMonsterAreaInfoType)
	{
		m_eMonsterAreaInfoType = eMonsterAreaInfoType;
	}
	public EMonsterAreaInfoType GetMonsterAreaInfoType()
	{
		return m_eMonsterAreaInfoType;
	}

	public void SetMonsterGroupID(uint dwGroupID)
	{
		m_dwGroupID = dwGroupID;
	}
	public void SetMonsterGroupName(string strGroupName)
	{
		m_strGroupName = strGroupName;
	}
	public void SetMonsterGroupLeaderName(string strGroupLeaderName)
	{
		m_strLeaderName = strGroupLeaderName;
	}
	public void SetMonsterGroupFollowerCount(uint dwFollowerCount)
	{
		m_dwFollowerCount = dwFollowerCount;
	}

	public uint GetMonsterGroupID()
	{
		return m_dwGroupID;
	}
	...
	public string GetMonsterGroupLeaderName()
	{
		return m_strLeaderName;
	}
	public uint GetMonsterGroupFollowerCount()
	{
		return m_dwFollowerCount;
	}

	public void SetMonsterName(string strMonsterName)
	{
		m_strMonsterName = strMonsterName;
	}
	public void SetMonsterVID(uint dwVID)
	{
		m_dwVID = dwVID;
	}
	...
	public uint GetMonsterVID()
	{
		return m_dwVID;
	}

	public void SetMonsterCount(uint dwCount)
	{
	 ...
	 public void SetMonsterDirection(EMonsterDir eMonsterDir)
	 {
		 m_eMonsterDir = eMonsterDir;
		 D3DXMATRIX matRotation = new D3DXMATRIX();
		 D3DXVECTOR3 v3Direction = new D3DXVECTOR3(0.0f, 1.0f, 0.0f);
		 float fDegree = 0.0f;
	...
	public EMonsterDir GetMonsterDir()
	{
		return m_eMonsterDir;
	}
	public D3DXVECTOR2 GetMonsterDirVector()
	{
		return m_v2Monsterdirection;
	}
	public D3DXVECTOR2 GetTempMonsterPos(uint dwIndex)
	{
	...
	protected EMonsterAreaInfoType m_eMonsterAreaInfoType = new EMonsterAreaInfoType();

	protected uint m_dwGroupID;
	protected string m_strGroupName = "";
	protected string m_strLeaderName = "";
	protected uint m_dwFollowerCount;

	protected uint m_dwVID;
	protected string m_strMonsterName = "";

	protected uint m_dwMonsterCount;
	protected EMonsterDir m_eMonsterDir = new EMonsterDir();
	protected D3DXVECTOR2 m_v2Monsterdirection = new D3DXVECTOR2();

	protected uint m_dwID;

	protected int m_lOriginX;
	protected int m_lOriginY;
	protected int m_lSizeX;
	protected int m_lSizeY;

	protected int m_lLeft;
	protected int m_lRight;
	protected int m_lTop;
	protected int m_lBottom;

	protected List<D3DXVECTOR2> m_TempMonsterPosVector = new List<D3DXVECTOR2>();
}
