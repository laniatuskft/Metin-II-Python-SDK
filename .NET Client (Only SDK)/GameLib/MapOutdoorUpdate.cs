...
public class PCBlocker_CDynamicSphereInstanceVector
{

		public const int SIZE = 4;

		public PCBlocker_CDynamicSphereInstanceVector()
		{
		}
		public void Dispose()
		{
		...
		public CDynamicSphereInstance Begin()
		{
			return m_aDSI + 0;
		}
		public CDynamicSphereInstance End()
		{
			return m_aDSI + 4;
		}

		private CDynamicSphereInstance[] m_aDSI = Arrays.InitializeWithDefaultInstances<CDynamicSphereInstance>(4);
}



public class FGetShadowReceiverFromCollisionData
{
	public bool m_bCollide;
	public List<CGraphicObjectInstance > m_pkVct_pkShadowReceiver;
	public CDynamicSphereInstance m_pdsi;
	public FGetShadowReceiverFromCollisionData(CDynamicSphereInstance pdsi, List<CGraphicObjectInstance > pkVct_pkShadowReceiver)
	{
		this.m_pdsi = pdsi;
		this.m_bCollide = false;
...
public class FPCBlockerDistanceSort
{
	public _D3DVECTOR m_v3Eye = new _D3DVECTOR();
	public FPCBlockerDistanceSort(_D3DVECTOR v3Eye)
	{
		this.m_v3Eye = v3Eye;
	}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool operator ()(CGraphicObjectInstance * plhs, CGraphicObjectInstance * prhs) const
	public bool functorMethod(CGraphicObjectInstance plhs, CGraphicObjectInstance prhs)
	{
...
public class FGetShadowReceiverFromHeightData
{
	public const int COLLECT_MAX = 100;

	public uint m_dwCollectOverCount;
	public uint m_dwCollectCount;
	public uint m_dwCheckCount;
	public bool m_bReceiverFound;
	public float m_fFromX;
	public float m_fFromY;
	public float m_fToX;
	public float m_fToY;
	public float m_fReturnHeight;

	public CGraphicObjectInstance[] m_apkShadowReceiver = new CGraphicObjectInstance[COLLECT_MAX];

	public FGetShadowReceiverFromHeightData(float fFromX, float fFromY, float fToX, float fToY)
	{
		this.m_fFromX = fFromX;
		this.m_fFromY = fFromY;
		this.m_fToX = fToX;
		this.m_fToY = fToY;
		this.m_bReceiverFound = false;
		m_dwCheckCount = 0;
		m_dwCollectOverCount = 0;
		m_dwCollectCount = 0;
	}

	public CGraphicObjectInstance GetCollectItem(uint uIndex)
	{
...
public class PCBlocker_SInstanceList
{

	public const int CAPACITY = 512;

	public uint m_dwInstCount;
	public uint m_dwBlockerCount;
	public uint m_dwBlockerOverCount;

	public CGraphicObjectInstance[] m_apkPCBlocker = new CGraphicObjectInstance[CAPACITY];

	public PCBlocker_CDynamicSphereInstanceVector m_pkDSIVector;

	public CCamera m_pCamera;
	public D3DXVECTOR2 m_v2View = new D3DXVECTOR2();
	public D3DXVECTOR2 m_v2Target = new D3DXVECTOR2();

	public PCBlocker_SInstanceList(PCBlocker_CDynamicSphereInstanceVector pkDSIVector)
	{
		...
		_D3DVECTOR m_v3View = m_pCamera.GetView();
		_D3DVECTOR m_v3Target = m_pCamera.GetTarget();
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
	private uint __DEBUG_ShowInstanceMaxCount_s_dwInstMaxCount = 0;

	public void __DEBUG_ShowInstanceMaxCount()
	{
...
//		static uint s_dwInstMaxCount=0;
		if (__DEBUG_ShowInstanceMaxCount_s_dwInstMaxCount < m_dwInstCount)
		{
			__DEBUG_ShowInstanceMaxCount_s_dwInstMaxCount = m_dwInstCount;
		}
	}
...
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'Iterator' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
	...
	public void __AppendPCBlocker(CGraphicObjectInstance pInstance)
	{
	...
	public void __AppendObject(CGraphicObjectInstance pInstance)
	{
		_D3DVECTOR v3Center = new _D3DVECTOR();
		float fRadius;
		pInstance.GetBoundingSphere(v3Center, fRadius);

		D3DXVECTOR2 v2TargetToCenter = new D3DXVECTOR2();
...
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'Iterator' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
		PCBlocker_CDynamicSphereInstanceVector.Iterator LaniatusDefVariables = new PCBlocker_CDynamicSphereInstanceVector.Iterator();

		for (i = m_pkDSIVector.Begin(); LaniatusDefVariables != m_pkDSIVector.End(); ++i)
		{
//# Laniatus Games Studio Inc. | TODO TASK: C# does not have an equivalent to references to variables:
//Original Metin2 CPlus Line: CDynamicSphereInstance& rkDSI = *i;
