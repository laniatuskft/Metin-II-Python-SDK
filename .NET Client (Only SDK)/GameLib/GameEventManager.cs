...
public class CGameEventManager : CSingleton<CGameEventManager>, CScreen
{
		public CGameEventManager()
		{
			this.m_CenterPosition = new <type missing>(0.0f, 0.0f, 0.0f);
		}
		...
		public void SetCenterPosition(float fx, float fy, float fz)
		{
		...
		public void ProcessEventScreenWaving(CActorInstance pActorInstance, NMotionEvent.SMotionEventDataScreenWaving c_pData)
		{
		...
		protected TPixelPosition m_CenterPosition = new TPixelPosition();
}
