...
public class FAreaRenderShadow
{
...
public class FRenderPCBlocker
{
	public void functorMethod(CGraphicObjectInstance pInstance)
	{
		pInstance.Show();
		CGraphicThingInstance pThingInstance = pInstance as CGraphicThingInstance;
...
public class CMapOutdoor_LessThingInstancePtrRenderOrder
{
	public bool functorMethod(CGraphicThingInstance pkLeft, CGraphicThingInstance pkRight)
	{
		CCamera pCurrentCamera = CCameraManager.Instance().GetCurrentCamera();
		_D3DVECTOR c_rv3CameraPos = pCurrentCamera.GetEye();
		_D3DVECTOR c_v3LeftPos = pkLeft.GetPosition();
		_D3DVECTOR c_v3RightPos = pkRight.GetPosition();

		return D3DXVec3LengthSq(D3DXVECTOR3(c_rv3CameraPos - c_v3LeftPos)) < D3DXVec3LengthSq(D3DXVECTOR3(c_rv3CameraPos - c_v3RightPos));
	}
}

public class CMapOutdoor_FOpaqueThingInstanceRender
{
	public void functorMethod(CGraphicThingInstance pkThingInst)
	{
		pkThingInst.Render();
	}
}
public class CMapOutdoor_FBlendThingInstanceRender
{
	public void functorMethod(CGraphicThingInstance pkThingInst)
	{
...
public class FPatchNumMatch
{
	public int m_lPatchNumToCheck;
	public FPatchNumMatch(int lPatchNum)
	{
		m_lPatchNumToCheck = lPatchNum;
	}
	public bool functorMethod(Tuple<int, byte> aPair)
	{
		return m_lPatchNumToCheck == aPair.Item1;
	}
}
