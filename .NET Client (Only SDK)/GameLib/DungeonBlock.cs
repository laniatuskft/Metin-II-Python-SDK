...
public class CDungeonBlock : CGraphicObjectInstance
{
...
//Original Metin2 CPlus Line: int GetType() const
		...
		public void BuildBoundingSphere()
		{
			...
			m_fRadius = D3DXVec3Length((v3Max - v3Min)) * 0.5f + 150.0f;
		}
		...
		public bool Load(string c_szFileName)
		{
			...
			for (int LaniatusDefVariables = 0; LaniatusDefVariables < m_pThing.GetModelCount(); ++i)
			{
				...
				uint dwVertexCount = pModelInstance.GetVertexCount();
		...
		public bool Intersect(ref float pfu, ref float pfv, ref float pft)
		{
		...
		public void GetBoundBox(_D3DVECTOR pv3Min, _D3DVECTOR pv3Max)
		{
			...
			for (; itor != m_ModelInstanceContainer.end(); ++itor)
			{
				...
				pv3Min.x = Math.Min(v3Min.x, pv3Min.x);
				pv3Min.y = Math.Min(v3Min.x, pv3Min.y);
				pv3Min.z = Math.Min(v3Min.x, pv3Min.z);
				pv3Max.x = Math.Max(v3Max.x, pv3Max.x);
				pv3Max.y = Math.Max(v3Max.x, pv3Max.y);
				pv3Max.z = Math.Max(v3Max.x, pv3Max.z);
			}
		}
		...
		public bool GetBoundingSphere(ref _D3DVECTOR v3Center, ref float fRadius)
		{
			v3Center = m_v3Center;
			fRadius = m_fRadius;
		...
		public void OnUpdateCollisionData(List<CStaticCollisionData> pscdVector)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: Iterators are only converted within the context of 'while' and 'for' loops:
		...
		public void OnUpdateHeighInstance(CAttributeInstance pAttributeInstance)
		{
			Debug.Assert(pAttributeInstance);
			SetHeightInstance(pAttributeInstance);
		}

		public bool OnGetObjectHeight(float fX, float fY, ref float pfHeight)
		{
		...
		protected CGraphicThing m_pThing;
		protected List<CDungeonModelInstance > m_ModelInstanceContainer = new List<CDungeonModelInstance >();
		protected CGraphicVertexBuffer m_kDeformableVertexBuffer = new CGraphicVertexBuffer();
}
...
public class CDungeonModelInstance : CGrannyModelInstance
{
		public CDungeonModelInstance()
		{
		}
		public virtual void Dispose()
		{
		...
		public void RenderDungeonBlock()
		{
			if (IsEmpty())
			{
				return;
		...
		public void RenderDungeonBlockShadow()
		{
			...
			(CStateManager.Instance()).SaveRenderState(D3DRS_SRCBLEND, D3DBLEND_ZERO);
			(CStateManager.Instance()).SaveRenderState(D3DRS_DESTBLEND, D3DBLEND_SRCCOLOR);
...
public class FUpdate
{
	...
	public _D3DMATRIX pmatWorld;
	public void functorMethod(CGrannyModelInstance pInstance)
	{
...
{
	public void functorMethod(CDungeonModelInstance pInstance)
	{
...
{
	public _D3DVECTOR m_pv3Min;
	public _D3DVECTOR m_pv3Max;

	public FBoundBox(_D3DVECTOR pv3Min, _D3DVECTOR pv3Max)
	{
		m_pv3Min = pv3Min;
		m_pv3Max = pv3Max;
	}
