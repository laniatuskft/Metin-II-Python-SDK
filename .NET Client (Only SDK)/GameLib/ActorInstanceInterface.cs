...
public class IActorInstance : CGraphicThingInstance
{
	public const int ID = ACTOR_OBJECT;
...
//Original Metin2 CPlus Line: int GetType() const
	...
	public IActorInstance()
	{
	}
	public virtual void Dispose()
	{
	}
	public abstract bool TestCollisionWithDynamicSphere(in CDynamicSphereInstance dsi);
	public abstract uint GetVirtualID();
}