...
//	friend class CFlyTarget;
	...
	public abstract D3DXVECTOR3 OnGetFlyTargetPosition();
	public abstract void OnShootDamage();

	protected void ClearFlyTargeter()
	{
		SortedSet<CFlyTarget>.Enumerator it;
		for (it = m_FlyTargeterSet.begin(); it.MoveNext();)
		{
			it.Current.NotifyTargetClear();
		}
		m_FlyTargeterSet.clear();
	}

	private SortedSet<CFlyTarget> m_FlyTargeterSet = new SortedSet<CFlyTarget>();
	private void AddFlyTargeter(CFlyTarget pTargeter)
	{
		m_FlyTargeterSet.insert(pTargeter);
	}
	private void RemoveFlyTargeter(CFlyTarget pTargeter)
	{
		m_FlyTargeterSet.erase(pTargeter);
	}
}

public class CFlyTarget
{
	public enum EType
	{
		TYPE_NONE,
	...
	public CFlyTarget(IFlyTargetableObject pFlyTarget)
	{
		__Initialize();
	...
	public CFlyTarget(in D3DXVECTOR3 v3FlyTargetPosition)
	{
		__Initialize();
	...
	public CFlyTarget(in CFlyTarget rhs)
	{
		__Initialize();
...
//Original Metin2 CPlus Line: const D3DXVECTOR3 & GetFlyTargetPosition() const
	public D3DXVECTOR3 GetFlyTargetPosition()
	{
	...
	public CFlyTarget.EType GetType()
	{
		return m_eType;
	}

	public IFlyTargetableObject GetFlyTarget()
	{
		Debug.Assert(TYPE_OBJECT == GetType() && "CFly::GetFlyTarget");
		return m_pFlyTarget;
	}

//# Laniatus Games Studio Inc. |: This 'CopyFrom' method was converted from the original copy assignment operator:
//Original Metin2 CPlus Line: CFlyTarget & operator = (const CFlyTarget & rhs)
	public CFlyTarget CopyFrom (in CFlyTarget rhs)
	{
		if (m_pFlyTarget)
		{
			m_pFlyTarget.RemoveFlyTargeter(this);
	...
	public void GetFlyTargetData(CFlyTarget pFlyTarget)
	{
	...
	private D3DXVECTOR3 m_v3FlyTargetPosition = new D3DXVECTOR3();
	private IFlyTargetableObject m_pFlyTarget;

	private EType m_eType = new EType();
}
