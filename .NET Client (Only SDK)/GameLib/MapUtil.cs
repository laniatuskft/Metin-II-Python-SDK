...
public class CEaseOutInterpolation
{
		public CEaseOutInterpolation()
		{
			Initialize();
		}
		...
		public bool Setup(float fStart, float fEnd, float fTime)
		{
			if (Math.Abs(fTime) < FLT_EPSILON)
			{
				fTime = 0.01f;
			}
		...
		public void Interpolate(float fElapsedTime)
		{
		...
		protected float m_fStartValue;
		protected float m_fLastValue;
}