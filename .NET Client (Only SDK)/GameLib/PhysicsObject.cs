...
public class IPhysicsWorld
{
	public IPhysicsWorld()
	{
		Debug.Assert(ms_pWorld == null);
		ms_pWorld = this;
	}
	...
	public abstract bool isPhysicalCollision(in D3DXVECTOR3 c_rvCheckPosition);

	private static IPhysicsWorld ms_pWorld = null;
}
...
public class IObjectManager
{
	...
	{
		Debug.Assert(ms_ObjManager == null);
		ms_ObjManager = this;
	}
	...
	public abstract void AdjustCollisionWithOtherObjects(CActorInstance pInst);

	private static IObjectManager ms_ObjManager = null;
}

public class CPhysicsObject
{
		...
		public void SetDirection(in D3DXVECTOR3 c_rv3Direction)
		{
		...
		public void IncreaseExternalForce(in D3DXVECTOR3 c_rvBasePosition, float fForce)
		{
			...
			D3DXVECTOR3 v3Movement = new D3DXVECTOR3(0.0f, 0.0f, 0.0f);
			...
			for (int LaniatusDefVariables = 0; LaniatusDefVariables < LoopValue; ++i)
			{
				...
				if (Math.Abs(m_v3Velocity.x) < EPSILON && Math.Abs(m_v3Velocity.y) < EPSILON && Math.Abs(m_v3Velocity.z) < EPSILON)
				{
					break;
				}
			}
		...
		public void SetLastPosition(in TPixelPosition c_rPosition, float fBlendingTime)
		{
		...
		public void GetLastPosition(TPixelPosition pPosition)
		{
...
//		void ClearSavingMovement();
		...
		public void SetActorInstance(CActorInstance pInst)
		{
			m_pActorInstance = pInst;
		}
		public CActorInstance GetActorInstance()
		{
			return m_pActorInstance;
		}

		protected void Accumulate(D3DXVECTOR3 pv3Position)
		{
			float fForce = 0.0f;
		...
		protected float m_fFriction;
		protected D3DXVECTOR3 m_v3Direction = new D3DXVECTOR3();
		protected D3DXVECTOR3 m_v3Acceleration = new D3DXVECTOR3();
		protected D3DXVECTOR3 m_v3Velocity = new D3DXVECTOR3();

		protected D3DXVECTOR3 m_v3LastPosition = new D3DXVECTOR3();
		protected CEaseOutInterpolation m_xPushingPosition = new CEaseOutInterpolation();
		protected CEaseOutInterpolation m_yPushingPosition = new CEaseOutInterpolation();

		protected CActorInstance m_pActorInstance;
}