...
public class CRaceData
{
		...
		public const int RACE_WARRIOR_M = 0;
		public const int RACE_ASSASSIN_W = 1;
		public const int RACE_SURA_M = 2;
		public const int RACE_SHAMAN_W = 3;
		public const int RACE_WARRIOR_W = 4;
		public const int RACE_ASSASSIN_M = 5;
		public const int RACE_SURA_W = 6;
		public const int RACE_SHAMAN_M = 7;
		public const int #if ENABLE_WOLFMAN = 8;
		public const int RACE_WOLFMAN_M = 9;
		public const int #endif = 10;
		public const int RACE_MAX_NUM = 11;

		public const int SMOKE_NUM = 4;


		public class SMotion
		{
			public byte byPercentage;
			public CGraphicThing pMotion;
			public CRaceMotionData pMotionData;
		}

		public class SMotionModeData
		{
			public ushort wMotionModeIndex;

			public TMotionVectorMap MotionVectorMap = new TMotionVectorMap();

			public SMotionModeData()
			{
			}
		...
		{
			public NRaceData.TAttachingDataVector AttachingDataVector = new NRaceData.TAttachingDataVector();
		}


		public class SComboAttackData
		{
			public TComboIndexVector ComboIndexVector = new TComboIndexVector();
		}
		...
		public class SSkin
		{
			...
			public string m_stSrcFileName = "";
			public string m_stDstFileName = "";

			public SSkin()
			{
				m_ePart = 0;
			}
			public SSkin(in SSkin c_rkSkin)
			{
				Copy(c_rkSkin);
			}
//# Laniatus Games Studio Inc. |: This 'CopyFrom' method was converted from the original copy assignment operator:
//Original Metin2 CPlus Line: void operator =(const SSkin& c_rkSkin)
			public void CopyFrom(in SSkin c_rkSkin)
			{
				Copy(c_rkSkin);
			}
			public void Copy(in SSkin c_rkSkin)
			{
		...
		public class SHair
		{
			public string m_stModelFileName = "";
			public List<SSkin> m_kVct_kSkin = new List<SSkin>();
		}
		...
		public static CRaceData New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CRaceData pkRaceData)
		{
			pkRaceData.Destroy();
			ms_kPool.Free(pkRaceData);
		}

		public static void CreateSystem(uint uCapacity, uint uMotModeCapacity)
		{
...
//Original Metin2 CPlus Line: const char * GetBaseModelFileName() const
		public string GetBaseModelFileName()
		{
			return m_strBaseModelFileName.c_str();
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const char * GetAttributeFileName() const
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const char* GetMotionListFileName() const
		public string GetMotionListFileName()
		{
			return m_strMotionListFileName.c_str();
		}

		public CGraphicThing GetBaseModelThing()
		{
		...
		public CAttributeData GetAttributeDataPtr()
		{
		...
		public bool GetAttachingBoneName(uint dwPartIndex, string[] c_pszBoneName)
		{
			...
			string c_rstrBoneName = itor.second;

			c_pszBoneName[0] = c_rstrBoneName;

			return true;
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool CreateMotionModeIterator(System.Collections.Generic.SortedDictionaryIterator<ushort, SMotionModeData> itor);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NextMotionModeIterator(System.Collections.Generic.SortedDictionaryIterator<ushort, SMotionModeData> itor);

		public bool GetMotionKey(ushort wMotionModeIndex, ushort wMotionIndex, MOTION_KEY pMotionKey)
		{
			...
			{
				ushort wGeneralMode = CRaceMotionData.MODE_GENERAL;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMotionModeDataPointer(ushort wMotionMode, SMotionModeData[] ppMotionModeData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetModelDataPointer(uint dwModelIndex, SModelData[] c_ppModelData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMotionVectorPointer(ushort wMotionMode, ushort wMotionIndex, System.Collections.Generic.List<SMotion>[] c_ppMotionVector);
		public bool GetMotionDataPointer(ushort wMotionMode, ushort wMotionIndex, ushort wMotionSubIndex, CRaceMotionData[] c_ppMotionData)
		{
			TMotionVector c_pMotionVector;
			...
			TMotion c_rMotion = c_pMotionVector.at(wMotionSubIndex);
			...
			c_ppMotionData[0] = c_rMotion.pMotionData;

			return true;
		}

		public bool GetMotionDataPointer(uint dwMotionKey, CRaceMotionData[] c_ppMotionData)
		{
		...
		public uint GetAttachingDataCount()
		{
			return (uint)m_AttachingDataVector.size();
		}

		public bool GetAttachingDataPointer(uint dwIndex, NRaceData.TAttachingData[] c_ppAttachingData)
		{
			...
			c_ppAttachingData[0] = &m_AttachingDataVector[dwIndex];

			return true;
		}

		public bool GetCollisionDataPointer(uint dwIndex, NRaceData.TAttachingData[] c_ppAttachingData)
		{
			if (dwIndex >= GetAttachingDataCount())
			{
				return false;
		...
		public bool GetBodyCollisionDataPointer(NRaceData.TAttachingData[] c_ppAttachingData)
		{
...
//Original Metin2 CPlus Line: *c_ppAttachingData = pAttachingData;
					c_ppAttachingData[0].CopyFrom(pAttachingData);
					return true;
				}
				}
			}
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool LoadRaceData(string c_szFileName);

		public CGraphicThing RegisterMotionData(ushort wMotionMode, ushort wMotionIndex, string c_szFileName, byte byPercentage = 100)
		{
		...
		public void SetRace(uint dwRaceIndex)
		{
			m_dwRaceIndex = dwRaceIndex;
		}

		public void RegisterAttachingBoneName(uint dwPartIndex, string c_szBoneName)
		{
			m_AttachingBoneNameMap.insert(TAttachingBoneNameMap.value_type(dwPartIndex, c_szBoneName));
		}

		public void RegisterMotionMode(ushort wMotionModeIndex)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetMotionModeParent(ushort wParentMotionModeIndex, ushort wMotionModeIndex);
		public void OLD_RegisterMotion(ushort wMotionModeIndex, ushort wMotionIndex, string c_szFileName, byte byPercentage = 100)
		{
			CGraphicThing pThing = (CGraphicThing)CResourceManager.Instance().GetResourcePointer(c_szFileName);

			TMotion Motion = new TMotion();
		...
		public CGraphicThing NEW_RegisterMotion(CRaceMotionData pkMotionData, ushort wMotionModeIndex, ushort wMotionIndex, string c_szFileName, byte byPercentage = 100)
		{
		...
		public bool SetMotionRandomWeight(ushort wMotionModeIndex, ushort wMotionIndex, ushort wMotionSubIndex, byte byPercentage)
		{
			TMotionModeData pMotionModeData;
			...
			{
				TraceError("CRaceData::SetMotionRandomWeight(wMotionModeIndex=%d, wMotionIndex=%d, wMotionSubIndex=%d, byPercentage=%d) - Find Motion(wMotionIndex=%d) FAILED", wMotionModeIndex, wMotionIndex, wMotionSubIndex, byPercentage, wMotionModeIndex);
		...
		public void RegisterNormalAttack(ushort wMotionModeIndex, ushort wMotionIndex)
		{
			m_NormalAttackIndexMap.insert(TNormalAttackIndexMap.value_type(wMotionModeIndex, wMotionIndex));
		}

		public bool GetNormalAttackIndex(ushort wMotionModeIndex, ref ushort pwMotionIndex)
		{
		...
		public void ReserveComboAttack(ushort wMotionModeIndex, ushort wComboType, uint dwComboCount)
		{
			TComboData ComboData = new TComboData();
			ComboData.ComboIndexVector.clear();
			ComboData.ComboIndexVector.resize(dwComboCount);
			m_ComboAttackDataMap.insert(TComboAttackDataMap.value_type((((uint)wMotionModeIndex << 16) | ((uint)wComboType)), ComboData));
		}

		public void RegisterComboAttack(ushort wMotionModeIndex, ushort wComboType, uint dwComboIndex, ushort wMotionIndex)
		{
			...
			{
				TraceError("CRaceData::RegisterCombo - Strange combo index!");
				Debug.Assert(!"CRaceData::RegisterCombo - Strange combo index!");
				return;
			}
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetComboDataPointer(ushort wMotionModeIndex, ushort wComboType, SComboAttackData[] ppComboData);

		public void SetShapeModel(uint eShape, string c_szModelFileName)
		{
			m_kMap_dwShapeKey_kShape[eShape].m_stModelFileName = c_szModelFileName;
		}

		public void AppendShapeSkin(uint eShape, uint ePart, string c_szSrcFileName, string c_szDstFileName)
		{
			SSkin kSkin = new SSkin();
			kSkin.m_ePart = ePart;
		...
		public void SetHairSkin(uint eHair, uint ePart, string c_szModelFileName, string c_szSrcFileName, string c_szDstFileName)
		{
			SSkin kSkin = new SSkin();
			kSkin.m_ePart = ePart;
			kSkin.m_stSrcFileName = c_szSrcFileName;
		...
		public uint GetSmokeEffectID(uint eSmoke)
		{
			if (eSmoke >= SMOKE_NUM)
			{
		...
		public string GetSmokeBone()
		{
			return m_strSmokeBoneName;
		}

		public CRaceData.SHair FindHair(uint eHair)
		{
			SortedDictionary<uint, SHair>.Enumerator f = m_kMap_dwHairKey_kHair.find(eHair);
...
//# Laniatus Games Studio Inc. | TODO TASK: Iterators are only converted within the context of 'while' and 'for' loops:
		...
		public CRaceData.SShape FindShape(uint eShape)
		{
			SortedDictionary<uint, SShape>.Enumerator f = m_kMap_dwShapeKey_kShape.find(eShape);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __OLD_RegisterMotion(ushort wMotionMode, ushort wMotionIndex, in SMotion rMotion);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMotionVectorPointer(ushort wMotionMode, ushort wMotionIndex, System.Collections.Generic.List<SMotion>[] ppMotionVector);

		protected uint m_dwRaceIndex;
		protected uint[] m_adwSmokeEffectID = new uint[SMOKE_NUM];

		protected CGraphicThing m_pBaseModelThing;
		protected CGraphicThing m_pLODModelThing;

		protected string m_strBaseModelFileName = "";
		protected string m_strTreeFileName = "";
		protected string m_strAttributeFileName = "";
		protected string m_strMotionListFileName = "";
		protected string m_strSmokeBoneName = "";

		protected SortedDictionary<uint, SModelData> m_ModelDataMap = new SortedDictionary<uint, SModelData>();
		protected SortedDictionary<ushort, SMotionModeData> m_pMotionModeDataMap = new SortedDictionary<ushort, SMotionModeData>();
		protected SortedDictionary<uint, string> m_AttachingBoneNameMap = new SortedDictionary<uint, string>();
		protected SortedDictionary<uint, SComboAttackData> m_ComboAttackDataMap = new SortedDictionary<uint, SComboAttackData>();
		protected SortedDictionary<uint, uint> m_NormalAttackIndexMap = new SortedDictionary<uint, uint>();

		protected SortedDictionary<uint, SHair> m_kMap_dwHairKey_kHair = new SortedDictionary<uint, SHair>();
		protected SortedDictionary<uint, SShape> m_kMap_dwShapeKey_kShape = new SortedDictionary<uint, SShape>();

		protected NRaceData.TAttachingDataVector m_AttachingDataVector = new NRaceData.TAttachingDataVector();

		protected static CDynamicPool<SMotionModeData> ms_MotionModeDataPool = new CDynamicPool<SMotionModeData>();
		protected static CDynamicPool<CRaceData> ms_kPool = new CDynamicPool<CRaceData>();
}
