...
public class CTerrainQuadtreeNode
{
	public CTerrainQuadtreeNode()
	{
		this.NW_Node = null;
		this.NE_Node = null;
		this.SW_Node = null;
		this.SE_Node = null;
		this.center = new <type missing>(-1.0f, -1.0f, -1.0f);
		x0 = y0 = x1 = y1 = 0;
		Size = 0;
		PatchNum = 0;
		radius = 0.0f;
	...
	public int x1;
	public int y1;
	public CTerrainQuadtreeNode NW_Node;
	public CTerrainQuadtreeNode NE_Node;
	public CTerrainQuadtreeNode SW_Node;
	public CTerrainQuadtreeNode SE_Node;
	public int Size;
	public int PatchNum;
	public D3DXVECTOR3 center = new D3DXVECTOR3();
	public float radius;
	public byte m_byLODLevel;
}
