...
//Original Metin2 CPlus Line: granny_world_pose* CGrannyModelInstance::__GetWorldPosePtr() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: int* CGrannyModelInstance::__GetMeshBoneIndices(uint iMeshBinding) const
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool CGrannyModelInstance::GetBoneIndexByName(const char * c_szBoneName, int * pBoneIndex) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const float * CGrannyModelInstance::GetBoneMatrixPointer(int iBone) const
//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const float * CGrannyModelInstance::GetCompositeBoneMatrixPointer(int iBone) const
//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:
