...
public class CGrannyMotion : System.IDisposable
{
		public CGrannyMotion()
		{
			Initialize();
		}
		...
		public bool IsEmpty()
		{
			return m_pgrnAni != null ? false : true;
		}
		...
		public bool BindGrannyAnimation(granny_animation pgrnAni)
		{
...
//Original Metin2 CPlus Line: granny_animation* GetGrannyAnimationPointer() const
		public granny_animation GetGrannyAnimationPointer()
		{
			return m_pgrnAni;
		}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: float GetDuration() const
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void GetTextTrack(const char * c_szTextTrackName, int * pCount, float * pArray) const
		public void GetTextTrack(string c_szTextTrackName, ref int pCount, float[] pArray)
		{
