...
public class CGrannyModelInstance : CGraphicCollisionObject
{
		public const int ANIFPS_MIN = 30;
		public const int ANIFPS_MAX = 120;
		public static void DestroySystem()
		{
			ms_kPool.Destroy();
		}

		public static CGrannyModelInstance New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CGrannyModelInstance pkInst)
		{
			pkInst.Clear();
			ms_kPool.Free(pkInst);
		}

		public static CDynamicPool<CGrannyModelInstance> ms_kPool = new CDynamicPool<CGrannyModelInstance>();

		public class FCreateDeviceObjects
		{
			public void functorMethod(CGrannyModelInstance pModelInstance)
			{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdateSkeleton(D3DXMATRIX c_pWorldMatrix, float fLocalTime);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void DeformNoSkin(D3DXMATRIX c_pWorldMatrix);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void Deform(D3DXMATRIX c_pWorldMatrix);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetMotionPointer(CGrannyMotion pMotion, float blendTime = 0.0f, int loopCount = 0, float speedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ChangeMotionPointer(CGrannyMotion pMotion, int loopCount = 0, float speedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetMotionAtEnd();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint GetDeformableVertexCount();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint GetVertexCount();

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const float * GetBoneMatrixPointer(int iBone) const;
//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float GetBoneMatrixPointer(int iBone);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const float * GetCompositeBoneMatrixPointer(int iBone) const;
//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float GetCompositeBoneMatrixPointer(int iBone);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool GetMeshMatrixPointer(int iMesh, const D3DXMATRIX ** c_ppMatrix) const;
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMeshMatrixPointer(int iMesh, D3DXMATRIX[] c_ppMatrix);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool GetBoneIndexByName(const char * c_szBoneName, int * pBoneIndex) const;
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetBoneIndexByName(string c_szBoneName, ref int pBoneIndex);
		public void SetParentModelInstance(CGrannyModelInstance c_pParentModelInstance, string c_szBoneName)
		{
			int iBoneIndex;
		...
		public void SetParentModelInstance(CGrannyModelInstance c_pParentModelInstance, int iBone)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool Intersect(D3DXMATRIX c_pMatrix, ref float pu, ref float pv, ref float pt);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void MakeBoundBox(TBoundBox pBoundBox, float mat, float OBBMin, float OBBMax, D3DXVECTOR3 vtMin, D3DXVECTOR3 vtMax);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: int* __GetMeshBoneIndices(uint iMeshBinding) const;
//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		int __GetMeshBoneIndices(uint iMeshBinding);
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: granny_world_pose* __GetWorldPosePtr() const;
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		granny_world_pose __GetWorldPosePtr();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdateWorldPose();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdateWorldMatrices(D3DXMATRIX c_pWorldMatrix);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void DeformPNTVertices(object pvDest);
...
//		void RenderMeshNodeListWithoutTexture(CGrannyMesh::EType eMeshType, CGrannyMaterial::EType eMtrlType);
		...
		protected CGrannyModel m_pModel;
		protected granny_model_instance m_pgrnModelInstance;
		protected granny_control m_pgrnCtrl;
		protected granny_animation m_pgrnAni;
		protected D3DXMATRIX[] m_meshMatrices;
		protected readonly CGrannyModelInstance mc_pParentInstance;
		protected int m_iParentBoneIndex;

		protected float m_fLocalTime;
		protected float m_fSecondsElapsed;

		protected uint m_dwOldUpdateFrame;

		protected CGrannyMaterialPalette m_kMtrlPal = new CGrannyMaterialPalette();

		protected granny_world_pose m_pgrnWorldPoseReal;
		protected List<granny_mesh_binding> m_vct_pgrnMeshBinding = new List<granny_mesh_binding>();

		protected CGraphicVertexBuffer m_pkSharedDeformableVertexBuffer;
		protected CGraphicVertexBuffer m_kLocalDeformableVertexBuffer = new CGraphicVertexBuffer();
		protected bool m_isDeformableVertexBuffer;

		protected CGrannyModelInstance[] m_ppkSkeletonInst;
