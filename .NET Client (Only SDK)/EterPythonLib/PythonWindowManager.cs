...
//	class CWindow;
	...
	public class CWindowManager : CSingleton<CWindowManager>
	{

			public CWindowManager()
			{
				this.m_pActiveWindow = null;
				this.m_pPointWindow = null;
				this.m_pLeftCaptureWindow = null;
				this.m_pMiddleCaptureWindow = null;
				this.m_pRightCaptureWindow = null;
				this.m_pLockWindow = null;
				this.m_bAttachingFlag = false;
				this.m_dwAttachingType = 0;
				this.m_dwAttachingIndex = 0;
				this.m_dwAttachingSlotNumber = 0;
				this.m_poMouseHandler = null;
				this.m_iHres = 0;
				this.m_iVres = 0;
				this.m_bOnceIgnoreMouseLeftButtonUpEventFlag = false;
				m_pRootWindow = new CWindow(null);
				m_pRootWindow.SetName("root");
				m_pRootWindow.Show();

				string[] layerTbl = {"GAME", "UI_BOTTOM", "UI", "TOP_MOST", "CURTAIN"};

//# Laniatus Games Studio Inc. | WARN: This 'sizeof' ratio was replaced with a direct reference to the array length:
//Original Metin2 CPlus Line: for(uint layer = 0; layer < sizeof(layerTbl)/sizeof(layerTbl[0]); layer++)
				for (uint layer = 0; layer < layerTbl.Length; layer++)
				{
			...
			public void SetScreenSize(int lWidth, int lHeight)
			{
				m_lWidth = lWidth;
				m_lHeight = lHeight;
			...
			public void GetResolution(ref int rx, ref int ry)
			{
				rx = m_iHres;
				ry = m_iVres;
			}

			public void SetMouseHandler(PyObject poMouseHandler)
			{
			...
			public void GetMousePosition(ref int rx, ref int ry)
			{
				rx = m_lMouseX;
				ry = m_lMouseY;
			}
			...
			{
				int ldx = Math.Abs(m_lMouseX - m_lPickedX);
				int ldy = Math.Abs(m_lMouseY - m_lPickedY);
				if (ldx + ldy < 10)
				{
					return false;
				}
			...
			public CWindow GetLockWindow()
			{
				return m_pLockWindow;
			}
			public CWindow GetPointWindow()
			{
			...
			public bool IsFocusWindow(CWindow pWindow)
			{
				return pWindow == m_pActiveWindow;
			}

			public void SetParent(CWindow pWindow, CWindow pParentWindow)
			{
				if (pWindow == null)
				{
					Debug.Assert(!"CWindowManager::SetParent - There is no self window!");
					return;
				}
				if (pParentWindow == null)
				{
					Debug.Assert(!"There is no parent window");
					return;
				}
			...
			public void SetPickAlways(CWindow pWindow)
			{
				m_PickAlwaysWindowList.push_back(pWindow);
			}

			public const int WT_NORMAL = 0;
			public const int WT_SLOT = 1;
			public const int WT_GRIDSLOT = 2;
			public const int WT_TEXTLINE = 3;
			public const int WT_MARKBOX = 4;
			public const int WT_IMAGEBOX = 5;
			public const int WT_EXP_IMAGEBOX = 6;
			public const int WT_ANI_IMAGEBOX = 7;
			public const int WT_BUTTON = 8;
			public const int WT_RATIOBUTTON = 9;
			public const int WT_TOGGLEBUTTON = 10;
			public const int WT_DRAGBUTTON = 11;
			public const int WT_BOX = 12;
			public const int WT_BAR = 13;
			public const int WT_LINE = 14;
			public const int WT_BAR3D = 15;
			public const int WT_NUMLINE = 16;

			public CWindow RegisterWindow(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterTypeWindow(PyObject po, uint dwWndType, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterSlotWindow(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterGridSlotWindow(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterTextLine(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterMarkBox(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterImageBox(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterExpandedImageBox(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterAniImageBox(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterButton(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterRadioButton(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterToggleButton(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterDragButton(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterBox(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterBar(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterLine(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterBar3D(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public CWindow RegisterNumberLine(PyObject po, string c_szLayer)
			{
				Debug.Assert(m_LayerWindowMap.end() != m_LayerWindowMap.find(c_szLayer));
			...
			public void DestroyWindow(CWindow pWin)
			{
			...
			public void NotifyDestroyWindow(CWindow pWindow)
			{
			...
			public uint GetAttachingType()
			{
				return m_dwAttachingType;
			}

			public uint GetAttachingIndex()
			{
				return m_dwAttachingIndex;
			}

			public uint GetAttachingSlotNumber()
			{
				return m_dwAttachingSlotNumber;
			}

			public void GetAttachingIconSize(ref byte pbyWidth, ref byte pbyHeight)
			{
				pbyWidth = m_byAttachingIconWidth;
				pbyHeight = m_byAttachingIconHeight;
			}

			public void AttachIcon(uint dwType, uint dwIndex, uint dwSlotNumber, byte byWidth, byte byHeight)
			{
			...
			public void SetAttachingFlag(bool bFlag)
			{
				m_bAttachingFlag = bFlag;
			}

			public void OnceIgnoreMouseLeftButtonUpEvent()
			{
				m_bOnceIgnoreMouseLeftButtonUpEventFlag = true;
				m_iIgnoreEndTime = timeGetTime() + 500;
			}

			public void LockWindow(CWindow pWin)
			{
				if (m_pActiveWindow)
				{
			...
			public void ActivateWindow(CWindow pWin)
			{
			...
			public CWindow GetActivateWindow()
			{
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
			private string RunMouseMove_strPickWindowName = "";

			public void RunMouseMove(int x, int y)
			{
				if (IsAttaching())
				{
					if (x > m_lWidth)
...
//						static string strPickWindowName = "";
						if (0 != RunMouseMove_strPickWindowName.compare(pPointWindow.GetName()))
						{
							Tracef(" OverInWindowName [%s]\n", pPointWindow.GetName());
							RunMouseMove_strPickWindowName = pPointWindow.GetName();
						}
					}
				}
				...
				if (m_pLeftCaptureWindow)
				{
					...
					{
						int x = m_lMouseX - m_lDragX;
						int y = m_lMouseY - m_lDragY;
						if (pWin.HasParent())
						{
				...
				{
#if DEBUG
					if (pPointWindow != null && pPointWindow.GetName())
					{
			...
			public void RunMouseLeftButtonDown(int x, int y)
			{
				SetTopUIWindow();
			...
			public void RunMouseLeftButtonUp(int x, int y)
			{
			...
			public void RunMouseLeftButtonDoubleClick(int x, int y)
			{
				SetMousePosition(x, y);
			...
			public void RunMouseRightButtonDown(int x, int y)
			{
				SetTopUIWindow();
			...
			public void RunMouseRightButtonUp(int x, int y)
			{
			...
			public void RunMouseRightButtonDoubleClick(int x, int y)
			{
				SetMousePosition(x, y);
			...
			public void RunMouseMiddleButtonDown(int x, int y)
			{
				SetMousePosition(x, y);
			...
			public void RunMouseMiddleButtonUp(int x, int y)
			{
				SetMousePosition(x, y);
			...
			public bool RunMouseWheel(int nLen)
			{
				CWindow pWin = GetPointWindow();
				if (pWin == null)
				{
			...
			public void RunIMETabEvent()
			{
				...
				if (!m_pRootWindow.RunIMETabEvent())
				{
					if (!m_ActiveWindowList.empty())
					{
						...
						uint dwMaxLoopCount = 20;
						for (uint LaniatusDefVariables = 0; LaniatusDefVariables < dwMaxLoopCount; ++i)
						{
							if (pParentWindow == null)
							{
								break;
			...
			public void RunIMEKeyDown(int vkey)
			{
				if (m_pLockWindow)
				{
			...
			public void RunKeyDown(int vkey)
			{
				if (m_pLockWindow)
				{
					m_pLockWindow.OnKeyDown(vkey);
					m_KeyCaptureWindowMap.insert(Tuple.Create(vkey, m_pLockWindow));
					return;
				}
				if (m_pActiveWindow)
				{
				if (m_pActiveWindow.IsShow())
				{
					...
					{
						m_KeyCaptureWindowMap.insert(Tuple.Create(vkey, m_pActiveWindow));
						return;
					}
				}
				}
			...
			private CWindow __PickWindow(int x, int y)
			{
				if (m_pLockWindow)
				{
		...
		//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
		...
		//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			...
			private CWindow __NewWindow(PyObject po, uint dwWndType)
			{
				switch (dwWndType)
				{
					case WT_SLOT:
					...
					case WT_NUMLINE:
						...
						break;
					default:
						Debug.Assert(!"CWindowManager::__NewWindow");
						break;
				}
				return new CWindow(po);
			}

			private void __ClearReserveDeleteWindowList()
			{
		//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			...
			private int m_lMouseX;
			private int m_lMouseY;
			private int m_lDragX;
			private int m_lDragY;
			private int m_lPickedX;
			private int m_lPickedY;

			private bool m_bOnceIgnoreMouseLeftButtonUpEventFlag;
			private int m_iIgnoreEndTime;

			private PyObject m_poMouseHandler;
			private bool m_bAttachingFlag;
			private uint m_dwAttachingType;
			private uint m_dwAttachingIndex;
			private uint m_dwAttachingSlotNumber;
			private byte m_byAttachingIconWidth;
			private byte m_byAttachingIconHeight;

			private CWindow m_pActiveWindow;
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			private TWindowContainer m_ActiveWindowList = new TWindowContainer();
			private CWindow m_pLockWindow;
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			private TWindowContainer m_LockWindowList = new TWindowContainer();
			private CWindow m_pPointWindow;
			private CWindow m_pLeftCaptureWindow;
			private CWindow m_pRightCaptureWindow;
			private CWindow m_pMiddleCaptureWindow;
			private SortedDictionary<int, CWindow > m_KeyCaptureWindowMap = new SortedDictionary<int, CWindow >();
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			private TWindowContainer m_ReserveDeleteWindowList = new TWindowContainer();
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			private TWindowContainer m_PickAlwaysWindowList = new TWindowContainer();

			private CWindow m_pRootWindow;
//# Laniatus Games Studio Inc. | TODO TASK: The typedef 'TWindowContainer' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
			private TWindowContainer m_LayerWindowList = new TWindowContainer();
			private SortedDictionary<string, CWindow > m_LayerWindowMap = new SortedDictionary<string, CWindow >();
	}
}
