...
{
	public @interface IOleInPlaceFrame frame = new @interface();
	public IntPtr window;
}

public class _IOleInPlaceSiteEx
{
	public @interface IOleInPlaceSite inplace = new @interface();
	public _IOleInPlaceFrameEx frame = new _IOleInPlaceFrameEx();
}

public class _IDocHostUIHandlerEx
{
	public @interface IDocHostUIHandler ui = new @interface();
}

public class _IOleClientSiteEx
{
	public @interface IOleClientSite client = new @interface();
	public _IOleInPlaceSiteEx inplace = new _IOleInPlaceSiteEx();
	public _IDocHostUIHandlerEx ui = new _IDocHostUIHandlerEx();
}