...
public class CSpeedTreeMaterial
{
		public CSpeedTreeMaterial()
		{
		...
		public void Set(float[] pMaterialArray)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
		...
		public _D3DMATERIAL8 Get()
		{
			return m_cMaterial;
		}

		private _D3DMATERIAL8 m_cMaterial = new _D3DMATERIAL8();
}
