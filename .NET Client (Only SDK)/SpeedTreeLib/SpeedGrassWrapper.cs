...
//Original Metin2 CPlus Line: float CSpeedGrassWrapper::Color(float fX, float fY, const float* pNormal, float* pTopColor, float* pBottomColor) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: float CSpeedGrassWrapper::Height(float fX, float fY, float* pNormal) const
