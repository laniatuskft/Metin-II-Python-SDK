...
//Original Metin2 CPlus Line: const float* CSpeedGrassRT::GetWindDirection()

//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:
//Original Metin2 CPlus Line: const float* CSpeedGrassRT::GetCameraPos()
...
D3DXVECTOR3 ComputeUnitBillboard_afCorner1(0.0f, 0.5f, 1.0f);
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
//# Laniatus Games Studio Inc. | TODO TASK: The following statement was not recognized, possibly due to an unrecognized macro:
D3DXVECTOR3 ComputeUnitBillboard_afCorner2(0.0f, -0.5f, 1.0f);
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
//# Laniatus Games Studio Inc. | TODO TASK: The following statement was not recognized, possibly due to an unrecognized macro:
D3DXVECTOR3 ComputeUnitBillboard_afCorner3(0.0f, -0.5f, 0.0f);
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
//# Laniatus Games Studio Inc. | TODO TASK: The following statement was not recognized, possibly due to an unrecognized macro:
D3DXVECTOR3 ComputeUnitBillboard_afCorner4(0.0f, 0.5f, 0.0f);


//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSpeedGrassRT::ConvertCoordsToCell(const float* pCoords, int* pGridCoords) const
