...
public class CEffectElementBaseInstance
{
		public CEffectElementBaseInstance()
		{
		}
		...
		public void SetDataPointer(CEffectElementBase pElement)
		{
			m_pBase = pElement;
		...
		public void SetLocalMatrixPointer(D3DXMATRIX c_pMatrix)
		{
		...
		protected abstract void OnSetDataPointer(CEffectElementBase pElement);

		protected abstract void OnInitialize();
		protected abstract void OnDestroy();

		protected abstract bool OnUpdate(float fElapsedTime);
		protected abstract void OnRender();

		protected readonly D3DXMATRIX mc_pmatLocal;

		protected bool m_isActive;

		protected float m_fLocalTime;
		protected uint m_dwStartTime;
		protected float m_fElapsedTime;
		protected float m_fRemainingTime;
		protected bool m_bStart;

		private CEffectElementBase m_pBase;
		...
		public void SetMeshScale(D3DXVECTOR3 rv3Scale)
		{
			m_v3ScaleMesh = rv3Scale;
		}

		protected float m_fScaleParticle;
		protected D3DXVECTOR3 m_v3ScaleMesh = new D3DXVECTOR3();
}