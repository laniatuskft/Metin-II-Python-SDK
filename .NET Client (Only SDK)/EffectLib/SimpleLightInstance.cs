...
//		friend class CLightData;
		...
		protected uint m_LightID;
		protected CLightData m_pData;
		protected uint m_dwRangeIndex;

		protected uint m_iLoopCount;
		...
		public static CLightInstance New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CLightInstance pkData)
		{
			pkData.Destroy();
			ms_kPool.Free(pkData);
		}

		public static CDynamicPool<CLightInstance> ms_kPool = new CDynamicPool<CLightInstance>();
}