...
//	friend class CParticleSystemInstance;
		public const int ROTATION_TYPE_NONE = 0;
		public const int ROTATION_TYPE_TIME_EVENT = 1;
		public const int ROTATION_TYPE_CW = 2;
		public const int ROTATION_TYPE_CCW = 3;
		public const int ROTATION_TYPE_RANDOM_DIRECTION = 4;

		public const int TEXTURE_ANIMATION_TYPE_NONE = 0;
		public const int TEXTURE_ANIMATION_TYPE_CW = 1;
		public const int TEXTURE_ANIMATION_TYPE_CCW = 2;
		public const int TEXTURE_ANIMATION_TYPE_RANDOM_FRAME = 3;
		public const int TEXTURE_ANIMATION_TYPE_RANDOM_DIRECTION = 4;
		...
		public void InsertTexture(string c_szFileName)
		{
		...
		public bool SetTexture(string c_szFileName)
		{
		...
		public byte GetTextureAnimationType()
		{
			return m_byTexAniType;
		}

		public uint GetTextureAnimationFrameCount()
		{
			return (uint)m_ImageVector.size();
		}

		public float GetTextureAnimationFrameDelay()
		{
			return m_fTexAniDelay;
		}


		public byte m_byTexAniType;
		public float m_fTexAniDelay;
		public bool m_bTexAniRandomStartFrameFlag;

		public byte m_bySrcBlendType;
		public byte m_byDestBlendType;
		public byte m_byColorOperationType;
		public byte m_byBillboardType;

		public byte m_byRotationType;
		public float m_fRotationSpeed;
		public ushort m_wRotationRandomStartingBegin;
		public ushort m_wRotationRandomStartingEnd;

		public bool m_bAttachFlag;
		public bool m_bStretchFlag;

		public List<CTimeEvent<float>> m_TimeEventGravity = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventAirResistance = new List<CTimeEvent<float>>();

		public List<CTimeEvent<float>> m_TimeEventScaleX = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventScaleY = new List<CTimeEvent<float>>();
		public List<CTimeEvent<DWORDCOLOR>> m_TimeEventColor = new List<CTimeEvent<DWORDCOLOR>>();
		public List<CTimeEvent<float>> m_TimeEventRotation = new List<CTimeEvent<float>>();

		public List<CGraphicImage> m_ImageVector = new List<CGraphicImage>();

//# Laniatus Games Studio Inc. |: This 'CopyFrom' method was converted from the original copy assignment operator:
//Original Metin2 CPlus Line: CParticleProperty & operator = (const CParticleProperty& c_ParticleProperty)
		public CParticleProperty CopyFrom (in CParticleProperty c_ParticleProperty)
		{
		...
		public D3DXVECTOR3 m_v3ZAxis = new D3DXVECTOR3();
}
