...
//	friend class CParticleSystemInstance;
		public const int EMITTER_SHAPE_POINT = 0;
		public const int EMITTER_SHAPE_ELLIPSE = 1;
		public const int EMITTER_SHAPE_SQUARE = 2;
		public const int EMITTER_SHAPE_SPHERE = 3;

		public const int EMITTER_ADVANCED_TYPE_FREE = 0;
		public const int EMITTER_ADVANCED_TYPE_OUTER = 1;
		public const int EMITTER_ADVANCED_TYPE_INNER = 2;
		...
		public uint GetMaxEmissionCount()
		{
		...
		public byte GetEmitterShape()
		{
			return m_byEmitterShape;
		}

		public byte GetEmitterAdvancedType()
		{
			return m_byEmitterAdvancedType;
		}

		public bool isEmitFromEdge()
		{
			return m_bEmitFromEdgeFlag;
		}

		public void GetEmittingSize(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmittingSize, pfValue);
		}

		public void GetEmittingAngularVelocity(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmittingAngularVelocity, pfValue);
		}

		public void GetEmittingDirectionX(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmittingDirectionX, pfValue);
		}

		public void GetEmittingDirectionY(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmittingDirectionY, pfValue);
		}

		public void GetEmittingDirectionZ(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmittingDirectionZ, pfValue);
		}

		public void GetEmittingVelocity(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmittingVelocity, pfValue);
		}

		public void GetEmissionCountPerSecond(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventEmissionCountPerSecond, pfValue);
		}

		public void GetParticleLifeTime(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventLifeTime, pfValue);
		}

		public void GetParticleSizeX(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventSizeX, pfValue);
		}

		public void GetParticleSizeY(float fTime, ref float pfValue)
		{
			GetTimeEventBlendValue(fTime, m_TimeEventSizeY, pfValue);
		}

		public uint m_dwMaxEmissionCount;

		public float m_fCycleLength;
		public bool m_bCycleLoopFlag;
		public int m_iLoopCount;

		public byte m_byEmitterShape;
		public byte m_byEmitterAdvancedType;
		public bool m_bEmitFromEdgeFlag;
		public D3DXVECTOR3 m_v3EmittingSize = new D3DXVECTOR3();
		public float m_fEmittingRadius;

		public D3DXVECTOR3 m_v3EmittingDirection = new D3DXVECTOR3();

		public List<CTimeEvent<float>> m_TimeEventEmittingSize = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventEmittingAngularVelocity = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventEmittingDirectionX = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventEmittingDirectionY = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventEmittingDirectionZ = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventEmittingVelocity = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventEmissionCountPerSecond = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventLifeTime = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventSizeX = new List<CTimeEvent<float>>();
		public List<CTimeEvent<float>> m_TimeEventSizeY = new List<CTimeEvent<float>>();
}
