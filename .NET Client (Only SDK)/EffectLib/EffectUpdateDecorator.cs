...
{
	public class CDecoratorData
	{
		public float fTime;
		public float fElapsedTime;
		public CParticleInstance pInstance;
		public CDecoratorData(float fTime, float fElapsedTime, CParticleInstance pInstance)
		{
			this.fTime = fTime;
			this.fElapsedTime = fElapsedTime;
			this.pInstance = new CParticleInstance(pInstance);
		}
	}
	public class CBaseDecorator
	{
...
//		friend class CParticleSystemData;
		...
		{
			this.m_NextDecorator = 0;
			this.m_PrevDecorator = 0;
		}
		public virtual void Dispose()
		{
		}

		public void Excute(in CDecoratorData d)
		{
		...
		public CBaseDecorator AddChainFront(CBaseDecorator pd)
		{
		...
		public CBaseDecorator Clone(CParticleInstance pFirstInstance, CParticleInstance pInstance)
		{
		...
		protected abstract void __Excute(in CDecoratorData d);
		protected abstract CBaseDecorator __Clone(CParticleInstance pFirstInstance, CParticleInstance pInstance);
		...
		protected CBaseDecorator m_NextDecorator;
		protected CBaseDecorator m_PrevDecorator;
	}

//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CHeaderDecorator : CBaseDecorator, CPooledObject<CHeaderDecorator>
	{
		public CHeaderDecorator()
		{
		}
		public virtual void Dispose()
		{
		}
		protected virtual void __Excute(in CDecoratorData UnnamedParameter)
		{
		}
		protected virtual CBaseDecorator __Clone(CParticleInstance UnnamedParameter, CParticleInstance UnnamedParameter2)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CNullDecorator : CBaseDecorator, CPooledObject<CNullDecorator>
	{
		public CNullDecorator()
		{
		}
		public virtual void Dispose()
		{
		...
		protected virtual void __Excute(in CDecoratorData d)
		{
		}
		protected virtual CBaseDecorator __Clone(CParticleInstance UnnamedParameter, CParticleInstance UnnamedParameter2)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CTimeEventDecorator <T> : CBaseDecorator, CPooledObject<CTimeEventDecorator<T>>
	{
		public CTimeEventDecorator(in List<CTimeEvent<T>> TimeEventContainer, T pValue = null)
		{
			this.it_start = TimeEventContainer.GetEnumerator();
			this.it_cur = TimeEventContainer.GetEnumerator();
			this.it_next = TimeEventContainer.GetEnumerator();
			this.it_end = TimeEventContainer.end();
			this.pData = pValue;
				if (it_start == it_end)
				{
					pValue = default(T);
		...
		protected CTimeEventDecorator(CTimeEventDecorator<T> ted, CParticleInstance pFirstInstance, CParticleInstance pInstance)
		{
			this.it_start = ted.it_start;
			this.it_end = ted.it_end;
			this.it_cur = ted.it_cur;
			this.it_next = ted.it_next;
			this.pData = (T)((byte)ted.pData - (uint)pFirstInstance + (uint)pInstance);
				if (it_start == it_end)
				{
					*pData = default(T);
				}
		}
		protected virtual CBaseDecorator __Clone(CParticleInstance pFirstInstance, CParticleInstance pInstance)
		{
		...
		protected List<CTimeEvent<T>>.Enumerator it_start;
		protected List<CTimeEvent<T>>.Enumerator it_end;
		protected List<CTimeEvent<T>>.Enumerator it_cur;
		protected List<CTimeEvent<T>>.Enumerator it_next;
		protected T pData;
	}


//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CTextureAnimationCWDecorator : CBaseDecorator, CPooledObject<CTextureAnimationCWDecorator>
	{
		public CTextureAnimationCWDecorator(float fFrameTime, uint n, ref byte pIdx)
		{
			this.n = n;
			this.pIdx = pIdx;
			this.fFrameTime = fFrameTime;
			this.fLastFrameTime = fFrameTime;
		}
		public virtual void Dispose()
		{
		}
		protected virtual CBaseDecorator __Clone(CParticleInstance pfi, CParticleInstance pi)
		{
			return new CTextureAnimationCWDecorator(fFrameTime,n,(byte)((byte)pi + ((byte)pIdx - (byte)pfi)));
		}
		protected virtual void __Excute(in CDecoratorData d)
		{
		...
		protected float fFrameTime;
//# Laniatus Games Studio Inc. | TODO TASK: C# does not have an equivalent to pointers to value types:
//Original Metin2 CPlus Line: byte* pIdx;
		protected byte pIdx;

	}
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CTextureAnimationCCWDecorator : CBaseDecorator, CPooledObject<CTextureAnimationCCWDecorator>
	{
		public CTextureAnimationCCWDecorator(float fFrameTime, byte n, ref byte pIdx)
		{
			this.n = n;
			this.pIdx = pIdx;
			this.fFrameTime = fFrameTime;
		...
		protected virtual CBaseDecorator __Clone(CParticleInstance pfi, CParticleInstance pi)
		{
			return new CTextureAnimationCCWDecorator(fFrameTime,n,(byte)((byte)pi + ((byte)pIdx - (byte)pfi)));
		}
		protected virtual void __Excute(in CDecoratorData d)
		{
			fLastFrameTime -= d.fElapsedTime;
...
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CTextureAnimationRandomDecorator : CBaseDecorator, CPooledObject<CTextureAnimationRandomDecorator>
	{
		public CTextureAnimationRandomDecorator(float fFrameTime, byte n, ref byte pIdx)
		{
			this.n = n;
			this.pIdx = pIdx;
			this.fFrameTime = fFrameTime;
		...
		protected virtual CBaseDecorator __Clone(CParticleInstance pfi, CParticleInstance pi)
		{
			return new CTextureAnimationRandomDecorator(fFrameTime,n,(byte)((byte)pi + ((byte)pIdx - (byte)pfi)));
		}
		protected virtual void __Excute(in CDecoratorData d)
		{
			fLastFrameTime -= d.fElapsedTime;
...
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CAirResistanceDecorator : CBaseDecorator, CPooledObject<CAirResistanceDecorator>
	{
		public CAirResistanceDecorator()
		{
		}
		public virtual void Dispose()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CGravityDecorator : CBaseDecorator, CPooledObject<CGravityDecorator>
	{
		public CGravityDecorator()
		{
		}
		public virtual void Dispose()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: Multiple inheritance is not available in C#:
	public class CRotationDecorator : CBaseDecorator, CPooledObject<CRotationDecorator>
	{
		public CRotationDecorator()
		{
		}
		public virtual void Dispose()
		{
