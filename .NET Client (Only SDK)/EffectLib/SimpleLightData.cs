...
public class CLightData : CEffectElementBase
{
...
//	friend class CLightInstance;
		...
		public void GetRange(float fTime, ref float rRange)
		{
		...
		public void InitializeLight(D3DLIGHT8 light)
		{
			...
			D3DXVECTOR3 position = new D3DXVECTOR3();
		...
		protected List<CTimeEvent<float>> m_TimeEventTableRange = new List<CTimeEvent<float>>();

		protected D3DXCOLOR m_cAmbient = new D3DXCOLOR();
		protected D3DXCOLOR m_cDiffuse = new D3DXCOLOR();

		protected bool m_bLoopFlag;
		protected int m_iLoopCount;

		protected float m_fAttenuation0;
		protected float m_fAttenuation1;
		protected float m_fAttenuation2;
		...
		public static CLightData New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CLightData pkData)
		{
			pkData.Clear();
			ms_kPool.Free(pkData);
		}

		public static CDynamicPool<CLightData> ms_kPool = new CDynamicPool<CLightData>();
}