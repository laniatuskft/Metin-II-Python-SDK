...
public class CFrameController
{
		...
		public void Update(float fElapsedTime)
		{
			...
			for (int LaniatusDefVariables = 0; LaniatusDefVariables < 20; ++i)
			{
		...
		public void SetCurrentFrame(uint dwFrame)
		{
		...
		public void SetMaxFrame(uint dwMaxFrame)
		{
		...
		public void SetStartFrame(uint dwStartFrame)
		{
			m_dwStartFrame = dwStartFrame;
		}

		public void SetLoopFlag(bool bFlag)
		{
			m_isLoop = bFlag;
		}
		...
		public bool isActive(uint dwMainFrame = 0)
		{
