...
public class SEffectPosition
{
	public float m_fTime;

	public D3DXVECTOR3 m_vecPosition = new D3DXVECTOR3();
	public int m_iMovingType;
	public D3DXVECTOR3 m_vecControlPoint = new D3DXVECTOR3();

}
public class CTimeEvent <T>
{
	public CTimeEvent()
	{
	}
...
public class DWORDCOLOR
{
	...
	public DWORDCOLOR(in DWORDCOLOR r)
	{
		this.m_dwColor = r.m_dwColor;
	}

//# Laniatus Games Studio Inc. |: This 'CopyFrom' method was converted from the original copy assignment operator:
//Original Metin2 CPlus Line: DWORDCOLOR& operator = (const DWORDCOLOR& r)
	public DWORDCOLOR CopyFrom (in DWORDCOLOR r)
	{
...
//# Laniatus Games Studio Inc. | TODO TASK: The *= operator cannot be overloaded in C#:
	public static DWORDCOLOR operator *= (float f)
	{
		uint idx = (uint)(f * 256);
		m_dwColor = (((uint)(((m_dwColor & DefineConstants.AG_MASK) >> 8) * idx)) & DefineConstants.AG_MASK) + ((uint)(((m_dwColor & DefineConstants.RB_MASK) * idx) >> 8) & DefineConstants.RB_MASK);

		return this;
	}
//# Laniatus Games Studio Inc. | TODO TASK: The += operator cannot be overloaded in C#:
	public static DWORDCOLOR operator += (in DWORDCOLOR r)
	{
		m_dwColor += r.m_dwColor;
		return this;
	}
	public static implicit operator uint(DWORDCOLOR ImpliedObject)
	{
		return m_dwColor;
	}
}