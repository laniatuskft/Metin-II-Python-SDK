...
public class ISoundInstance : CSoundBase
{
	...
	public abstract bool SetSound(CSoundData pSound);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void Play(int iLoopCount = 1, uint dwPlayCycleTimeLimit = 0) const = 0;
	public abstract void Play(int iLoopCount = 1, uint dwPlayCycleTimeLimit = 0);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void Pause() const = 0;
	public abstract void Pause();
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void Resume() const = 0;
	public abstract void Resume();
	public abstract void Stop();
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void GetVolume(float& rfVolume) const = 0;
	public abstract void GetVolume(ref float rfVolume);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void SetVolume(float volume) const = 0;
	public abstract void SetVolume(float volume);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual bool IsDone() const = 0;
	public abstract bool IsDone();
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void SetPosition(float x, float y, float z) const = 0;
	public abstract void SetPosition(float x, float y, float z);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal) const = 0;
	public abstract void SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual void SetVelocity(float x, float y, float z, float fMagnitude) const = 0;
	public abstract void SetVelocity(float x, float y, float z, float fMagnitude);
}

public class CSoundInstance2D : ISoundInstance
{
	public CSoundInstance2D()
	{
		this.m_sample = null;
		this.m_pSoundData = null;
	}
	public void Dispose()
	{
		Destroy();
	...
	public bool SetSound(CSoundData pSoundData)
	{
		Debug.Assert(m_sample != null && pSoundData != null);
		object lpData = pSoundData.Get();
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void Play(int iLoopCount = 1, uint dwPlayCycleTimeLimit = 0) const;
	public void Play(int iLoopCount, uint dwPlayCycleTimeLimit)
	{
		AIL_set_sample_loop_count(m_sample, iLoopCount);
		AIL_start_sample(m_sample);
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void Pause() const;
	public void Pause()
	{
		AIL_stop_sample(m_sample);
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void Resume() const;
	public void Resume()
	{
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void GetVolume(float& rfVolume) const;
	public void GetVolume(ref float rfVolume)
	{
		AIL_sample_volume_pan(m_sample, rfVolume, null);
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetVolume(float volume) const;
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool IsDone() const;
	public bool IsDone()
	{
		return AIL_sample_status(m_sample) == SMP_DONE;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetPosition(float x, float y, float z) const;
	public void SetPosition(float x, float y, float z)
	{
		Debug.Assert(!"must not call this method");
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal) const;
	public void SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal)
	{
		Debug.Assert(!"must not call this method");
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetVelocity(float fx, float fy, float fz, float fMagnitude) const;
	public void SetVelocity(float fx, float fy, float fz, float fMagnitude)
	{
		Debug.Assert(!"must not call this method");
	}

	private HSAMPLE m_sample = new HSAMPLE();
	private CSoundData m_pSoundData;
}

public class CSoundInstance3D : ISoundInstance
{
	public CSoundInstance3D()
	{
		this.m_sample = null;
		this.m_pSoundData = null;
	}
...
//Original Metin2 CPlus Line: void SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal) const;
	public void SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal)
	{
		Debug.Assert(!" CSoundInstance3D::SetOrientation - ??? ???? ?ʴ? ?Լ?");
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetVelocity(float fx, float fy, float fz, float fMagnitude) const;
	public void SetVelocity(float fDistanceX, float fDistanceY, float fDistanceZ, float fNagnitude)
	{
		AIL_set_3D_velocity(m_sample, fDistanceX, fDistanceY, fDistanceZ, fNagnitude);
		AIL_auto_update_3D_position(m_sample, 1);
	}

	public void UpdatePosition(float fElapsedTime)
	{
		AIL_update_3D_position(m_sample, fElapsedTime);
	}

		private H3DSAMPLE m_sample = new H3DSAMPLE();
		private CSoundData m_pSoundData;
}

public class CSoundInstanceStream : ISoundInstance
{
	public CSoundInstanceStream()
	{
		this.m_stream = null;
	}
	public void Dispose()
	...
	public void SetStream(HSTREAM stream)
	{
		m_stream = stream;
	}
	public bool SetSound(CSoundData pSound)
	{
		return true;
	}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void Play(int iLoopCount = 1, uint dwPlayCycleTimeLimit = 0) const;
	public void Play(int count, uint dwPlayCycleTimeLimit)
	{
		if (!IsData())
		{
			return;
...
//Original Metin2 CPlus Line: void SetVelocity(float fx, float fy, float fz, float fMagnitude) const;
	...
	private HSTREAM m_stream = new HSTREAM();
}
