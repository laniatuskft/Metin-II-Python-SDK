...
//Original Metin2 CPlus Line: bool CSoundInstanceStream::IsDone() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool CSoundInstanceStream::IsData() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::Play(int count, uint dwPlayCycleTimeLimit) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::Pause() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::Resume() const


//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::GetVolume(float& rfVolume) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::SetVolume(float volume) const


//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::SetPosition(float x, float y, float z) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstanceStream::SetVelocity(float fx, float fy, float fz, float fMagnitude) const
