...
public class CSoundManager2D : CSoundBase
{
		public const int INSTANCE_MAX_COUNT = 4;

		public CSoundManager2D()
		{
		}
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private uint GetInstance_k = 0;

		public ISoundInstance GetInstance(string c_pszFileName)
		{
...
//			static uint k = 0;
		...
		protected CSoundInstance2D[] ms_Instances = Arrays.InitializeWithDefaultInstances<CSoundInstance2D>(INSTANCE_MAX_COUNT);
}
