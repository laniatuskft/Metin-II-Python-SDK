...
//Original Metin2 CPlus Line: bool CSoundInstance2D::IsDone() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::Play(int iLoopCount, uint dwPlayCycleTimeLimit) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::Pause() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::Resume() const


//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::GetVolume(float& rfVolume) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::SetVolume(float volume) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::SetPosition(float x, float y, float z) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::SetOrientation(float x_face, float y_face, float z_face, float x_normal, float y_normal, float z_normal) const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void CSoundInstance2D::SetVelocity(float fx, float fy, float fz, float fMagnitude) const
