...
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CRYPTOPP_DEFINE_NAME_STRING(name) inline const char *name() {return #name;}
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CRYPTOPP_KEYSTREAM_OUTPUT_WORD(x, b, i, a) PutWord(bool(x & OUTPUT_ALIGNED), b, output+i*sizeof(WordType), (x & INPUT_NULL) ? (a) : (a) ^ GetWord<WordType>(bool(x & INPUT_ALIGNED), b, input+i*sizeof(WordType)));
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CRYPTOPP_KEYSTREAM_OUTPUT_XMM(x, i, a) { __m128i t = (x & INPUT_NULL) ? a : _mm_xor_si128(a, (x & INPUT_ALIGNED) ? _mm_load_si128((__m128i *)input+i) : _mm_loadu_si128((__m128i *)input+i)); if (x & OUTPUT_ALIGNED) _mm_store_si128((__m128i *)output+i, t); else _mm_storeu_si128((__m128i *)output+i, t);}
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CRYPTOPP_KEYSTREAM_OUTPUT_SWITCH(x, y) switch (operation) { case WRITE_KEYSTREAM: x(WRITE_KEYSTREAM) break; case XOR_KEYSTREAM: x(XOR_KEYSTREAM) input += y; break; case XOR_KEYSTREAM_INPUT_ALIGNED: x(XOR_KEYSTREAM_INPUT_ALIGNED) input += y; break; case XOR_KEYSTREAM_OUTPUT_ALIGNED: x(XOR_KEYSTREAM_OUTPUT_ALIGNED) input += y; break; case WRITE_KEYSTREAM_ALIGNED: x(WRITE_KEYSTREAM_ALIGNED) break; case XOR_KEYSTREAM_BOTH_ALIGNED: x(XOR_KEYSTREAM_BOTH_ALIGNED) input += y; break; } output += y;