...
public class CTimer : CSingleton<CTimer>
{
		public CTimer()
		{
			ELTimer_Init();
		...
		public void Adjust(int iTimeGap)
		{
		...
		public uint GetCurrentMillisecond()
		{
			if (m_bUseRealTime)
			{
		...
		public uint GetElapsedMilliecond()
		{
			if (!m_bUseRealTime)
			{
				return (uint)(16 + (m_index & 1));
			}
		...
		protected bool m_bUseRealTime;
		protected uint m_dwBaseTime;
		protected uint m_dwCurrentTime;
		protected float m_fCurrentTime;
		protected uint m_dwElapsedTime;
