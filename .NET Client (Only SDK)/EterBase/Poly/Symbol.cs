...
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define MID_LONG MID_NUMBER + 1
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define MID_SQRT MID_NUMBER + 2
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define MID_FRACTION MID_NUMBER + 3



public class CSymbol : CBase
{
	private int iType;

	public CSymbol()
	{
		id = DefineConstants.MID_SYMBOL;
		iType = DefineConstants.ST_UNKNOWN;
	}
	...
	public static int issymbol(int ch)
	{
		switch (ch)
		{
		case DefineConstants.SY_PLUS :
			return DefineConstants.ST_PLUS;
		case DefineConstants.SY_MINUS :
			return DefineConstants.ST_MINUS;
		case DefineConstants.SY_MULTIPLY:
			return DefineConstants.ST_MULTIPLY;
		case DefineConstants.SY_DIVIDE :
			return DefineConstants.SY_DIVIDE;
		case DefineConstants.SY_CARET :
			return DefineConstants.SY_CARET;
		case DefineConstants.SY_OPEN :
			return DefineConstants.SY_OPEN;
		case DefineConstants.SY_CLOSE :
			return DefineConstants.ST_CLOSE;
		}
		return 0;
	}
