...
public class CLogFile : CSingleton<CLogFile>
{
		public CLogFile()
		{
			this.m_fp = null;
		...
		public void Write(string c_pszMsg)
		{
			if (!m_fp)
			{
				return;
			...
			fprintf(m_fp, "%02d%02d %02d:%02d:%05d :: %s", ctm.tm_mon + 1, ctm.tm_mday, ctm.tm_hour, ctm.tm_min, ELTimer_GetMSec() % 60000, c_pszMsg);
