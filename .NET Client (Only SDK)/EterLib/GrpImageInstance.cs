...
public class CGraphicImageInstance
{
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private static uint Type_s_dwType = GetCRC32("CGraphicImageInstance", strlen("CGraphicImageInstance"));
...
//			static uint s_dwType = GetCRC32("CGraphicImageInstance", strlen("CGraphicImageInstance"));
		...
		public void SetImagePointer(CGraphicImage pImage)
		{
		...
		public void ReloadImagePointer(CGraphicImage pImage)
		{
			if (m_roImage.IsNull())
			{
...
//Original Metin2 CPlus Line: bool IsEmpty() const
		...
		{
			CGraphicImage pkImage = m_roImage.GetPointer();
			return pkImage != null ? pkImage.GetTexturePointer() : null;
		}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool operator == (const CGraphicImageInstance & rhs) const
		public static bool operator == (CGraphicImageInstance ImpliedObject, in CGraphicImageInstance rhs)
		{
		...
		public static CGraphicImageInstance New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CGraphicImageInstance pkImgInst)
		{
			pkImgInst.Destroy();
			ms_kPool.Free(pkImgInst);
		}

		public static CDynamicPool<CGraphicImageInstance> ms_kPool = new CDynamicPool<CGraphicImageInstance>();
}