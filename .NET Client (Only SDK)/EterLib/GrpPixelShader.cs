...
public class CPixelShader : CGraphicBase
{
		public CPixelShader()
		{
			Initialize();
		...
		public bool CreateFromDiskFile(string c_szFileName)
		{
			Destroy();
			...
			if (FAILED(ms_lpd3dDevice.CreatePixelShader((uint)shaderBuffer.GetPointer(), m_handle)))
			{
				return false;
			}
		...
		public void Set()
		{
			(CStateManager.Instance()).SetPixelShader(m_handle);
		}
