...
public class CNetDatagramReceiver
{
		public CNetDatagramReceiver()
		{
			m_recvBuf = null;
			m_recvBufSize = 0;
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		public bool Bind(uint dwAddress, ushort wPortIndex)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		public bool Process()
		{
			...
			m_recvBufCurrentSize = recvfrom(m_Socket, (string)m_recvBuf, m_recvBufSize, 0, (PSOCKADDR) & m_SockAddr, irecvAddrLength);
		...
		public bool Recv(object pBuffer, int iSize)
		{
		...
		public bool Peek(object pBuffer, int iSize)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
		...
		protected uint m_dwPortIndex;

		protected SOCKET m_Socket = new SOCKET();
		protected SOCKADDR_IN m_SockAddr = new SOCKADDR_IN();

		protected int m_recvBufCurrentPos;
		protected int m_recvBufCurrentSize;

		protected string m_recvBuf;
		protected int m_recvBufSize;
}
