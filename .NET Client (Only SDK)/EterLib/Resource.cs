...
//# Laniatus Games Studio Inc. | TODO TASK: Pointer arithmetic is detected on the parameter 'pszRetPathName', so pointers on this parameter are left unchanged:
...
//Original Metin2 CPlus Line: bool CResource::IsData() const

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool CResource::IsEmpty() const
