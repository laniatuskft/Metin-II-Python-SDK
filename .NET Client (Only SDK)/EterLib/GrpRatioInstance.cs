...
public class CGraphicRatioInstance
{
		public CGraphicRatioInstance()
		{
			m_baseTime = 0;
			m_blendTime = 0;
		}
		...
		public void SetRatioReference(in float c_rRatio)
		{
			m_curRatio = c_rRatio;
		...
		public void BlendRatioReference(uint blendTime, in float c_rDstRatio)
		{
			m_baseTime = GetTime();
...
//Original Metin2 CPlus Line: const float& GetCurrentRatioReference() const
		public float GetCurrentRatioReference()
		{
			return m_curRatio;
		}
		...
		protected float m_curRatio;
		protected float m_srcRatio;
		protected float m_dstRatio;
