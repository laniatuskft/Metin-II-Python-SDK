...
public class CPathStack
{
		...
		public void Push()
		{
			string szPathName = new string(new char[MAX_PATH + 1]);
		...
		public bool Pop()
		{
			...
			{
				Debug.Assert(!"CPathStack::Pop Empty Stack");
				return false;
			}
		...
		public void Move(string c_szPathName)
		{
			_chdir(c_szPathName);
		}

		public void GetCurrentPathName(string pstCurPathName)
		{
			Debug.Assert(pstCurPathName != null);
		...
		protected string m_stBasePathName = "";
		protected LinkedList<string> m_stPathNameDeque = new LinkedList<string>();
}
