...
public class CNetworkAddress
{
#if ! VC_EXTRALEAN
		public static bool GetHostName(ref string szName, int size)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		public bool Set(string c_szAddr, int port)
		{
			if (IsIP(c_szAddr))
			{
				SetIP(c_szAddr);
		...
		public void SetIP(string c_szIP)
		{
			m_sockAddrIn.sin_addr.s_addr = inet_addr(c_szIP);
		}

		public bool SetDNS(string c_szDNS)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
		...
		public void GetIP(ref string szIP, int len)
		{
			byte[] IPs = new byte[4];
			(uint)IPs = m_sockAddrIn.sin_addr.s_addr;
...
//Original Metin2 CPlus Line: operator const SOCKADDR_IN&() const
		public static implicit operator SOCKADDR_IN & (CNetworkAddress ImpliedObject)
		{
			return m_sockAddrIn;
		}


		private bool IsIP(string c_szAddr)
		{
		...
		private SOCKADDR_IN m_sockAddrIn = new SOCKADDR_IN();
}
