...
public class CGraphicMarkInstance
{
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private static uint Type_s_dwType = GetCRC32("CGraphicMarkInstance", strlen("CGraphicMarkInstance"));
...
//			static uint s_dwType = GetCRC32("CGraphicMarkInstance", strlen("CGraphicMarkInstance"));
		...
		public void SetImageFileName(string c_szFileName)
		{
...
//		void SetDepth(float fDepth);
		...
		public void Load()
		{
			...
			{
				SetImagePointer((CGraphicImage)pResource);
			}
		}
...
//Original Metin2 CPlus Line: bool IsEmpty() const
		...
		public CGraphicTexture GetTexturePointer()
		{
			return m_roImage.GetTexturePointer();
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const CGraphicTexture & GetTextureReference() const
		public CGraphicTexture GetTextureReference()
		{
			return m_roImage.GetTextureReference();
		}

		public CGraphicImage GetGraphicImagePointer()
		{
			return m_roImage.GetPointer();
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool operator == (const CGraphicMarkInstance & rhs) const
		public static bool operator == (CGraphicMarkInstance ImpliedObject, in CGraphicMarkInstance rhs)
		{
			return (m_roImage.GetPointer() == rhs.m_roImage.GetPointer());
		}

		protected const int MARK_WIDTH = 16;
		protected const int MARK_HEIGHT = 12;
		...
		protected virtual void OnRender()
		{
			...
			if (CGraphicBase.SetPDTStream(vertices, 4))
			{
				...
				(CStateManager.Instance()).SetTexture(0, pTexture.GetD3DTexture());
		...
		protected virtual void OnSetImagePointer()
		{
		}

		protected virtual bool OnIsType(uint dwType)
		{
		...
		protected void SetImagePointer(CGraphicImage pImage)
		{
		...
		protected D3DXCOLOR m_DiffuseColor = new D3DXCOLOR();
		protected D3DXVECTOR2 m_v2Position = new D3DXVECTOR2();

		protected uint m_uIndex;

		protected float m_fScale;
		protected float m_fDepth;

		protected CRef<CGraphicImage> m_roImage = new CRef<CGraphicImage>();
		protected string m_stImageFileName = "";
		...
		public static CGraphicMarkInstance New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CGraphicMarkInstance pkImgInst)
		{
			pkImgInst.Destroy();
			ms_kPool.Free(pkImgInst);
		}

		public static CDynamicPool<CGraphicMarkInstance> ms_kPool = new CDynamicPool<CGraphicMarkInstance>();
}