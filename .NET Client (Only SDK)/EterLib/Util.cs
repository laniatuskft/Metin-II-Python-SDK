...
public class CTransitor <T>
{
		...
		public bool isActiveTime(float fcurTime)
		{
		...
		public void SetSourceValue(in T c_rSourceValue)
		{
			m_SourceValue = c_rSourceValue;
		}

		public void SetTransition(in T c_rSourceValue, in T c_rTargetValue, float fStartTime, float fBlendTime)
		{
			m_SourceValue = c_rSourceValue;
		...
		public bool GetValue(float fcurTime, T pValue)
		{
		...
		protected T m_SourceValue = default(T);
