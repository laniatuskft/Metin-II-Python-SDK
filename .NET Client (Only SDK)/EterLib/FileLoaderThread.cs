...
public class CFileLoaderThread
{
		public class SData
		{
			...
			public CMappedFile File = new CMappedFile();
			public object[] pvBuf;
			public uint dwSize;
		}

		public CFileLoaderThread()
		{
		...
		public void Request(string c_rstFileName)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
		...
		private LinkedList<SData > m_pRequestDeque = new LinkedList<SData >();
		private Mutex m_RequestMutex = new Mutex();

		private LinkedList<SData > m_pCompleteDeque = new LinkedList<SData >();
		private Mutex m_CompleteMutex = new Mutex();
