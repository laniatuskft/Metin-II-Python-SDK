...
public class CTargaResource : CResource
{

//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private static TType Type_s_type = StringToType("CTargaResource");

		public static CTargaResource.TType Type()
		{
...
//			static TType s_type = StringToType("CTargaResource");
		...
		public CTargaResource(string c_pszFileName) : base(c_pszFileName)
		{
		}
...
//Original Metin2 CPlus Line: uint * GetMemPtr()
		public uint GetMemPtr()
		{
			return image.GetBasePointer();
		}

		public void GetRect(ref uint w, ref uint h)
		{
			w = image.GetWidth();
			h = image.GetHeight();
		}

		public TGA_HEADER GetTgaHeader()
		{
			return image.GetHeader();
		}

		protected virtual bool OnLoad(int iSize, object c_pvBuf)
		{
			return image.LoadFromMemory(iSize, (byte)c_pvBuf);
		}
...
//Original Metin2 CPlus Line: virtual bool OnIsEmpty() const
		protected virtual bool OnIsEmpty()
		{
			return image.IsEmpty();
		}

		protected virtual bool OnIsType(TType type)
		{
		...
		protected CTGAImage image = new CTGAImage();
}
