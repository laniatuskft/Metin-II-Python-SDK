...
public class CGraphicImage : CResource
{

//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private static TType Type_s_type = StringToType("CGraphicImage");

		public static CGraphicImage.TType Type()
		{
...
//			static TType s_type = StringToType("CGraphicImage");
		...
		public CGraphicImage(string c_szFileName, uint dwFilter = (uint)(3 << 0)) : base(c_szFileName)
		{
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const RECT& GetRectReference() const
...
//Original Metin2 CPlus Line: bool OnIsEmpty() const
		...
		protected CGraphicImageTexture m_imageTexture = new CGraphicImageTexture();
