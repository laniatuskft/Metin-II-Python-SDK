...
public class CGraphicShadowTexture : CGraphicTexture
{
		public CGraphicShadowTexture()
		{
			Initialize();
		}
		...
		public void Begin()
		{
			...
			D3DVIEWPORT8 d3dViewport = new D3DVIEWPORT8();
			...
			(CStateManager.Instance()).SaveRenderState(D3DRS_TEXTUREFACTOR, 0xbb000000);

			(CStateManager.Instance()).SetTexture(0, null);
			(CStateManager.Instance()).SaveTextureStageState(0, D3DTSS_COLORARG1, D3DTA_TFACTOR);
			(CStateManager.Instance()).SaveTextureStageState(0, D3DTSS_COLORARG2, D3DTA_TEXTURE);
			(CStateManager.Instance()).SaveTextureStageState(0, D3DTSS_COLOROP, D3DTOP_MODULATE);
			(CStateManager.Instance()).SaveTextureStageState(0, D3DTSS_ALPHAARG1, D3DTA_TFACTOR);
			(CStateManager.Instance()).SaveTextureStageState(0, D3DTSS_ALPHAARG2, D3DTA_TEXTURE);
			...
			(CStateManager.Instance()).SaveTextureStageState(1, D3DTSS_COLORARG1, D3DTA_CURRENT);
			(CStateManager.Instance()).SaveTextureStageState(1, D3DTSS_COLORARG2, D3DTA_TEXTURE);
			(CStateManager.Instance()).SaveTextureStageState(1, D3DTSS_COLOROP, D3DTOP_SELECTARG1);
			(CStateManager.Instance()).SaveTextureStageState(1, D3DTSS_ALPHAARG1, D3DTA_CURRENT);
			(CStateManager.Instance()).SaveTextureStageState(1, D3DTSS_ALPHAARG2, D3DTA_TEXTURE);
		...
		public void End()
		{
			Debug.Assert(m_lpd3dOldBackBufferSurface != null);
			Debug.Assert(m_lpd3dOldDepthBufferSurface != null);
...
//Original Metin2 CPlus Line: void Set(int stage = 0) const
		public void Set(int stage = 0)
		{
			(CStateManager.Instance()).SetTexture(stage, m_lpd3dShadowTexture);
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const struct _D3DMATRIX& GetLightVPMatrixReference() const
		public _D3DMATRIX GetLightVPMatrixReference()
		{
			return m_d3dLightVPMatrix;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: LPDIRECT3DTEXTURE8 GetD3DTexture() const
		public LPDIRECT3DTEXTURE8 GetD3DTexture()
		{
		...
		protected _D3DMATRIX m_d3dLightVPMatrix = new _D3DMATRIX();
		protected D3DVIEWPORT8 m_d3dOldViewport = new D3DVIEWPORT8();

		protected LPDIRECT3DTEXTURE8 m_lpd3dShadowTexture = new LPDIRECT3DTEXTURE8();
		protected LPDIRECT3DSURFACE8 m_lpd3dShadowSurface = new LPDIRECT3DSURFACE8();
		protected LPDIRECT3DSURFACE8 m_lpd3dDepthSurface = new LPDIRECT3DSURFACE8();

		protected LPDIRECT3DSURFACE8 m_lpd3dOldBackBufferSurface = new LPDIRECT3DSURFACE8();
		protected LPDIRECT3DSURFACE8 m_lpd3dOldDepthBufferSurface = new LPDIRECT3DSURFACE8();
}
