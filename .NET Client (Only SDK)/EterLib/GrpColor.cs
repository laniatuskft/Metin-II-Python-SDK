...
public class CGraphicColor
{
		public CGraphicColor(in CGraphicColor c_rSrcColor)
		{
			Set(c_rSrcColor);
		}

		public CGraphicColor(float r, float g, float b, float a)
		{
			Set(r, g, b, a);
		}

		public CGraphicColor(uint color)
		{
			Set(color);
		}

		public CGraphicColor()
		{
			Clear();
		}
		...
		public void Set(in CGraphicColor c_rSrcColor)
		{
			m_r = c_rSrcColor.m_r;
			m_g = c_rSrcColor.m_g;
			m_b = c_rSrcColor.m_b;
		...
		public void Blend(float p, in CGraphicColor c_rSrcColor, in CGraphicColor c_rDstColor)
		{
			float q = 1.0f - p;
...
//Original Metin2 CPlus Line: uint GetPackValue() const
		public uint GetPackValue()
		{
			uint packValue = 0;

			packValue = (uint)((int)(255.0f * m_a));
			packValue <<= 8;
			packValue |= (uint)((int)(255.0f * m_r));
			packValue <<= 8;
			packValue |= (uint)((int)(255.0f * m_g));
			packValue <<= 8;
			packValue |= (uint)((int)(255.0f * m_b));
