...
public class CRay
{
		public CRay(in D3DXVECTOR3 v3Start, in D3DXVECTOR3 v3Dir, float fRayRange)
		{
			this.m_v3Start = v3Start;
			this.m_v3Direction = v3Dir;
			Debug.Assert(fRayRange >= 0F);
		...
		public void SetStartPoint(in D3DXVECTOR3 v3Start)
		{
			m_v3Start = v3Start;
		}

		public void SetDirection(in D3DXVECTOR3 v3Dir, float fRayRange)
		{
			Debug.Assert(fRayRange >= 0F);
			m_v3Direction = v3Dir;
			D3DXVec3Normalize(m_v3Direction, m_v3Direction);
...
//Original Metin2 CPlus Line: void GetStartPoint(D3DXVECTOR3 * pv3Start) const
		public void GetStartPoint(D3DXVECTOR3 pv3Start)
		{
			pv3Start = m_v3Start;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void GetDirection(D3DXVECTOR3 * pv3Dir, float * pfRayRange) const
		public void GetDirection(D3DXVECTOR3 pv3Dir, ref float pfRayRange)
		{
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void GetEndPoint(D3DXVECTOR3 * pv3End) const
		public void GetEndPoint(D3DXVECTOR3 pv3End)
		{
			pv3End = m_v3End;
		}

//# Laniatus Games Studio Inc. |: This 'CopyFrom' method was converted from the original copy assignment operator:
//Original Metin2 CPlus Line: const CRay & operator = (const CRay & rhs)
		public CRay CopyFrom (in CRay rhs)
		{
			Debug.Assert(rhs.m_fRayRange >= 0);
		...
		private D3DXVECTOR3 m_v3Start = new D3DXVECTOR3();
		private D3DXVECTOR3 m_v3End = new D3DXVECTOR3();
		private D3DXVECTOR3 m_v3Direction = new D3DXVECTOR3();
		private float m_fRayRange;
}
