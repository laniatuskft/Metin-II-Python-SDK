...
public class CColorTransitionHelper
{
		public CColorTransitionHelper()
		{
			this.m_bTransitionStarted = false;
		...
		public void Clear(in float c_rfRed, in float c_rfGreen, in float c_rfBlue, in float c_rfAlpha)
		{
		...
		public void SetSrcColor(in float c_rfRed, in float c_rfGreen, in float c_rfBlue, in float c_rfAlpha)
		{
			m_fSrcRed = c_rfRed;
			m_fSrcGreen = c_rfGreen;
			m_fSrcBlue = c_rfBlue;
		...
		public void SetTransition(in float c_rfRed, in float c_rfGreen, in float c_rfBlue, in float c_rfAlpha, in uint dwDuration)
		{
			m_fDstRed = c_rfRed;
			m_fDstGreen = c_rfGreen;
			m_fDstBlue = c_rfBlue;
		...
		public bool Update()
		{
			uint dwCurTime = GetCurrentTime();
			uint dwElapsedTime = dwCurTime - m_dwStartTime;
			...
			m_dwCurColor = (((uint)(fCurAlpha * 255.0f) & 0xff) << 24) | (((uint)(fCurRed * 255.0f) & 0xff) << 16) | (((uint)(fCurGreen * 255.0f) & 0xff) << 8) | ((uint)(fCurBlue * 255.0f) & 0xff);
		...
		public bool isTransitionStarted()
		{
		 ...
		 private D3DCOLOR m_dwCurColor = new D3DCOLOR();

		private uint m_dwStartTime;
		private uint m_dwDuration;

		private bool m_bTransitionStarted;

		private float m_fSrcRed;
		private float m_fSrcGreen;
		private float m_fSrcBlue;
		private float m_fSrcAlpha;
		private float m_fDstRed;
		private float m_fDstGreen;
		private float m_fDstBlue;
		private float m_fDstAlpha;
}
