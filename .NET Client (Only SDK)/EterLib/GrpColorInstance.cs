...
public class CGraphicColorInstance
{
		public CGraphicColorInstance()
		{
			m_baseTime = 0;
			m_blendTime = 0;
		}
		...
		public void SetColorReference(in CGraphicColor c_rSrcColor)
		{
		...
		public void BlendColorReference(uint blendTime, in CGraphicColor c_rDstColor)
		{
		...
		public void Update()
		{
			uint curTime = GetCurrentTime();
			uint elapsedTime = curTime - m_baseTime;
...
//Original Metin2 CPlus Line: const CGraphicColor& GetCurrentColorReference() const
		public CGraphicColor GetCurrentColorReference()
		{
			return m_curColor;
		}

		protected uint GetCurrentTime()
		{
			return CTimer.Instance().GetCurrentMillisecond();
		}

		protected CGraphicColor m_srcColor = new CGraphicColor();
		protected CGraphicColor m_dstColor = new CGraphicColor();
		protected CGraphicColor m_curColor = new CGraphicColor();

		protected uint m_baseTime;
		protected uint m_blendTime;
}
