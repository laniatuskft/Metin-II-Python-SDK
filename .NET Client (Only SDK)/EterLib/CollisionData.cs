...
public class SSphereData
{
	public D3DXVECTOR3 v3Position = new D3DXVECTOR3();
	public float fRadius;
}

public class SPlaneData
{
	public D3DXVECTOR3 v3Position = new D3DXVECTOR3();
	public D3DXVECTOR3 v3Normal = new D3DXVECTOR3();

	public D3DXVECTOR3[] v3QuadPosition = Arrays.InitializeWithDefaultInstances<D3DXVECTOR3>(4);
	public D3DXVECTOR3[] v3InsideVector = Arrays.InitializeWithDefaultInstances<D3DXVECTOR3>(4);
}

public class SAABBData
{
	public D3DXVECTOR3 v3Min = new D3DXVECTOR3();
	public D3DXVECTOR3 v3Max = new D3DXVECTOR3();

}

public class SOBBData
{
	public D3DXVECTOR3 v3Min = new D3DXVECTOR3();
	public D3DXVECTOR3 v3Max = new D3DXVECTOR3();
	public D3DXMATRIX matRot = new D3DXMATRIX();

}

public class SCylinderData
{
	public D3DXVECTOR3 v3Position = new D3DXVECTOR3();
	public float fRadius;
...
public class CDynamicSphereInstance
{
	public D3DXVECTOR3 v3Position = new D3DXVECTOR3();
	public D3DXVECTOR3 v3LastPosition = new D3DXVECTOR3();

	public float fRadius;
}

public class CStaticCollisionData
{
	public uint dwType;
	public string szName = new string(new char[32 + 1]);

	public D3DXVECTOR3 v3Position = new D3DXVECTOR3();
	public float[] fDimensions = new float[3];
	public D3DXQUATERNION quatRotation = new D3DXQUATERNION();
}


public class CBaseCollisionInstance
{
		public abstract void Render(D3DFILLMODE d3dFillMode = D3DFILL_SOLID);
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: D3DXVECTOR3 GetCollisionMovementAdjust(const CDynamicSphereInstance & s) const
		public D3DXVECTOR3 GetCollisionMovementAdjust(in CDynamicSphereInstance s)
		{
...
//		static CBaseCollisionInstance BuildCollisionInstance(CStaticCollisionData c_pCollisionData, D3DXMATRIX pMat);

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual D3DXVECTOR3 OnGetCollisionMovementAdjust(const CDynamicSphereInstance & s) const = 0;
		protected abstract D3DXVECTOR3 OnGetCollisionMovementAdjust(in CDynamicSphereInstance s);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual bool OnMovementCollisionDynamicSphere(const CDynamicSphereInstance & s) const = 0;
		protected abstract bool OnMovementCollisionDynamicSphere(in CDynamicSphereInstance s);
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual bool OnCollisionDynamicSphere(const CDynamicSphereInstance & s) const = 0;
		protected abstract bool OnCollisionDynamicSphere(in CDynamicSphereInstance s);
		protected abstract void OnDestroy();
}

public class CSphereCollisionInstance : CBaseCollisionInstance
{
		public SSphereData GetAttribute()
		{
			return m_attribute;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const SSphereData & GetAttribute() const
		public SSphereData GetAttribute()
		{
			return m_attribute;
		}
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private CScreen Render_s = new CScreen();

		public virtual void Render(D3DFILLMODE d3dFillMode = D3DFILL_SOLID)
		{
...
//			static CScreen s;
			...
			Render_s.RenderSphere(null, m_attribute.v3Position.x, m_attribute.v3Position.y, m_attribute.v3Position.z, m_attribute.fRadius, d3dFillMode);
		}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool OnMovementCollisionDynamicSphere(const CDynamicSphereInstance & s) const
		protected bool OnMovementCollisionDynamicSphere(in CDynamicSphereInstance s)
		{
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual bool OnCollisionDynamicSphere(const CDynamicSphereInstance & s) const
		protected virtual bool OnCollisionDynamicSphere(in CDynamicSphereInstance s)
		{
			if (square_distance_between_linesegment_and_point(s.v3LastPosition,s.v3Position,m_attribute.v3Position) < (m_attribute.fRadius + s.fRadius) * (m_attribute.fRadius + s.fRadius))
			{
				return true;
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual struct _D3DVECTOR OnGetCollisionMovementAdjust(const CDynamicSphereInstance & s) const
		protected virtual _D3DVECTOR OnGetCollisionMovementAdjust(in CDynamicSphereInstance s)
		{
			...
			float sq = Math.Sqrt(sum * sum - 4 * mul);
			float t1 = -sum - sq;
			float t2 = -sum + sq;
			t1 *= 0.5f;
			t2 *= 0.5f;
		...
		protected SSphereData m_attribute = new SSphereData();
}

public class CPlaneCollisionInstance : CBaseCollisionInstance
{
		public SPlaneData GetAttribute()
		{
			return m_attribute;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const SPlaneData & GetAttribute() const
		public SPlaneData GetAttribute()
		{
			return m_attribute;
		}
...
//# Laniatus Games Studio Inc. |: This static local variable declaration (not allowed in C#) has been moved just prior to the method:
//			static CScreen s;
			Render_s.RenderBar3d(m_attribute.v3QuadPosition);
		}
...
//Original Metin2 CPlus Line: bool OnMovementCollisionDynamicSphere(const CDynamicSphereInstance & s) const
		protected bool OnMovementCollisionDynamicSphere(in CDynamicSphereInstance s)
		{
			_D3DVECTOR v3SpherePosition = s.v3Position - m_attribute.v3Position;
			_D3DVECTOR v3SphereLastPosition = s.v3LastPosition - m_attribute.v3Position;
			...
			{
				_D3DVECTOR v3QuadPosition1 = s.v3Position - m_attribute.v3QuadPosition[0];
				_D3DVECTOR v3QuadPosition2 = s.v3Position - m_attribute.v3QuadPosition[3];
				...
				if (D3DXVec3Dot(v3QuadPosition1, m_attribute.v3InsideVector[0]) > - s.fRadius)
				{
					if (D3DXVec3Dot(v3QuadPosition1, m_attribute.v3InsideVector[1]) > -s.fRadius)
					{
						if (D3DXVec3Dot(v3QuadPosition2, m_attribute.v3InsideVector[2]) > - s.fRadius)
						{
							...
							{
								if (Math.Abs(D3DXVec3Dot((s.v3Position - m_attribute.v3Position), m_attribute.v3Normal)) < Math.Abs(D3DXVec3Dot((s.v3LastPosition - m_attribute.v3Position), m_attribute.v3Normal)))
								{
									return true;
								}
							}
...
//Original Metin2 CPlus Line: virtual struct _D3DVECTOR OnGetCollisionMovementAdjust(const CDynamicSphereInstance & s) const
		protected virtual _D3DVECTOR OnGetCollisionMovementAdjust(in CDynamicSphereInstance s)
		{
			_D3DVECTOR advance = s.v3Position - s.v3LastPosition;
		...
		protected SPlaneData m_attribute = new SPlaneData();
}

public class CAABBCollisionInstance : CBaseCollisionInstance
{
		public SAABBData GetAttribute()
		{
			return m_attribute;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const SAABBData & GetAttribute() const
		public SAABBData GetAttribute()
		{
...
//			static CScreen s;
			(CStateManager.Instance()).SetRenderState(D3DRS_TEXTUREFACTOR, 0xffffffff);
			Render_s.RenderCube(m_attribute.v3Min.x, m_attribute.v3Min.y, m_attribute.v3Min.z, m_attribute.v3Max.x, m_attribute.v3Max.y, m_attribute.v3Max.z);
			return;
		}
...
//Original Metin2 CPlus Line: bool OnMovementCollisionDynamicSphere(const CDynamicSphereInstance & s) const
		protected bool OnMovementCollisionDynamicSphere(in CDynamicSphereInstance s)
		{
			...
			_D3DVECTOR v3center = (m_attribute.v3Min + m_attribute.v3Max) * 0.5f;

//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
			memcpy(v, s.v3Position, sizeof(_D3DVECTOR));
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
			memcpy(v, s.v3LastPosition, sizeof(_D3DVECTOR));
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
			...
			if (v.x > m_attribute.v3Min.x && v.x < m_attribute.v3Max.x && v.y > m_attribute.v3Min.y && v.y < m_attribute.v3Max.y && v.z > m_attribute.v3Min.z && v.z < m_attribute.v3Max.z)
			{
				return true;
			}
...
//Original Metin2 CPlus Line: virtual struct _D3DVECTOR OnGetCollisionMovementAdjust(const CDynamicSphereInstance & s) const
		protected virtual _D3DVECTOR OnGetCollisionMovementAdjust(in CDynamicSphereInstance s)
		{
			_D3DVECTOR v3Temp = new _D3DVECTOR();
			...
			{
				return struct _D3DVECTOR(.0f, .0f, .0f);
			}
		...
		protected SAABBData m_attribute = new SAABBData();
}

public class COBBCollisionInstance : CBaseCollisionInstance
{
		public SOBBData GetAttribute()
		{
			return m_attribute;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const SOBBData & GetAttribute() const
		public SOBBData GetAttribute()
		{
...
//			static CScreen s;
			(CStateManager.Instance()).SetRenderState(D3DRS_TEXTUREFACTOR, 0xffffffff);
			Render_s.RenderCube(m_attribute.v3Min.x, m_attribute.v3Min.y, m_attribute.v3Min.z, m_attribute.v3Max.x, m_attribute.v3Max.y, m_attribute.v3Max.z, m_attribute.matRot);
			return;
		}
...
//Original Metin2 CPlus Line: bool OnMovementCollisionDynamicSphere(const CDynamicSphereInstance & s) const
		protected bool OnMovementCollisionDynamicSphere(in CDynamicSphereInstance s)
		{
			_D3DVECTOR v3Center = 0.5f * (m_attribute.v3Min + m_attribute.v3Max);
			_D3DVECTOR v3Sphere = s.v3Position - v3Center;
...
//Original Metin2 CPlus Line: v3Sphere = v3Sphere + v3Center;
			v3Sphere.CopyFrom(v3Sphere + v3Center);

			_D3DVECTOR v3Point = new _D3DVECTOR(v3Sphere);
...
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: v3Point = v3Sphere;
			v3Point.CopyFrom(v3Sphere);
			if (v3Point.x < m_attribute.v3Min.x)
			{
				v3Point.x = m_attribute.v3Min.x;
			}
...
//Original Metin2 CPlus Line: virtual struct _D3DVECTOR OnGetCollisionMovementAdjust(const CDynamicSphereInstance & s) const
		...
		protected SOBBData m_attribute = new SOBBData();
}

public class CCylinderCollisionInstance : CBaseCollisionInstance
{
		public SCylinderData GetAttribute()
		{
			return m_attribute;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const SCylinderData & GetAttribute() const
		public SCylinderData GetAttribute()
		{
			return m_attribute;
		}
...
//			static CScreen s;
			(CStateManager.Instance()).SetRenderState(D3DRS_TEXTUREFACTOR, 0xffffffff);
			Render_s.RenderCylinder(null, m_attribute.v3Position.x, m_attribute.v3Position.y, m_attribute.v3Position.z + m_attribute.fHeight / 2, m_attribute.fRadius, m_attribute.fHeight, d3dFillMode);
		}
...
//Original Metin2 CPlus Line: bool OnMovementCollisionDynamicSphere(const CDynamicSphereInstance & s) const
		protected bool OnMovementCollisionDynamicSphere(in CDynamicSphereInstance s)
		{
			...
			_D3DVECTOR v3Distance = s.v3Position - s.v3LastPosition;
			...
			{
				SCylinderData cylinder = new SCylinderData();
				cylinder = m_attribute;
				cylinder.v3Position = s.v3LastPosition;

				int iStep = fDistance / s.fRadius * 2.0f;
				_D3DVECTOR v3Step = v3Distance / (float)iStep;

				for (int LaniatusDefVariables = 0; LaniatusDefVariables < iStep; ++i)
				{
...
//Original Metin2 CPlus Line: virtual struct _D3DVECTOR OnGetCollisionMovementAdjust(const CDynamicSphereInstance & s) const
		protected virtual _D3DVECTOR OnGetCollisionMovementAdjust(in CDynamicSphereInstance s)
		{
			_D3DVECTOR v3Position = m_attribute.v3Position;
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool CollideCylinderVSDynamicSphere(const SCylinderData & c_rattribute, const CDynamicSphereInstance & s) const
		protected bool CollideCylinderVSDynamicSphere(in SCylinderData c_rattribute, in CDynamicSphereInstance s)
		{
			...
			_D3DVECTOR oa = new _D3DVECTOR();
			_D3DVECTOR ob = new _D3DVECTOR();
		...
		protected SCylinderData m_attribute = new SCylinderData();
}
