...
public class CGraphicExpandedImageInstance : CGraphicImageInstance
{
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private static uint Type_s_dwType = GetCRC32("CGraphicExpandedImageInstance", strlen("CGraphicExpandedImageInstance"));
...
//			static uint s_dwType = GetCRC32("CGraphicExpandedImageInstance", strlen("CGraphicExpandedImageInstance"));
			return (Type_s_dwType);
		}

		public static void DeleteExpandedImageInstance(CGraphicExpandedImageInstance pkInstance)
		{
			pkInstance.Destroy();
		...
		public CGraphicExpandedImageInstance()
		{
			Initialize();
		}
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		protected void OnRender()
		{
			...
			RECT c_rRect = pImage.GetRectReference();
			...
			if (0.0f == m_fRotation)
			{
				...
				{
					(CStateManager.Instance()).SetRenderState(D3DRS_CULLMODE, D3DCULL_CCW);
				}
			}
			else
			{
			...
			switch (m_iRenderingMode)
			{
				...
				case RENDERING_MODE_COLOR_DODGE:
					(CStateManager.Instance()).SaveRenderState(D3DRS_SRCBLEND, D3DBLEND_INVDESTCOLOR);
			...
			(CStateManager.Instance()).SetRenderState(D3DRS_CULLMODE, D3DCULL_CW);
		}

		protected void OnSetImagePointer()
		{
			if (IsEmpty())
			{
				return;
		...
		protected D3DXVECTOR2 m_v2Origin = new D3DXVECTOR2();
		protected D3DXVECTOR2 m_v2Scale = new D3DXVECTOR2();
		protected float m_fRotation;
		protected RECT m_RenderingRect = new RECT();
		protected int m_iRenderingMode;
		...
		public static CGraphicExpandedImageInstance New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CGraphicExpandedImageInstance pkImgInst)
		{
			pkImgInst.Destroy();
			ms_kPool.Free(pkImgInst);
		}

		public static CDynamicPool<CGraphicExpandedImageInstance> ms_kPool = new CDynamicPool<CGraphicExpandedImageInstance>();
}