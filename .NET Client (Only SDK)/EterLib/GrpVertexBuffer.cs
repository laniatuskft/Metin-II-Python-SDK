...
public class CGraphicVertexBuffer : CGraphicBase
{
		public CGraphicVertexBuffer()
		{
			Initialize();
		}
		...
		public virtual bool Create(int vtxCount, uint fvf, uint usage, D3DPOOL d3dPool)
		{
			Debug.Assert(ms_lpd3dDevice != null);
			Debug.Assert(vtxCount > 0);
		...
		{
			Debug.Assert(ms_lpd3dDevice != null);
			Debug.Assert(m_lpd3dVB == null);

			if (FAILED(ms_lpd3dDevice.CreateVertexBuffer(m_dwBufferSize, m_dwUsage, m_dwFVF, m_d3dPool, m_lpd3dVB)))
			{
				return false;
			}
		...
		public bool Copy(int bufSize, object srcVertices)
		{
			object dstVertices;
...
//Original Metin2 CPlus Line: bool LockRange(uint count, object** pretVertices) const
		public bool LockRange(uint count, object[] pretVertices)
		{
			if (!m_lpd3dVB)
			{
				return false;
			...
			uint dwLockSize = GetVertexStride() * count;
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool Lock(object** pretVertices) const
		public bool Lock(object[] pretVertices)
		{
			if (!m_lpd3dVB)
			{
				return false;
			...
			uint dwLockSize = GetVertexStride() * GetVertexCount();
			if (FAILED(m_lpd3dVB.Lock(0, dwLockSize, (byte) pretVertices, m_dwLockFlag)))
			{
				return false;
			}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool Unlock() const
		public bool Unlock()
		{
			if (!m_lpd3dVB)
			{
		...
		public bool LockDynamic(object[] pretVertices)
		{
			if (!m_lpd3dVB)
			{
				return false;
		...
		public virtual bool Lock(object[] pretVertices)
		{
			if (!m_lpd3dVB)
			{
				return false;
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetStream(int stride, int layer =0) const
		public void SetStream(int stride, int layer = 0)
		{
			Debug.Assert(ms_lpd3dDevice != null);
			(CStateManager.Instance()).SetStreamSource(layer, m_lpd3dVB, stride);
		}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: int GetVertexStride() const
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: uint GetFlexibleVertexFormat() const
		public uint GetFlexibleVertexFormat()
		{
			return m_dwFVF;
		}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: inline LPDIRECT3DVERTEXBUFFER8 GetD3DVertexBuffer() const
		public LPDIRECT3DVERTEXBUFFER8 GetD3DVertexBuffer()
		{
			return m_lpd3dVB;
		}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: inline uint GetBufferSize() const
...
//Original Metin2 CPlus Line: bool IsEmpty() const
		...
		protected LPDIRECT3DVERTEXBUFFER8 m_lpd3dVB = new LPDIRECT3DVERTEXBUFFER8();

		protected uint m_dwBufferSize;
		protected uint m_dwFVF;
		protected uint m_dwUsage;
		protected D3DPOOL m_d3dPool = new D3DPOOL();
		protected int m_vtxCount;
		protected uint m_dwLockFlag;
}
