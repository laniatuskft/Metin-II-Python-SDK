...
public class CGraphicTexture : CGraphicBase
{
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual bool IsEmpty() const
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetTextureStage(int stage) const
		public void SetTextureStage(int stage)
		{
			Debug.Assert(ms_lpd3dDevice != null);
			(CStateManager.Instance()).SetTexture(stage, m_lpd3dTexture);
		}
