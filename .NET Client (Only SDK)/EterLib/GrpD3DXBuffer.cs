...
public class CDirect3DXBuffer
{
		public CDirect3DXBuffer()
		{
			m_lpd3dxBuffer = null;
		}

		public CDirect3DXBuffer(LPD3DXBUFFER lpd3dxBuffer)
		{
		...
		public void Create(LPD3DXBUFFER lpd3dxBuffer)
		{
			Destroy();
			m_lpd3dxBuffer = lpd3dxBuffer;
		}
		...
		{
			Debug.Assert(m_lpd3dxBuffer != null);
		...
		protected LPD3DXBUFFER m_lpd3dxBuffer = new LPD3DXBUFFER();
}
