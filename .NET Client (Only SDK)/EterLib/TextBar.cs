...
public class CTextBar : CDibBar
{
		public CTextBar(int fontSize, bool isBold)
		{
			m_hOldFont = null;
			m_fontSize = fontSize;
			m_isBold = isBold;
		...
		{
			IntPtr hDC = m_dib.GetDCHandle();
			global::SetTextColor(hDC, RGB(r, g, b));
		}

		public void GetTextExtent(string c_szText, SIZE p_size)
		{
			IntPtr hDC = m_dib.GetDCHandle();
			GetTextExtentPoint32(hDC, c_szText, strlen(c_szText), p_size);
		}

		protected void __SetFont(int fontSize, bool isBold)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
			...
			IntPtr hdc = m_dib.GetDCHandle();
			m_hOldFont = (IntPtr)SelectObject(hdc, m_hFont);
