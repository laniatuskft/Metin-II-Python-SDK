...
public class CNetworkPacketHeaderMap
{
		...
		{
			public SPacketType(int iSize = 0, bool bFlag = false)
			{
				iPacketSize = iSize;
			...
			public bool isDynamicSizePacket;
		}

		public CNetworkPacketHeaderMap()
		{
		}
...
//		void Set(int header, SPacketType rPacketType);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool Get(int header, SPacketType pPacketType);

		protected SortedDictionary<int, SPacketType> m_headerMap = new SortedDictionary<int, SPacketType>();
}
