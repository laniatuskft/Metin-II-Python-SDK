...
public class CScreenFilter : CScreen
{
		public CScreenFilter()
		{
			m_bEnable = false;
		...
		public void SetEnable(bool bFlag)
		{
			m_bEnable = false;
		}

		public void SetBlendType(byte bySrcType, byte byDestType)
		{
			m_bySrcType = bySrcType;
			m_byDestType = byDestType;
		}

		public void SetColor(in D3DXCOLOR c_rColor)
		{
			m_Color = c_rColor;
		}
		...
		public void Render()
		{
			...
			(CStateManager.Instance()).SaveTransform(D3DTS_PROJECTION, ms_matIdentity);
			...
			(CStateManager.Instance()).SaveRenderState(D3DRS_SRCBLEND, m_bySrcType);
			(CStateManager.Instance()).SaveRenderState(D3DRS_DESTBLEND, m_byDestType);
		...
		protected byte m_bySrcType;
		protected byte m_byDestType;
		protected D3DXCOLOR m_Color = new D3DXCOLOR();
}
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
