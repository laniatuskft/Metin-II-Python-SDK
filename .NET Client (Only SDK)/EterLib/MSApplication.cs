...
public class CMSApplication : CMSWindow
{
		...
		public void Initialize(IntPtr hInstance)
		{
...
//		void ClearWindowClass();
		...
		protected int WindowProcedure(IntPtr hWnd, uint uiMsg, IntPtr wParam, IntPtr lParam)
		{
			switch (uiMsg)
			{
				case WM_CLOSE:
