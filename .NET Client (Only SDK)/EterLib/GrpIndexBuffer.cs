...
public class CGraphicIndexBuffer : CGraphicBase
{
		public CGraphicIndexBuffer()
		{
			Initialize();
		}
		...
		public bool Create(int idxCount, D3DFORMAT d3dFmt)
		{
			Destroy();

			m_iidxCount = idxCount;
			m_dwBufferSize = sizeof(ushort) * idxCount;
			m_d3dFmt = d3dFmt;

			return CreateDeviceObjects();
		}

		public bool Create(int faceCount, SFace faces)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: Pointer arithmetic is detected on this variable, so pointers on this variable are left unchanged:
			...
			for (int LaniatusDefVariables = 0; LaniatusDefVariables < faceCount; ++i, dstIndices += 3)
			{
				SFace curFace = faces + i;
		...
		public bool Copy(int bufSize, object srcIndices)
		{
			Debug.Assert(m_lpd3dIdxBuf != null);

//# Laniatus Games Studio Inc. | TODO TASK: C# does not have an equivalent to pointers to value types:
//Original Metin2 CPlus Line: byte* dstIndices;
			byte dstIndices;
...
//Original Metin2 CPlus Line: bool Lock(object** pretIndices) const
		public bool Lock(object[] pretIndices)
		{
			Debug.Assert(m_lpd3dIdxBuf != null);
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void Unlock() const
		public void Unlock()
		{
			Debug.Assert(m_lpd3dIdxBuf != null);
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: void SetIndices(int startIndex =0) const
		public void SetIndices(int startIndex = 0)
		{
			Debug.Assert(ms_lpd3dDevice != null);
			(CStateManager.Instance()).SetIndices(m_lpd3dIdxBuf, startIndex);
		}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: int GetIndexCount() const
		...
		protected LPDIRECT3DINDEXBUFFER8 m_lpd3dIdxBuf = new LPDIRECT3DINDEXBUFFER8();
		protected uint m_dwBufferSize;
		protected D3DFORMAT m_d3dFmt = new D3DFORMAT();
		protected int m_iidxCount;
}
