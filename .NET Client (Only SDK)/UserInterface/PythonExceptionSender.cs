...
public class CPythonExceptionSender : IPythonExceptionSender
{
		public CPythonExceptionSender()
		{
		}
		...
		protected SortedSet<uint> m_kSet_dwSendedExceptionCRC = new SortedSet<uint>();
}
