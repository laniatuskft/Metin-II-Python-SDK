...
{
		public class SCreateData
		{
			public byte m_bType;
			public uint m_dwStateFlags;
			public uint m_dwEmpireID;
			public uint m_dwGuildID;
			public uint m_dwLevel;
			public uint m_dwVID;
			public uint m_dwRace;
			public uint m_dwMovSpd;
			public uint m_dwAtkSpd;
			public int m_lPosX;
			public int m_lPosY;
			public float m_fRot;
			public uint m_dwArmor;
			public uint m_dwWeapon;
			public uint m_dwHair;
			public uint m_dwAcce;
			public uint m_byAcceDrainRate;
			public uint m_dwMountVnum;
			public uint m_dwArrow;
#if ENABLE_MULTI_LANGUAGE_SYSTEM
			public byte m_bLanguage;
#endif
			public short m_sAlignment;
			public byte m_byPKMode;
			public CAffectFlagContainer m_kAffectFlags = new CAffectFlagContainer();
		...
		public const int FUNC_MOVE = 1;
		public const int FUNC_ATTACK = 2;
		public const int FUNC_COMBO = 3;
		public const int FUNC_MOB_SKILL = 4;
		public const int FUNC_EMOTION = 5;
		public const int FUNC_SKILL = 0x80;

		public const int AFFECT_YMIR = 0;
		public const int AFFECT_INVISIBILITY = 1;
		public const int AFFECT_SPAWN = 2;
		public const int AFFECT_POISON = 3;
		public const int AFFECT_SLOW = 4;
		public const int AFFECT_STUN = 5;
		public const int AFFECT_DUNGEON_READY = 6;
		public const int AFFECT_SHOW_ALWAYS = 7;
		public const int AFFECT_BUILDING_CONSTRUCTION_SMALL = 8;
		public const int AFFECT_BUILDING_CONSTRUCTION_LARGE = 9;
		public const int AFFECT_BUILDING_UPGRADE = 10;
		public const int AFFECT_MOV_SPEED_POTION = 11;
		public const int AFFECT_ATT_SPEED_POTION = 12;
		public const int AFFECT_FISH_MIND = 13;
		public const int AFFECT_JEONGWI = 14;
		public const int AFFECT_GEOMGYEONG = 15;
		public const int AFFECT_CHEONGEUN = 16;
		public const int AFFECT_GYEONGGONG = 17;
		public const int AFFECT_EUNHYEONG = 18;
		public const int AFFECT_GWIGEOM = 19;
		public const int AFFECT_GONGPO = 20;
		public const int AFFECT_JUMAGAP = 21;
		public const int AFFECT_HOSIN = 22;
		public const int AFFECT_BOHO = 23;
		public const int AFFECT_KWAESOK = 24;
		public const int AFFECT_HEUKSIN = 25;
		public const int AFFECT_MUYEONG = 26;
		public const int AFFECT_REVIVE_INVISIBILITY = 27;
		public const int AFFECT_FIRE = 28;
		public const int AFFECT_GICHEON = 29;
		public const int AFFECT_JEUNGRYEOK = 30;
		public const int AFFECT_DASH = 31;
		public const int AFFECT_PABEOP = 32;
		public const int AFFECT_FALLEN_CHEONGEUN = 33;
		public const int AFFECT_POLYMORPH = 34;
		public const int AFFECT_WAR_FLAG1 = 35;
		public const int AFFECT_WAR_FLAG2 = 36;
		public const int AFFECT_WAR_FLAG3 = 37;
		public const int AFFECT_CHINA_FIREWORK = 38;
		public const int #if ENABLE_WOLFMAN = 39;
		public const int AFFECT_BLEEDING = 40;
		public const int AFFECT_RED_POSSESSION = 41;
		public const int AFFECT_BLUE_POSSESSION = 42;
		public const int #endif = 43;
		public const int AFFECT_NUM = 64;

		public const int NEW_AFFECT_MOV_SPEED = 200;
		public const int NEW_AFFECT_ATT_SPEED = 201;
		public const int NEW_AFFECT_ATT_GRADE = 202;
		public const int NEW_AFFECT_INVISIBILITY = 203;
		public const int NEW_AFFECT_STR = 204;
		public const int NEW_AFFECT_DEX = 205;
		public const int NEW_AFFECT_CON = 206;
		public const int NEW_AFFECT_INT = 207;
		public const int NEW_AFFECT_FISH_MIND_PILL = 208;
		public const int NEW_AFFECT_POISON = 209;
		public const int NEW_AFFECT_STUN = 210;
		public const int NEW_AFFECT_SLOW = 211;
		public const int NEW_AFFECT_DUNGEON_READY = 212;
		public const int NEW_AFFECT_DUNGEON_UNIQUE = 213;
		public const int NEW_AFFECT_BUILDING = 214;
		public const int NEW_AFFECT_REVIVE_INVISIBLE = 215;
		public const int NEW_AFFECT_FIRE = 216;
		public const int NEW_AFFECT_CAST_SPEED = 217;
		public const int NEW_AFFECT_HP_RECOVER_CONTINUE = 218;
		public const int NEW_AFFECT_SP_RECOVER_CONTINUE = 219;
		public const int NEW_AFFECT_POLYMORPH = 220;
		public const int NEW_AFFECT_MOUNT = 221;
		public const int NEW_AFFECT_WAR_FLAG = 222;
		public const int NEW_AFFECT_BLOCK_CHAT = 223;
		public const int NEW_AFFECT_CHINA_FIREWORK = 224;
		public const int NEW_AFFECT_BOW_DISTANCE = 225;
		public const int NEW_AFFECT_EXP_BONUS = 500;
		public const int NEW_AFFECT_ITEM_BONUS = 501;
		public const int NEW_AFFECT_SAFEBOX = 502;
		public const int NEW_AFFECT_AUTOLOOT = 503;
		public const int NEW_AFFECT_FISH_MIND = 504;
		public const int NEW_AFFECT_MARRIAGE_FAST = 505;
		public const int NEW_AFFECT_GOLD_BONUS = 506;
		public const int NEW_AFFECT_MALL = 510;
		public const int NEW_AFFECT_NO_DEATH_PENALTY = 511;
		public const int NEW_AFFECT_SKILL_BOOK_BONUS = 512;
		public const int NEW_AFFECT_SKILL_BOOK_NO_DELAY = 513;
		public const int NEW_AFFECT_EXP_BONUS_EURO_FREE = 516;
		public const int NEW_AFFECT_EXP_BONUS_EURO_FREE_UNDER_15 = 517;
		public const int NEW_AFFECT_AUTO_HP_RECOVERY = 534;
		public const int NEW_AFFECT_AUTO_SP_RECOVERY = 535;
		public const int NEW_AFFECT_DRAGON_SOUL_QUALIFIED = 540;
		public const int NEW_AFFECT_DRAGON_SOUL_DECK1 = 541;
		public const int NEW_AFFECT_DRAGON_SOUL_DECK2 = 542;
		public const int NEW_AFFECT_RAMADAN_ABILITY = 300;
		public const int NEW_AFFECT_RAMADAN_RING = 301;
		public const int NEW_AFFECT_NOG_POCKET_ABILITY = 302;
		public const int NEW_AFFECT_QUEST_START_IDX = 1000;

		public const int STONE_SMOKE1 = 0;
		public const int STONE_SMOKE2 = 1;
		public const int STONE_SMOKE3 = 2;
		public const int STONE_SMOKE4 = 3;
		public const int STONE_SMOKE5 = 4;
		public const int STONE_SMOKE6 = 5;
		public const int STONE_SMOKE7 = 6;
		public const int STONE_SMOKE8 = 7;
		public const int STONE_SMOKE_NUM = 4;

		public enum EBuildingAffect
		{
		...
		public const int WEAPON_DUALHAND = 0;
		public const int WEAPON_ONEHAND = 1;
		public const int WEAPON_TWOHAND = 2;
		public const int WEAPON_NUM = 3;

		public const int EMPIRE_NONE = 0;
		public const int EMPIRE_A = 1;
		public const int EMPIRE_B = 2;
		public const int EMPIRE_C = 3;
		public const int EMPIRE_NUM = 4;

		public const int NAMECOLOR_MOB = 0;
		public const int NAMECOLOR_NPC = 1;
		public const int NAMECOLOR_PC = 2;
		public const int NAMECOLOR_PC_END = NAMECOLOR_PC + EMPIRE_NUM;
		public const int NAMECOLOR_NORMAL_MOB = (NAMECOLOR_PC + EMPIRE_NUM) + 1;
		public const int NAMECOLOR_NORMAL_NPC = (NAMECOLOR_PC + EMPIRE_NUM) + 2;
		public const int NAMECOLOR_NORMAL_PC = (NAMECOLOR_PC + EMPIRE_NUM) + 3;
		public const int NAMECOLOR_NORMAL_PC_END = NAMECOLOR_NORMAL_PC + EMPIRE_NUM;
		public const int NAMECOLOR_EMPIRE_MOB = (NAMECOLOR_NORMAL_PC + EMPIRE_NUM) + 1;
		public const int NAMECOLOR_EMPIRE_NPC = (NAMECOLOR_NORMAL_PC + EMPIRE_NUM) + 2;
		public const int NAMECOLOR_EMPIRE_PC = (NAMECOLOR_NORMAL_PC + EMPIRE_NUM) + 3;
		public const int NAMECOLOR_EMPIRE_PC_END = NAMECOLOR_EMPIRE_PC + EMPIRE_NUM;
		public const int NAMECOLOR_FUNC = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 1;
		public const int NAMECOLOR_PK = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 2;
		public const int NAMECOLOR_PVP = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 3;
		public const int NAMECOLOR_PARTY = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 4;
		public const int NAMECOLOR_WARP = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 5;
		public const int NAMECOLOR_WAYPOINT = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 6;
		public const int NAMECOLOR_METIN = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 7;
		public const int NAMECOLOR_MOUNT = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 8;
		public const int NAMECOLOR_PET = (NAMECOLOR_EMPIRE_PC + EMPIRE_NUM) + 9;
		public const int NAMECOLOR_EXTRA = NAMECOLOR_FUNC + 10;
		public const int NAMECOLOR_NUM = NAMECOLOR_EXTRA + 10;

		public const int ALIGNMENT_TYPE_WHITE = 0;
		public const int ALIGNMENT_TYPE_NORMAL = 1;
		public const int ALIGNMENT_TYPE_DARK = 2;

		public const int EMOTICON_EXCLAMATION = 1;
		public const int EMOTICON_FISH = 11;
		public const int EMOTICON_NUM = 128;
		public const int TITLE_NUM = 9;
		public const int TITLE_NONE = 4;
		...
		public const int EFFECT_REFINED_NONE = 0;
		public const int EFFECT_SWORD_REFINED7 = 1;
		public const int EFFECT_SWORD_REFINED8 = 2;
		public const int EFFECT_SWORD_REFINED9 = 3;
		public const int EFFECT_BOW_REFINED7 = 4;
		public const int EFFECT_BOW_REFINED8 = 5;
		public const int EFFECT_BOW_REFINED9 = 6;
		public const int EFFECT_FANBELL_REFINED7 = 7;
		public const int EFFECT_FANBELL_REFINED8 = 8;
		public const int EFFECT_FANBELL_REFINED9 = 9;
		public const int EFFECT_SMALLSWORD_REFINED7 = 10;
		public const int EFFECT_SMALLSWORD_REFINED8 = 11;
		public const int EFFECT_SMALLSWORD_REFINED9 = 12;
		public const int EFFECT_SMALLSWORD_REFINED7_LEFT = 13;
		public const int EFFECT_SMALLSWORD_REFINED8_LEFT = 14;
		public const int EFFECT_SMALLSWORD_REFINED9_LEFT = 15;
		public const int EFFECT_BODYARMOR_REFINED7 = 16;
		public const int EFFECT_BODYARMOR_REFINED8 = 17;
		public const int EFFECT_BODYARMOR_REFINED9 = 18;
		public const int EFFECT_BODYARMOR_SPECIAL = 19;
		public const int EFFECT_BODYARMOR_SPECIAL2 = 20;
		public const int EFFECT_BODYARMOR_SPECIAL3 = 21;
		public const int #if ENABLE_WOLFMAN = 22;
		public const int EFFECT_CLAW_REFINED7 = 23;
		public const int EFFECT_CLAW_REFINED8 = 24;
		public const int EFFECT_CLAW_REFINED9 = 25;
		public const int EFFECT_CLAW_REFINED7_LEFT = 26;
		public const int EFFECT_CLAW_REFINED8_LEFT = 27;
		public const int EFFECT_CLAW_REFINED9_LEFT = 28;
		public const int #endif = 29;
		public const int EFFECT_BODYARMOR_SPECIAL4 = 28;
		public const int EFFECT_SWORD_REFINED7TH_SWORD = 29;
		public const int EFFECT_SWORD_REFINED7TH_SMALL = 30;
		public const int EFFECT_SWORD_REFINED7TH_SMALL_LEFT = 31;
		public const int EFFECT_SWORD_REFINED7TH_FAN = 32;
		public const int EFFECT_SWORD_REFINED7TH_SMALLSWORD = 33;
		public const int EFFECT_SWORD_REFINED7TH_BOW = 34;
		public const int EFFECT_SWORD_REFINED7TH_CLAW = 35;
		public const int EFFECT_SWORD_REFINED7TH_CLAW_LEFT = 36;
		public const int EFFECT_REFINED_NUM = 37;
		...
		public const int EFFECT_DUST = 0;
		public const int EFFECT_STUN = 1;
		public const int EFFECT_HIT = 2;
		public const int EFFECT_FLAME_ATTACK = 3;
		public const int EFFECT_FLAME_HIT = 4;
		public const int EFFECT_FLAME_ATTACH = 5;
		public const int EFFECT_ELECTRIC_ATTACK = 6;
		public const int EFFECT_ELECTRIC_HIT = 7;
		public const int EFFECT_ELECTRIC_ATTACH = 8;
		public const int EFFECT_SPAWN_APPEAR = 9;
		public const int EFFECT_SPAWN_DISAPPEAR = 10;
		public const int EFFECT_LEVELUP = 11;
		public const int EFFECT_SKILLUP = 12;
		public const int EFFECT_HPUP_RED = 13;
		public const int EFFECT_SPUP_BLUE = 14;
		public const int EFFECT_SPEEDUP_GREEN = 15;
		public const int EFFECT_DXUP_PURPLE = 16;
		public const int EFFECT_CRITICAL = 17;
		public const int EFFECT_PENETRATE = 18;
		public const int EFFECT_BLOCK = 19;
		public const int EFFECT_DODGE = 20;
		public const int EFFECT_FIRECRACKER = 21;
		public const int EFFECT_SPIN_TOP = 22;
		public const int EFFECT_WEAPON = 23;
		public const int EFFECT_WEAPON_END = EFFECT_WEAPON + WEAPON_NUM;
		public const int EFFECT_AFFECT = (EFFECT_WEAPON + WEAPON_NUM) + 1;
		public const int EFFECT_AFFECT_GYEONGGONG = EFFECT_AFFECT + AFFECT_GYEONGGONG;
		public const int EFFECT_AFFECT_KWAESOK = EFFECT_AFFECT + AFFECT_KWAESOK;
		public const int EFFECT_AFFECT_END = EFFECT_AFFECT + AFFECT_NUM;
		public const int EFFECT_EMOTICON = (EFFECT_AFFECT + AFFECT_NUM) + 1;
		public const int EFFECT_EMOTICON_END = EFFECT_EMOTICON + EMOTICON_NUM;
		public const int EFFECT_SELECT = (EFFECT_EMOTICON + EMOTICON_NUM) + 1;
		public const int EFFECT_TARGET = (EFFECT_EMOTICON + EMOTICON_NUM) + 2;
		public const int EFFECT_EMPIRE = (EFFECT_EMOTICON + EMOTICON_NUM) + 3;
		public const int EFFECT_EMPIRE_END = EFFECT_EMPIRE + EMPIRE_NUM;
		public const int EFFECT_HORSE_DUST = (EFFECT_EMPIRE + EMPIRE_NUM) + 1;
		public const int EFFECT_REFINED = (EFFECT_EMPIRE + EMPIRE_NUM) + 2;
		public const int EFFECT_REFINED_END = EFFECT_REFINED + EFFECT_REFINED_NUM;
		public const int EFFECT_DAMAGE_TARGET = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 1;
		public const int EFFECT_DAMAGE_NOT_TARGET = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 2;
		public const int EFFECT_DAMAGE_SELFDAMAGE = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 3;
		public const int EFFECT_DAMAGE_SELFDAMAGE2 = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 4;
		public const int EFFECT_DAMAGE_POISON = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 5;
		public const int EFFECT_DAMAGE_MISS = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 6;
		public const int EFFECT_DAMAGE_TARGETMISS = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 7;
		public const int EFFECT_DAMAGE_CRITICAL = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 8;
		public const int EFFECT_DAMAGE_PENETRATE = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 9;
		public const int EFFECT_SUCCESS = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 10;
		public const int EFFECT_FAIL = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 11;
		public const int EFFECT_FR_SUCCESS = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 12;
		public const int EFFECT_LEVELUP_ON_14_FOR_GERMANY = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 13;
		public const int EFFECT_LEVELUP_UNDER_15_FOR_GERMANY = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 14;
		public const int EFFECT_PERCENT_DAMAGE1 = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 15;
		public const int EFFECT_PERCENT_DAMAGE2 = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 16;
		public const int EFFECT_PERCENT_DAMAGE3 = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 17;
		public const int EFFECT_AUTO_HPUP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 18;
		public const int EFFECT_AUTO_SPUP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 19;
		public const int EFFECT_RAMADAN_RING_EQUIP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 20;
		public const int EFFECT_HALLOWEEN_CANDY_EQUIP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 21;
		public const int EFFECT_HAPPINESS_RING_EQUIP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 22;
		public const int EFFECT_LOVE_PENDANT_EQUIP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 23;
		public const int EFFECT_ACCE_SUCESS_ABSORB = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 24;
		public const int EFFECT_ACCE_EQUIP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 25;
		public const int EFFECT_ACCE_BACK = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 26;
		public const int EFFECT_TEMP = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 27;
		public const int EFFECT_NUM = (EFFECT_REFINED + EFFECT_REFINED_NUM) + 28;
...
//		static bool RegisterEffect(uint eEftType, string c_szEftAttachBone, string c_szEftName, bool isCache);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static void RegisterTitleName(int iIndex, string c_szTitleName);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static bool ChangeEffectTexture(uint eEftType, string c_szSrcFileName, string c_szDstFileName);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static D3DXCOLOR GetIndexedNameColor(uint eNameColor);
		...
		protected bool __IsExistMainInstance()
		{
		...
		protected bool __IsMainInstance()
		{
		...
		protected bool __MainCanSeeHiddenThing()
		{
			return false;
		}

		protected float __GetBowRange()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint __AttachEffect(uint eEftType);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint __AttachEffect(string filename);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __DetachEffect(uint dwEID);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void CreateSpecialEffect(uint iEffectIndex);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AttachSpecialEffect(uint effect);

		protected static string[] ms_astAffectEffectAttachBone = Arrays.InitializeStringArrayWithDefaultInstances(EFFECT_NUM);
		protected static uint[] ms_adwCRCAffectEffect = new uint[EFFECT_NUM];
		protected static float ms_fDustGap;
		protected static float ms_fHorseDustGap;
		...
		public bool LessRenderOrder(CInstanceBase pkInst)
		{
		...
		public void MountHorse(uint eRace)
		{
			m_kHorse.Destroy();
...
//		void SCRIPT_SetAffect(uint eAffect, bool isVisible);
		...
		public float CalculateDistanceSq3d(in TPixelPosition c_rkPPosDst)
		{
			TPixelPosition c_rkPPosSrc = m_GraphicThingInstance.NEW_GetCurPixelPositionRef();
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AddFlyTargetPosition(in TPixelPosition c_rkPPosDst);
...
//		void DetachTextTail();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void UpdateTextTailLevel(uint level);
...
//		void RefreshTextTailTitle();
		...
		public bool Create(in SCreateData c_rkCreateData)
		{
			...
			if (IsPC())
			{
				...
				SetAcceRefineEffect(c_rkCreateData.m_byAcceDrainRate);
			}
			...
			if ((c_rkCreateData.m_dwStateFlags & ADD_CHARACTER_STATE_SPAWN) != 0)
			{
			...
			if ((c_rkCreateData.m_dwStateFlags & ADD_CHARACTER_STATE_DEAD) != 0)
			{
			...
			if (!IsPC())
			{
				m_GraphicThingInstance.SetShowMonsterEffects(CPythonSystem.instance().IsShowMonsterEffects());
				uint dwBodyColor = CPythonNonPlayer.Instance().GetMonsterColor(c_rkCreateData.m_dwRace);
				if (0 != dwBodyColor)
				{
			...
			{
				string strFileName = GetGuildSymbolFileName(m_dwGuildID);
				if (IsFile(strFileName))
				{
					m_GraphicThingInstance.ChangeMaterial(strFileName);
				}
			}
		...
		public void Update()
		{
			...
			if (m_GraphicThingInstance.IsMovement())
			{
				...
				uint dwCurTime = ELTimer_GetFrameMSec();
				{
				...
				{
					uint dwMtrlColor = __GetShadowMapColor(kPPosCur.x, kPPosCur.y);
...
//		bool UpdateDeleting();
		...
		public void Transform()
		{
			...
			else
			{
				...
				{
					_D3DVECTOR c_rv3Movment = m_GraphicThingInstance.GetMovementVectorRef();
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private CScreen Render_s_kScreen = new CScreen();
		...
		public void Render()
		{
			...
			for (var ptr = rkChrMgr.CharacterInstanceBegin(); ptr != rkChrMgr.CharacterInstanceEnd(); ++ptr)
			{
...
//					static CScreen s_kScreen;
					...
					(CStateManager.Instance()).SetTextureStageState(0, D3DTSS_COLORARG1, DefineConstants.D3DTA_DIFFUSE);
					...
					TPixelPosition px = new TPixelPosition();
					m_GraphicThingInstance.GetPixelPosition(px);
					_D3DVECTOR kD3DVt3Cur = new _D3DVECTOR(px.x, px.y, px.z);
					_D3DVECTOR kD3DVt3Dest = new _D3DVECTOR(NEW_GetDstPixelPositionRef().x, -NEW_GetDstPixelPositionRef().y, NEW_GetDstPixelPositionRef().z);

					Render_s_kScreen.SetDiffuseColor(0.0f, 0.0f, 1.0f);
					Render_s_kScreen.RenderLine3d(kD3DVt3Cur.x, kD3DVt3Cur.y, px.z, kD3DVt3Dest.x, kD3DVt3Dest.y, px.z);
		...
		public void GetBoundBox(_D3DVECTOR vtMin, _D3DVECTOR vtMax)
		{
			m_GraphicThingInstance.GetBoundBox(vtMin, vtMax);
		}

		public void SetNameString(string c_szName, int len)
		{
			m_stName.assign(c_szName, len);

			if (GetInstanceType() == CActorInstance.TYPE_ENEMY && IS_SET(CPythonNonPlayer.Instance().GetMobAIFlag(GetRace()), CPythonNonPlayer.AIFLAG_AGGRESSIVE))
			{
				m_stName.append("*");
			}
		}
		...
		public void SetVirtualID(uint dwVirtualID)
		{
			m_GraphicThingInstance.SetVirtualID(dwVirtualID);
		}

		public void SetVirtualNumber(uint dwVirtualNumber)
		{
		...
		public void SetAlignment(short sAlignment)
		{
			m_sAlignment = sAlignment;
			RefreshTextTailTitle();
		}

		public void SetPKMode(byte byPKMode)
		{
		...
		public void SetKiller(bool bFlag)
		{
			if (m_isKiller == bFlag)
			{
				return;
		...
		public void SetPartyMemberFlag(bool bFlag)
		{
			m_isPartyMember = bFlag;
		}

		public void SetStateFlags(uint dwStateFlags)
		{
			if ((dwStateFlags & ADD_CHARACTER_STATE_KILLER) != 0)
			{
				SetKiller(true);
			}
			else
			...
			if ((dwStateFlags & ADD_CHARACTER_STATE_PARTY) != 0)
			{
...
#if ENABLE_MULTI_LANGUAGE_SYSTEM
		public void SetLanguage(byte bLang)
		{
			m_bLanguage = bLang;
		}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: byte GetLanguage() const
		public byte GetLanguage()
		{
			return m_bLanguage;
		}
#endif
		public void SetArmor(uint dwArmor)
		{
			uint dwShape;
		...
		public void SetShape(uint eShape, float fSpecular = 0.0f)
		{
			if (IsPoly())
			{
		...
		public bool SetWeapon(uint eWeapon)
		{
			if (IsPoly())
			{
				return false;
		...
		public bool SetAcce(uint eAcce)
		{
		...
		public void SetAcceRefineEffect(byte acceDrainRate)
		{
			m_byAcceDrainRate = acceDrainRate;
			RefreshAcceRefineEffect();
		}

		public void RefreshAcceRefineEffect()
		{
			if (m_acceRefineEffect)
			{
				__ClearAcceRefineEffect();
			...
			if (m_awPart[CRaceData.PART_ACCE] != 0 && m_byAcceDrainRate >= 19)
			{
				m_acceRefineEffect = __AttachEffect(EFFECT_ACCE_BACK);
			}
		}

		public bool ChangeArmor(uint dwArmor)
		{
			uint eShape;
			...
			CAffectFlagContainer kAffectFlagContainer = new CAffectFlagContainer();
			kAffectFlagContainer.CopyInstance(m_kAffectFlagContainer);

			uint dwVID = GetVirtualID();
			uint dwRace = GetRace();
			uint eHair = GetPart(CRaceData.PART_HAIR);
			uint eWeapon = GetPart(CRaceData.PART_WEAPON);
			uint eAcce = GetPart(CRaceData.PART_ACCE);
		...
		public bool SetArrow(uint eArrow)
		{
			if (IsPoly())
			{
				return false;
		...
		public void ChangeWeapon(uint eWeapon)
		{
		...
		public void ChangeHair(uint eHair)
		{
			if (!HAIR_COLOR_ENABLE)
			{
				return;
		...
		public void ChangeAcce(uint eAcce)
		{
		...
		public void ChangeGuild(uint dwGuildID)
		{
		...
		{
			uint dwWeapon = GetPart(CRaceData.PART_WEAPON);
			CItemData pItemData;
		...
		public void SetComboType(uint uComboType)
		{
...
//		void SetRotationSpeed(float fRotSpd);
		...
		public uint GetPart(CRaceData.EParts part)
		{
			Debug.Assert(part >= 0 && part < CRaceData.PART_MAX_NUM);
		...
		public uint GetVirtualNumber()
		{
			return m_dwVirtualNumber;
		}

		public uint GetEmpireID()
		{
			return m_dwEmpireID;
		}
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ActDualEmotion(CInstanceBase rkDstInst, ushort dwMotionNumber1, ushort dwMotionNumber2);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ActEmotion(uint dwMotionNumber);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void LevelUp();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SkillUp();
...
//		void Show();
		...
		public bool IsConflictAlignmentInstance(CInstanceBase rkInstVictim)
		{
		...
		public bool IsAttackableInstance(CInstanceBase rkInstVictim)
		{
			if (__IsMainInstance())
			{
		...
		public bool IsTargetableInstance(CInstanceBase rkInstVictim)
		{
...
//		bool IsPVPInstance(CInstanceBase rkInstVictim);
		...
		public bool CanViewTargetHP(CInstanceBase rkInstVictim)
		{
			if (rkInstVictim.IsStone())
			{
				return true;
...
//		bool IsGoing();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NEW_Goto(in TPixelPosition c_rkPPosDst, float fDstRot);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void EndGoing();
...
//		bool IsAffect(uint uAffect);
		...
		public bool IsSameEmpire(CInstanceBase rkInstDst)
		{
		...
		public bool isHoldingBouquet()
		{
			const int c_iPickAxeStart = 50201;
			const int c_iPickAxeEnd = 50202;
			return m_awPart[CRaceData.PART_WEAPON] >= c_iPickAxeStart && m_awPart[CRaceData.PART_WEAPON] <= c_iPickAxeEnd;
		}

		public bool IsMountingHorse()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NEW_CanMoveToDestPixelPosition(in TPixelPosition c_rkPPosDst);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetAdvancingRotationFromPixelPosition(in TPixelPosition c_rkPPosSrc, in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetAdvancingRotationFromDirPixelPosition(in TPixelPosition c_rkPPosDir);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NEW_SetAdvancingRotationFromDestPixelPosition(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//		void SetEventHandler(CActorInstance::IEventHandler pkEventHandler);
		...
		public void PushUDPState(uint dwCmdTime, in TPixelPosition c_rkPPosDst, float fDstRot, uint eFunc, uint uArg)
		{
		}

		public void PushTCPState(uint dwCmdTime, in TPixelPosition c_rkPPosDst, float fDstRot, uint eFunc, uint uArg)
		{
			if (__IsMainInstance())
			{
		...
		public void PushTCPStateExpanded(uint dwCmdTime, in TPixelPosition c_rkPPosDst, float fDstRot, uint eFunc, uint uArg, uint uTargetVID)
		{
			SCommand kCmdNew = new SCommand();
			kCmdNew.m_kPPosDst = c_rkPPosDst;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_AttackToDestPixelPositionDirection(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetDistanceFromDirPixelPosition(in TPixelPosition c_rkPPosDir);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetDistanceFromDestPixelPosition(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetRotationFromDestPixelPosition(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetRotationFromDirPixelPosition(in TPixelPosition c_rkPPosDir);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetRotationFromDestInstance(CInstanceBase rkInstDst);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetAdvancingRotationFromDirPixelPosition(in TPixelPosition c_rkPPosDir);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetAdvancingRotationFromDestPixelPosition(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		float NEW_GetAdvancingRotationFromPixelPosition(in TPixelPosition c_rkPPosSrc, in TPixelPosition c_rkPPosDst);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NEW_IsClickableDistanceDestPixelPosition(in TPixelPosition c_rkPPosDst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NEW_GetInstanceVectorInFanRange(float fSkillDistance, CInstanceBase rkInstTarget, System.Collections.Generic.List<CInstanceBase> pkVct_pkInst);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool NEW_GetInstanceVectorInCircleRange(float fSkillDistance, System.Collections.Generic.List<CInstanceBase> pkVct_pkInst);

		public void NEW_SetOwner(uint dwVIDOwner)
		{
			m_GraphicThingInstance.SetOwner(dwVIDOwner);
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SyncPixelPosition(ref int nPPosX, ref int nPPosY);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SyncCurrentPixelPosition();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetPixelPosition(in TPixelPosition c_rkPPosDst);

		public bool NEW_IsLastPixelPosition()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void RunComboAttack(float fAtkDirRot, uint wMotionIndex);
...
//		bool CheckAdvancing();
		...
		public bool AvoidObject(in CGraphicObjectInstance c_rkBGObj)
		{
			return m_GraphicThingInstance.AvoidObject(c_rkBGObj);
		}

		public bool IsBlockObject(in CGraphicObjectInstance c_rkBGObj)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessHitting(uint dwMotionKey, CInstanceBase pVictimInstance);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessHitting(uint dwMotionKey, byte byEventIndex, CInstanceBase pVictimInstance);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void GetBlendingPosition(TPixelPosition pPixelPosition);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetBlendingPosition(in TPixelPosition c_rPixelPosition);
...
//		void CatchFail();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetFishingRot(ref int pirot);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_LookAtDestPixelPosition(in TPixelPosition c_rkPPosDst);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		int GetMotionMode(uint dwMotionIndex);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ResetLocalTime();
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetLoopMotion(ushort wMotion, float fBlendTime = 0.1f, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void PushOnceMotion(ushort wMotion, float fBlendTime = 0.1f, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void PushLoopMotion(ushort wMotion, float fBlendTime = 0.1f, float fSpeedRatio = 1.0f);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetEndStopMotion();

		public bool IntersectDefendingSphere()
		{
			return m_GraphicThingInstance.IntersectDefendingSphere();
		}

		public bool IntersectBoundingBox()
		{
			float u;
			float v;
			float t;
		...
		public void Refresh(uint dwMotIndex, bool isLoop)
		{
			RefreshState(dwMotIndex, isLoop);
		}

		public float GetDistance(CInstanceBase pkTargetInst)
		{
			TPixelPosition TargetPixelPosition = new TPixelPosition();
			pkTargetInst.m_GraphicThingInstance.GetPixelPosition(TargetPixelPosition);
			return GetDistance(TargetPixelPosition);
		}

		public float GetDistance(in TPixelPosition c_rPixelPosition)
		{
		...
		public CActorInstance GetGraphicThingInstanceRef()
		{
			return m_GraphicThingInstance;
		}

		public CActorInstance GetGraphicThingInstancePtr()
		{
			return m_GraphicThingInstance;
		}

		public bool __Background_IsWaterPixelPosition(in TPixelPosition c_rkPPos)
		{
			return CPythonBackground.Instance().isAttrOn(c_rkPPos.x, c_rkPPos.y, CTerrainImpl.ATTRIBUTE_WATER);
		}

		public bool __Background_GetWaterHeight(in TPixelPosition c_rkPPos, ref float pfHeight)
		{
			int lHeight;
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetAffectFlagContainer(in CAffectFlagContainer c_rkAffectFlagContainer);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __SetNormalAffectFlagContainer(in CAffectFlagContainer c_rkAffectFlagContainer);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __SetStoneSmokeFlagContainer(in CAffectFlagContainer c_rkAffectFlagContainer);
...
//		bool IsPossibleEmoticon();
		...
		protected uint __LessRenderOrder_GetLODLevel()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		protected void __InitializeRotationSpeed()
		{
			SetRotationSpeed(c_fDefaultRotationSpeed);
		}

		protected void __Create_SetName(in SCreateData c_rkCreateData)
		{
			if (IsGoto())
			{
				SetNameString("", 0);
		...
		protected void __Create_SetWarpName(in SCreateData c_rkCreateData)
		{
			string c_szName;
			if (CPythonNonPlayer.Instance().GetName(c_rkCreateData.m_dwRace, c_szName))
			{
				string strName = c_szName;
				int iFindingPos = strName.IndexOfAny((Convert.ToString(" ")).ToCharArray(), 0);
				if (iFindingPos > 0)
				{
					strName.resize(iFindingPos);
				}
				SetNameString(strName, strName.Length);
			}
			else
			{
				SetNameString(c_rkCreateData.m_stName.c_str(), c_rkCreateData.m_stName.length());
		...
		protected CInstanceBase __GetMainInstancePtr()
		{
			CPythonCharacterManager rkChrMgr = CPythonCharacterManager.Instance();
			return rkChrMgr.GetMainInstancePtr();
		}

		protected CInstanceBase __FindInstancePtr(uint dwVID)
		{
			CPythonCharacterManager rkChrMgr = CPythonCharacterManager.Instance();
			return rkChrMgr.GetInstancePtr(dwVID);
		}

		protected bool __FindRaceType(uint dwRace, ref byte pbType)
		{
			CPythonNonPlayer rkNonPlayer = CPythonNonPlayer.Instance();
			return rkNonPlayer.GetInstanceType(dwRace, pbType);
		}

		protected uint __GetRaceType()
		{
			return m_eRaceType;
		}

		protected bool __IsShapeAnimalWear()
		{
		...
		protected bool __IsChangableWeapon(int iWeaponID)
		{
			if (IsWearingDress())
			{
		...
		protected void __EnableSkipCollision()
		{
			if (__IsMainInstance())
			{
		...
		protected void __DisableSkipCollision()
		{
			m_GraphicThingInstance.DisableSkipCollision();
		}

		protected void __ClearMainInstance()
		{
			CPythonCharacterManager rkChrMgr = CPythonCharacterManager.Instance();
...
//		void __SetReviveInvisibilityAffect(bool isVisible);
		...
		protected bool __CanProcessNetworkStatePacket()
		{
		...
		protected bool __IsInDustRange()
		{
			if (!__IsExistMainInstance())
			{
				return false;
		...
		protected void __ProcessFunctionEmotion(uint dwMotionNumber, uint dwTargetVID, in TPixelPosition c_rkPosDst)
		{
			if (IsAttacking())
			{
				return;
			...
			if (pTargetInstance != null)
			{
				...
				ushort wMotionNumber1 = (ushort)(((U32)dwMotionNumber) >> 16);
				ushort wMotionNumber2 = ((U16)((U32)dwMotionNumber));
...
//		void __DisableChangingTCPState();
		protected bool __IsEnableTCPProcess(uint eCurFunc)
		{
		...
		protected bool __IsInViewFrustum()
		{
			return m_GraphicThingInstance.isShow();
		}

		protected void __AttachHorseSaddle()
		{
			if (!IsMountingHorse())
			{
				return;
		...
		protected void __DetachHorseSaddle()
		{
			if (!IsMountingHorse())
			{
				return;
		...
		protected class SHORSE
		{
			public bool m_isMounting;
			public CActorInstance m_pkActor;
			...
			public void Create(in TPixelPosition c_rkPPos, uint eRace, uint eHitEffect)
			{
				Debug.Assert(null == m_pkActor && "CInstanceBase::SHORSE::Create - ALREADY MOUNT");
			...
			public CActorInstance GetActorRef()
			{
				Debug.Assert(null != m_pkActor && "CInstanceBase::SHORSE::GetActorRef");
				return m_pkActor;
			}

			public CActorInstance GetActorPtr()
			{
				return m_pkActor;
			}
			...
			public uint GetLevel()
			{
				if (m_pkActor)
				{
...

					{
						...
						if ((20209 <= mount && 20212 >= mount) || (20215 == mount) || (20218 == mount) || (20220 == mount) || (20221 <= mount && 20299 >= mount))
						{
							return 3;
						}
					}
		...
		protected SHORSE m_kHorse = new SHORSE();


		protected void __SetBlendRenderingMode()
		{
			m_GraphicThingInstance.SetBlendRenderMode();
		}

		protected void __SetAlphaValue(float fAlpha)
		{
			m_GraphicThingInstance.SetAlphaValue(fAlpha);
		}

		protected float __GetAlphaValue()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __ComboProcess();
		protected void MovementProcess()
		{
			TPixelPosition kPPosCur = new TPixelPosition();
			NEW_GetPixelPosition(kPPosCur);

			TPixelPosition kPPosNext = new TPixelPosition();
			{
				_D3DVECTOR c_rkV3Mov = m_GraphicThingInstance.GetMovementVectorRef();
			...
			if (__IsMainInstance())
			{
				if (m_isGoing && IsWalking())
				{
					...
					if (fRestLen <= 0.0F)
					{
						...
						{
							uint dwMotionNumber = m_kMovAfterFunc.uArg;
							uint dwTargetVID = m_kMovAfterFunc.uArgExpanded;
					...
					else if (fCurLen <= fTotalLen && fTotalLen <= fNextLen)
					{
						...
						else
						{
							switch (m_kMovAfterFunc.eFunc)
							{
								...
								default:
								{
									if ((m_kMovAfterFunc.eFunc & FUNC_SKILL) != 0)
									{
										SetAdvancingRotation(m_fDstRot);
										BlendRotation(m_fDstRot);
										NEW_UseSkill(0, m_kMovAfterFunc.eFunc & 0x7f, m_kMovAfterFunc.uArg & 0x0f, (m_kMovAfterFunc.uArg >> 4) != 0 ? true : false);
									}
									else
									{
										__DisableSkipCollision();
...
//		void TodoProcess();
		protected void StateProcess()
		{
			while (true)
			{
				...
				uint dwDstChkTime = m_kQue_kCmdNew.front().m_dwChkTime;
				uint dwCurChkTime = ELTimer_GetServerFrameMSec();
				...
				float fDirLen = (float)Math.Sqrt(kPPosDir.x * kPPosDir.x + kPPosDir.y * kPPosDir.y);
					...
					default:
					{
						if ((eFunc & FUNC_SKILL) != 0)
						{
							...
							else
							{
								...
								NEW_UseSkill(0, eFunc & 0x7f, uArg & 0x0f, (uArg >> 4) != 0 ? true : false);
							}
						}
						break;
					}
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void StartWalking();
		protected float GetLocalTime()
		{
			return m_GraphicThingInstance.GetLocalTime();
		}

		protected void RefreshState(uint dwMotIndex, bool isLoop)
		{
			uint dwPartItemID = m_GraphicThingInstance.GetPartItemID(CRaceData.PART_WEAPON);
...
//# Laniatus Games Studio Inc. | TODO TASK: C# does not allow fall-through from a non-empty 'case':
		...
		protected void RefreshActorInstance()
		{
			m_GraphicThingInstance.RefreshActorInstance();
		}

		protected void OnSyncing()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void NEW_SetCurPixelPosition(in TPixelPosition c_rkPPosDst);
		protected void NEW_SetSrcPixelPosition(in TPixelPosition c_rkPPosSrc)
		{
			m_GraphicThingInstance.NEW_SetSrcPixelPosition(c_rkPPosSrc);
		}

		protected void NEW_SetDstPixelPosition(in TPixelPosition c_rkPPosDst)
		{
			m_GraphicThingInstance.NEW_SetDstPixelPosition(c_rkPPosDst);
		}

		protected void NEW_SetDstPixelPositionZ(float z)
		{
			m_GraphicThingInstance.NEW_SetDstPixelPositionZ(z);
		}

		protected TPixelPosition NEW_GetCurPixelPositionRef()
		{
			return m_GraphicThingInstance.NEW_GetCurPixelPositionRef();
		}

		protected TPixelPosition NEW_GetSrcPixelPositionRef()
		{
		...
		protected bool m_isTextTail;

		protected string m_stName = "";

		protected uint[] m_awPart = new uint[CRaceData.PART_MAX_NUM];

		protected uint m_dwLevel;
		protected uint m_dwEmpireID;
		protected uint m_dwGuildID;
		protected byte m_byAcceDrainRate;

#if ENABLE_MULTI_LANGUAGE_SYSTEM
		protected byte m_bLanguage;
#endif
		protected CAffectFlagContainer m_kAffectFlagContainer = new CAffectFlagContainer();
		protected uint[] m_adwCRCAffectEffect = new uint[AFFECT_NUM];

		protected uint __GetRefinedEffect(CItemData pItem)
		{
			uint refine = Math.Max(pItem.GetRefine() + pItem.GetSocketCount(),CItemData.ITEM_SOCKET_MAX_NUM) - CItemData.ITEM_SOCKET_MAX_NUM;
			uint vnum = pItem.GetIndex();
			...
			case CItemData.ITEM_TYPE_WEAPON:
				...
				if (__IsTHWeapon(vnum))
				{
					switch (pItem.GetSubType())
					{
						case CItemData.WEAPON_DAGGER:
							m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_SMALL;
							m_swordRefineEffectLeft = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_SMALL_LEFT;
							break;
						case CItemData.WEAPON_FAN:
							m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_FAN;
							break;
						case CItemData.WEAPON_ARROW:
						case CItemData.WEAPON_QUIVER:
						case CItemData.WEAPON_BELL:
							m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_SMALLSWORD;
							break;
						case CItemData.WEAPON_BOW:
							m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_BOW;
							break;
#if ENABLE_WOLFMAN
//# Laniatus Games Studio Inc. | TODO TASK: C# does not allow fall-through from a non-empty 'case':
						case CItemData.WEAPON_CLAW:
							m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_CLAW;
							m_swordRefineEffectLeft = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_CLAW_LEFT;
							break;
#endif
//# Laniatus Games Studio Inc. | TODO TASK: C# does not allow fall-through from a non-empty 'case':
						default:
							m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SWORD_REFINED7TH_SWORD;
							break;
					}
...
//# Laniatus Games Studio Inc. | TODO TASK: C# does not allow fall-through from a non-empty 'case':
			...
			case CItemData.ITEM_TYPE_ARMOR:
				...
				if (pItem.GetSubType() == CItemData.ARMOR_BODY)
				{
					...
					if (12050 <= vnum && vnum <= 12099)
					{
						__AttachEffect(EFFECT_REFINED + EFFECT_BODYARMOR_SPECIAL3);
					}

					if (21220 <= vnum && vnum <= 21225 || 21240 <= vnum && vnum <= 21245 || 21260 <= vnum && vnum <= 21265 || 21280 <= vnum && vnum <= 21285 || 21300 <= vnum && vnum <= 21305)
					{
...
#if ENABLE_SHINING_SYSTEM
#if ENABLE_SHINING_SYSTEM
		protected void __GetShiningEffect(CItemData pItem)
		{
		...
		protected void __ClearWeaponShiningEffect(bool detaching = true)
		{
			if (detaching)
			{
				for (int LaniatusDefVariables = 0; LaniatusDefVariables < CItemData.ITEM_SHINING_MAX_COUNT; LaniatusDefVariables++)
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		protected void __ClearArmorShiningEffect(bool detaching = true)
		{
			if (detaching)
			{
				for (int LaniatusDefVariables = 0; LaniatusDefVariables < CItemData.ITEM_SHINING_MAX_COUNT; LaniatusDefVariables++)
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		protected void __AttachWeaponShiningEffect(int effectIndex, string effectFileName, string boneName = "Bip01")
		{
			if (IsAffect(AFFECT_INVISIBILITY))
			{
				return;
		...
		protected void __AttachArmorShiningEffect(int effectIndex, string effectFileName, string boneName = "Bip01")
		{
			if (IsAffect(AFFECT_INVISIBILITY))
			{
				return;
...
#endif
		protected void __ClearWeaponRefineEffect()
		{
			if (m_swordRefineEffectRight)
			{
		...
		protected void __ClearArmorRefineEffect()
		{
		...
		protected void __ClearAcceRefineEffect()
		{
			if (m_acceRefineEffect)
			{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __AttachEmpireEffect(uint eEmpire);

		protected class SEffectContainer
		{
...
//			typedef System.Collections.Generic.SortedDictionary<uint, uint> Dict;
			public SortedDictionary<uint, uint> m_kDct_dwEftID = new SortedDictionary<uint, uint>();
		}
		protected SEffectContainer m_kEffectContainer = new SEffectContainer();
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		uint __EffectContainer_AttachEffect(uint eEffect);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __EffectContainer_DetachEffect(uint eEffect);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		System.Collections.Generic.SortedDictionary<uint, uint> __EffectContainer_GetDict();

		protected class SStoneSmoke
		{
			public uint m_dwEftID;
		}
		protected SStoneSmoke m_kStoneSmoke = new SStoneSmoke();
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void __StoneSmoke_Create(uint eSmoke);


		protected byte m_eType;
		protected byte m_eRaceType;
		protected uint m_eShape;
		protected uint m_dwRace;
		protected uint m_dwVirtualNumber;
		protected short m_sAlignment;
		protected byte m_byPKMode;
		protected bool m_isKiller;
		protected bool m_isPartyMember;

		protected int m_iRotatingDirection;

		protected uint m_dwAdvActorVID;
		protected uint m_dwLastDmgActorVID;

		protected int m_nAverageNetworkGap;
		protected uint m_dwNextUpdateHeightTime;

		protected bool m_isGoing;

		protected TPixelPosition m_kPPosDust = new TPixelPosition();

		protected uint m_dwLastComboIndex;

		protected uint m_swordRefineEffectRight;
		protected uint m_swordRefineEffectLeft;
		protected uint m_armorRefineEffect;
		protected uint m_acceRefineEffect;
#if ENABLE_SHINING_SYSTEM
		protected uint[][] m_weaponShiningEffects =
		{
			new uint[CItemData.ITEM_SHINING_MAX_COUNT],
			new uint[CItemData.ITEM_SHINING_MAX_COUNT]
		};
		protected uint[] m_armorShiningEffects = new uint[CItemData.ITEM_SHINING_MAX_COUNT];
#endif

		protected class SMoveAfterFunc
		{
			public uint eFunc;
			public uint uArg;
			public uint uArgExpanded;
			public TPixelPosition kPosDst = new TPixelPosition();
		}

		protected SMoveAfterFunc m_kMovAfterFunc = new SMoveAfterFunc();

		protected float m_fDstRot;
		protected float m_fAtkPosTime;
		protected float m_fRotSpd;
		protected float m_fMaxRotSpd;

		protected bool m_bEnableTCPState;

		protected CActorInstance m_GraphicThingInstance = new CActorInstance();


		protected class SCommand
		{
			public SCommand()
			{
				this.m_dwChkTime = 0;
			...
			public uint m_dwChkTime;
			public uint m_dwCmdTime;
			public float m_fDstRot;
			public uint m_eFunc;
			public uint m_uArg;
			public uint m_uTargetVID;
			public TPixelPosition m_kPPosDst = new TPixelPosition();
		}

//# Laniatus Games Studio Inc. | TODO TASK: Typedefs defined in multiple preprocessor conditionals can only be replaced within the scope of the preprocessor conditional:
//		typedef System.Collections.Generic.LinkedList<SCommand> CommandQueue;

		protected uint m_dwBaseChkTime;
		protected uint m_dwBaseCmdTime;

		protected uint m_dwSkipTime;

		protected LinkedList<SCommand> m_kQue_kCmdNew = new LinkedList<SCommand>();

		protected bool m_bDamageEffectType;

		protected class SEffectDamage
		{
			public uint damage;
			public byte flag;
			public bool bSelf;
...
//# Laniatus Games Studio Inc. | TODO TASK: Typedefs defined in multiple preprocessor conditionals can only be replaced within the scope of the preprocessor conditional:
//		typedef System.Collections.Generic.LinkedList<SEffectDamage> CommandDamageQueue;
		protected LinkedList<SEffectDamage> m_DamageQueue = new LinkedList<SEffectDamage>();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void ProcessDamage();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void AddDamageEffect(uint damage, byte flag, bool bSelf, bool bTarget);

		protected class SWarrior
		{
			public uint m_dwGeomgyeongEffect;
		}

		protected SWarrior m_kWarrior = new SWarrior();

		protected void __Warrior_Initialize()
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static void InsertPVPKey(uint dwSrcVID, uint dwDstVID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static void InsertPVPReadyKey(uint dwSrcVID, uint dwDstVID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static void RemovePVPKey(uint dwSrcVID, uint dwDstVID);

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static void InsertGVGKey(uint dwSrcGuildVID, uint dwDstGuildVID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static void RemoveGVGKey(uint dwSrcGuildVID, uint dwDstGuildVID);
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		D3DXCOLOR GetTitleColor();

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static uint __GetPVPKey(uint dwSrcVID, uint dwDstVID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static bool __FindPVPKey(uint dwSrcVID, uint dwDstVID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static bool __FindPVPReadyKey(uint dwSrcVID, uint dwDstVID);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		static bool __FindGVGKey(uint dwSrcGuildID, uint dwDstGuildID);
...
//		CActorInstance::IEventHandler GetEventHandlerRef();
		...
		protected static float __GetBackgroundHeight(float x, float y)
		{
			CPythonBackground rkBG = CPythonBackground.Instance();
			return rkBG.GetHeight(x, y);
		}

		protected static uint __GetShadowMapColor(float x, float y)
		{
			CPythonBackground rkBG = CPythonBackground.Instance();
		...
		public static void GetInfo(string pstInfo)
		{
			string szInfo = new string(new char[256]);
			sprintf(szInfo, "Inst - UC %d, RC %d Pool - %d ", ms_dwUpdateCounter, ms_dwRenderCounter, ms_kPool.GetCapacity());

			pstInfo.append(szInfo);
		}

		public static CInstanceBase New()
		{
			return ms_kPool.Alloc();
		}

		public static void Delete(CInstanceBase pkInst)
		{
			pkInst.Destroy();
			ms_kPool.Free(pkInst);
		}

		public static CDynamicPool<CInstanceBase> ms_kPool = new CDynamicPool<CInstanceBase>();

		protected static uint ms_dwUpdateCounter = 0;
		protected static uint ms_dwRenderCounter = 0;
		protected static uint ms_dwDeformCounter = 0;

		protected uint m_dwEmoticonTime;

		public void SetShowMonsterEffects(bool show)
		{
			m_GraphicThingInstance.SetShowMonsterEffects(show);
		}
}

public class CActorInstanceBackground : IBackground
{
		public CActorInstanceBackground()
		{
		}
		public virtual void Dispose()
		{
