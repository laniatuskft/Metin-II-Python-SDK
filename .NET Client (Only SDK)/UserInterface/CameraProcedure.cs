...
public class CameraCollisionChecker
{
	...
	public List<_D3DVECTOR> m_pkVct_v3Position;
	public CDynamicSphereInstance m_pdsi;

	public CameraCollisionChecker(CDynamicSphereInstance pdsi, List<_D3DVECTOR> pkVct_v3Position)
	{
		this.m_pdsi = pdsi;
		this.m_pkVct_v3Position = pkVct_v3Position;
