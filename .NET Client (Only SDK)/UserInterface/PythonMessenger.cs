...
public class CPythonMessenger : CSingleton<CPythonMessenger>
{

		public enum EMessengerGroupIndex
		{
			MESSENGER_GRUOP_INDEX_FRIEND,
			MESSENGER_GRUOP_INDEX_GUILD
		}

		public CPythonMessenger()
		{
			this.m_poMessengerHandler = null;
		}
		...
		public void RemoveFriend(string c_szKey)
		{
		...
		public void OnFriendLogin(string c_szKey)
		{
		...
		public void OnFriendLogout(string c_szKey)
		{
			m_FriendNameMap.insert(c_szKey);
		...
		public bool IsFriendByKey(string c_szKey)
		{
			return m_FriendNameMap.end() != m_FriendNameMap.find(c_szKey);
		}

		public bool IsFriendByName(string c_szName)
		{
			return IsFriendByKey(c_szName);
		}

		public void AppendGuildMember(string c_szName)
		{
		...
		public void RemoveGuildMember(string c_szName)
		{
		...
		public void RemoveAllGuildMember()
		{
			m_GuildMemberStateMap.clear();
		...
		public void LoginGuildMember(string c_szName)
		{
		...
		public void LogoutGuildMember(string c_szName)
		{
		...
		public void RefreshGuildMember()
		{
		...
		public void SetMessengerHandler(PyObject poHandler)
		{
			m_poMessengerHandler = poHandler;
		}

		protected SortedSet<string> m_FriendNameMap = new SortedSet<string>();
		protected SortedDictionary<string, byte> m_GuildMemberStateMap = new SortedDictionary<string, byte>();

		private PyObject m_poMessengerHandler;
}