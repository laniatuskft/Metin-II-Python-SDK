...
#define FILE_MAX_LEN
//# Laniatus Games Studio Inc. | WARN: Statement interrupted by a preprocessor statement:
//The original statement from the file PythonPlayerSettingsModule.h starts with:
//    constexpr std::array<TRaceData, NPlayerData::MAIN_RACE_MAX_NUM> vecRaceData = {{
//Statements interrupted by the preprocessor cannot be processed by this intent.//MyInfo
//The remainder of the header file PythonPlayerSettingsModule.h is ignored.
#endif
