...
public class ClientApp : CefApp, CefRenderProcessHandler
{
	...
	public CefRefPtr<CefRenderProcessHandler> GetRenderProcessHandler() OVERRIDE
	{
		return this;
	}
	...
	{
		string app_code = "var app;" + "if (!app)" + "    app = {};" + "(function() {" + "    app.ChangeTextInJS = function(text) {" + "        native function ChangeTextInJS();" + "        return ChangeTextInJS(text);" + "    };" + "})();";
