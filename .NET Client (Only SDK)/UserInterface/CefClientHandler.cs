...
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define ALLOW_UNUSED_LOCAL(x) false ? (void)x : (void)0
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NO_SANITIZE(what)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NO_SANITIZE(what)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define OVERRIDE override
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define OVERRIDE override
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define OVERRIDE override
...
public class ClientHandler : CefClient, CefLifeSpanHandler
{
	//The original statement from the file cef_logging.h starts with:
	//    DEFINE_CHECK_OP_IMPL(EQ, ==) DEFINE_CHECK_OP_IMPL(NE, !=) DEFINE_CHECK_OP_IMPL(LE, <=) DEFINE_CHECK_OP_IMPL(LT, <) DEFINE_CHECK_OP_IMPL(GE, >=) DEFINE_CHECK_OP_IMPL(GT, >) #undef DEFINE_CHECK_OP_IMPL
	//Statements interrupted by the preprocessor cannot be processed by this intent.//MyInfo
	//The remainder of the header file cef_logging.h is ignored.

	public ClientHandler()
	{
	}

	public CefRefPtr<CefBrowser> GetBrowser()
	{
		return m_Browser;
	}

	public CefWindowHandle GetBrowserHwnd()
	{
		return m_BrowserHwnd;
	}

	public virtual CefRefPtr<CefLifeSpanHandler> GetLifeSpanHandler() OVERRIDE
	{
		return this;
	}
	...
	protected CefRefPtr<CefBrowser> m_Browser = new CefRefPtr<CefBrowser>();
	protected CefWindowHandle m_BrowserHwnd = new CefWindowHandle();
...
//Original Metin2 CPlus Line: #define OVERRIDE override
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define arraysize(array) (sizeof(ArraySizeHelper(array)))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DISALLOW_COPY_AND_ASSIGN(TypeName) TypeName(const TypeName&); void operator=(const TypeName&)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DISALLOW_IMPLICIT_CONSTRUCTORS(TypeName) TypeName(); DISALLOW_COPY_AND_ASSIGN(TypeName)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPILE_ASSERT(expr, msg) static_assert(expr, #msg)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPILE_ASSERT(expr, msg) typedef cef::CompileAssert<(bool(expr))> msg[bool(expr) ? 1 : -1] ALLOW_UNUSED_TYPE
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define MSVC_PUSH_DISABLE_WARNING(n) __pragma(warning(push)) __pragma(warning(disable : n))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define MSVC_PUSH_WARNING_LEVEL(n) __pragma(warning(push, n))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define MSVC_POP_WARNING() __pragma(warning(pop))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define ALLOW_THIS_IN_INITIALIZER_LIST(code) MSVC_PUSH_DISABLE_WARNING(4355) code MSVC_POP_WARNING()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define ALLOW_THIS_IN_INITIALIZER_LIST(code) code
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define arraysize(array) (sizeof(ArraySizeHelper(array)))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DISALLOW_COPY_AND_ASSIGN(TypeName) TypeName(const TypeName&); void operator=(const TypeName&)
...
//Original Metin2 CPlus Line: #define ALLOW_THIS_IN_INITIALIZER_LIST(code) code
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define ANNOTATE_HAPPENS_BEFORE(obj)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define ANNOTATE_HAPPENS_AFTER(obj)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define ATOMIC_DECLARATION = 0
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_IS_ON() false
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_IS_ON() true
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_IS_ON() false
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_IS_ON() true
...
//Original Metin2 CPlus Line: #define ALLOW_THIS_IN_INITIALIZER_LIST(code) code
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CEF_EXPORT __declspec(dllexport)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CEF_EXPORT __declspec(dllimport)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CEF_CALLBACK __stdcall
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_INFO(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_INFO, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_WARNING(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_WARNING, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_ERROR(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_ERROR, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_FATAL(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_FATAL, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_DFATAL(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_DFATAL, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_INFO COMPACT_GOOGLE_LOG_EX_INFO(LogMessage)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_WARNING COMPACT_GOOGLE_LOG_EX_WARNING(LogMessage)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_ERROR COMPACT_GOOGLE_LOG_EX_ERROR(LogMessage)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_FATAL COMPACT_GOOGLE_LOG_EX_FATAL(LogMessage)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_DFATAL COMPACT_GOOGLE_LOG_EX_DFATAL(LogMessage)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_0(ClassName, ...) COMPACT_GOOGLE_LOG_EX_ERROR(ClassName, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_0 COMPACT_GOOGLE_LOG_ERROR
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define LOG_IS_ON(severity) ((::cef::logging::LOG_##severity) >= ::cef::logging::GetMinLogLevel())
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VLOG_IS_ON(verboselevel) ((verboselevel) <= ::cef::logging::GetVlogLevel(__FILE__))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define LAZY_STREAM(stream, condition) !(condition) ? (void)0 : ::cef::logging::LogMessageVoidify() & (stream)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define LOG_STREAM(severity) COMPACT_GOOGLE_LOG_##severity.stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define LOG(severity) LAZY_STREAM(LOG_STREAM(severity), LOG_IS_ON(severity))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define LOG_IF(severity, condition) LAZY_STREAM(LOG_STREAM(severity), LOG_IS_ON(severity) && (condition))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define SYSLOG(severity) LOG(severity)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define SYSLOG_IF(severity, condition) LOG_IF(severity, condition)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VLOG_STREAM(verbose_level) cef::logging::LogMessage(__FILE__, __LINE__, -verbose_level).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VLOG(verbose_level) LAZY_STREAM(VLOG_STREAM(verbose_level), VLOG_IS_ON(verbose_level))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VLOG_IF(verbose_level, condition) LAZY_STREAM(VLOG_STREAM(verbose_level), VLOG_IS_ON(verbose_level) && (condition))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VPLOG_STREAM(verbose_level) cef::logging::Win32ErrorLogMessage(__FILE__, __LINE__, -verbose_level, ::cef::logging::GetLastSystemErrorCode()).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VPLOG_STREAM(verbose_level) cef::logging::ErrnoLogMessage(__FILE__, __LINE__, -verbose_level, ::cef::logging::GetLastSystemErrorCode()).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VPLOG(verbose_level) LAZY_STREAM(VPLOG_STREAM(verbose_level), VLOG_IS_ON(verbose_level))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define VPLOG_IF(verbose_level, condition) LAZY_STREAM(VPLOG_STREAM(verbose_level), VLOG_IS_ON(verbose_level) && (condition))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define LOG_ASSERT(condition) LOG_IF(FATAL, !(condition)) << "Assert failed: " #condition ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define SYSLOG_ASSERT(condition) SYSLOG_IF(FATAL, !(condition)) << "Assert failed: " #condition ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PLOG_STREAM(severity) COMPACT_GOOGLE_LOG_EX_##severity(Win32ErrorLogMessage, ::cef::logging::GetLastSystemErrorCode()).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PLOG_STREAM(severity) COMPACT_GOOGLE_LOG_EX_##severity(ErrnoLogMessage, ::cef::logging::GetLastSystemErrorCode()).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PLOG(severity) LAZY_STREAM(PLOG_STREAM(severity), LOG_IS_ON(severity))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PLOG_IF(severity, condition) LAZY_STREAM(PLOG_STREAM(severity), LOG_IS_ON(severity) && (condition))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define EAT_STREAM_PARAMETERS true ? (void)0 : ::cef::logging::LogMessageVoidify() & LOG_STREAM(FATAL)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK(condition) LAZY_STREAM(LOG_STREAM(FATAL), !(condition)) << "Check failed: " #condition ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PCHECK(condition) LAZY_STREAM(PLOG_STREAM(FATAL), !(condition)) << "Check failed: " #condition ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_OP(name, op, val1, val2) if (std::string* _result = cef::logging::Check##name##Impl( (val1), (val2), #val1 " " #op " " #val2)) cef::logging::LogMessage(__FILE__, __LINE__, _result).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DEFINE_CHECK_OP_IMPL(name, op) template <class t1, class t2> inline std::string* Check##name##Impl(const t1& v1, const t2& v2, const char* names) { if (v1 op v2) return NULL; else return MakeCheckOpString(v1, v2, names); } inline std::string* Check##name##Impl(int v1, int v2, const char* names) { if (v1 op v2) return NULL; else return MakeCheckOpString(v1, v2, names); }
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_EQ(val1, val2) CHECK_OP(EQ, ==, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_NE(val1, val2) CHECK_OP(NE, !=, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_LE(val1, val2) CHECK_OP(LE, <=, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_LT(val1, val2) CHECK_OP(LT, <, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_GE(val1, val2) CHECK_OP(GE, >=, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define CHECK_GT(val1, val2) CHECK_OP(GT, >, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_IS_ON() 0
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_IS_ON() 1
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG_IS_ON(severity) LOG_IS_ON(severity)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG_IF(severity, condition) LOG_IF(severity, condition)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG_ASSERT(condition) LOG_ASSERT(condition)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DPLOG_IF(severity, condition) PLOG_IF(severity, condition)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DVLOG_IF(verboselevel, condition) VLOG_IF(verboselevel, condition)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DVPLOG_IF(verboselevel, condition) VPLOG_IF(verboselevel, condition)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG_IS_ON(severity) false
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG_IF(severity, condition) EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG_ASSERT(condition) EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DPLOG_IF(severity, condition) EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DVLOG_IF(verboselevel, condition) EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DVPLOG_IF(verboselevel, condition) EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DLOG(severity) LAZY_STREAM(LOG_STREAM(severity), DLOG_IS_ON(severity))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DPLOG(severity) LAZY_STREAM(PLOG_STREAM(severity), DLOG_IS_ON(severity))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DVLOG(verboselevel) DVLOG_IF(verboselevel, VLOG_IS_ON(verboselevel))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DVPLOG(verboselevel) DVPLOG_IF(verboselevel, VLOG_IS_ON(verboselevel))
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_DCHECK(ClassName, ...) COMPACT_GOOGLE_LOG_EX_FATAL(ClassName, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_DCHECK COMPACT_GOOGLE_LOG_FATAL
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_DCHECK(ClassName, ...) COMPACT_GOOGLE_LOG_EX_INFO(ClassName, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_DCHECK COMPACT_GOOGLE_LOG_INFO
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK(condition) LAZY_STREAM(LOG_STREAM(DCHECK), DCHECK_IS_ON() && !(condition)) << "Check failed: " #condition ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DPCHECK(condition) LAZY_STREAM(PLOG_STREAM(DCHECK), DCHECK_IS_ON() && !(condition)) << "Check failed: " #condition ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_OP(name, op, val1, val2) if (DCHECK_IS_ON()) if (std::string* _result = cef::logging::Check##name##Impl( (val1), (val2), #val1 " " #op " " #val2)) cef::logging::LogMessage(__FILE__, __LINE__, ::cef::logging::LOG_DCHECK, _result).stream()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_EQ(val1, val2) DCHECK_OP(EQ, ==, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_NE(val1, val2) DCHECK_OP(NE, !=, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_LE(val1, val2) DCHECK_OP(LE, <=, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_LT(val1, val2) DCHECK_OP(LT, <, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_GE(val1, val2) DCHECK_OP(GE, >=, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define DCHECK_GT(val1, val2) DCHECK_OP(GT, >, val1, val2)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTREACHED() LOG(ERROR) << "NOTREACHED() hit in " << __FUNCTION__ << ". "
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTREACHED() DCHECK(false)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define assert(x) DLOG_ASSERT(x)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED_MSG "Not implemented reached in " << __PRETTY_FUNCTION__
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED() EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED() COMPILE_ASSERT(false, NOT_IMPLEMENTED)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED() COMPILE_ASSERT(false, NOT_IMPLEMENTED)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED() NOTREACHED()
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED() LOG(ERROR) << NOTIMPLEMENTED_MSG
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define NOTIMPLEMENTED() do { static bool logged_once = false; LOG_IF(ERROR, !logged_once) << NOTIMPLEMENTED_MSG; logged_once = true; } while (0); EAT_STREAM_PARAMETERS
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_INFO(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_INFO, ##__VA_ARGS__)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define COMPACT_GOOGLE_LOG_EX_WARNING(ClassName, ...) cef::logging::ClassName(__FILE__, __LINE__, cef::logging::LOG_WARNING, ##__VA_ARGS__)
