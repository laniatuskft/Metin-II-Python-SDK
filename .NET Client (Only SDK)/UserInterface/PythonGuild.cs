...
public class CPythonGuild : CSingleton<CPythonGuild>
{
		public const int GUILD_SKILL_MAX_NUM = 12;
		public const int ENEMY_GUILD_SLOT_MAX_COUNT = 6;

		public class SGulidInfo
		{
			public uint dwGuildID;
			public string szGuildName = new string(new char[GUILD_NAME_MAX_LEN + 1]);
			public uint dwMasterPID;
			public uint dwGuildLevel;
			public uint dwCurrentExperience;
			public uint dwCurrentMemberCount;
			public uint dwMaxMemberCount;
			public uint dwGuildMoney;
			public bool bHasLand;
		}

		public class SGuildGradeData
		{
			public SGuildGradeData()
			{
			}
			public SGuildGradeData(byte byAuthorityFlag_, string c_szName_)
			{
				this.byAuthorityFlag = byAuthorityFlag_;
				this.strName = c_szName_;
			}
			public byte byAuthorityFlag;
			public string strName = "";
		}

		public class SGuildMemberData
		{
			public uint dwPID;
			...
			public byte byJob;
			public byte byLevel;
			public byte byGeneralFlag;
			public uint dwOffer;
		}

		public class SGuildBoardCommentData
		{
			public uint dwCommentID;
			public string strName = "";
			public string strComment = "";
		}

		public class SGuildSkillData
		{
			public byte bySkillPoint;
			public byte[] bySkillLevel = new byte[GUILD_SKILL_MAX_NUM];
			public ushort wGuildPoint;
			public ushort wMaxGuildPoint;
		}
		...
		public void EnableGuild()
		{
			m_bGuildEnable = true;
		}

		public void SetGuildMoney(uint dwMoney)
		{
			m_GuildInfo.dwGuildMoney = dwMoney;
		}

		public void SetGuildEXP(byte byLevel, uint dwEXP)
		{
...
//		void SetGradeData(byte byGradeNumber, SGuildGradeData rGuildGradeData);
		public void SetGradeName(byte byGradeNumber, string c_szName)
		{
		...
		public void SetGradeAuthority(byte byGradeNumber, byte byAuthority)
		{
			if (!__IsGradeData(byGradeNumber))
			{
				return;
		...
		public void RegisterComment(uint dwCommentID, string c_szName, string c_szComment)
		{
			...
			TGuildBoardCommentData CommentData = new TGuildBoardCommentData();
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void RegisterMember(SGuildMemberData rGuildMemberData);
		public void ChangeGuildMemberGrade(uint dwPID, byte byGrade)
		{
		...
		public void ChangeGuildMemberGeneralFlag(uint dwPID, byte byFlag)
		{
			TGuildMemberData pGuildMemberData;
			if (!GetMemberDataPtrByPID(dwPID, pGuildMemberData))
			{
		...
		public void RemoveMember(uint dwPID)
		{
		...
		public void RegisterGuildName(uint dwID, string c_szName)
		{
			m_GuildNameMap.insert(Tuple.Create(dwID, new string(c_szName)));
		}

		public bool IsMainPlayer(uint dwPID)
		{
			TGuildMemberData pGuildMemberData;
			if (!GetMemberDataPtrByPID(dwPID, pGuildMemberData))
			{
		...
		public bool IsGuildEnable()
		{
			return m_bGuildEnable;
		}

		public SGulidInfo GetGuildInfoRef()
		{
			return m_GuildInfo;
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetGradeDataPtr(uint dwGradeNumber, SGuildGradeData[] ppData);
		public List<SGuildBoardCommentData> GetGuildBoardCommentVector()
		{
		...
		{
			return (uint)m_GuildMemberDataVector.size();
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMemberDataPtr(uint dwIndex, SGuildMemberData[] ppData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMemberDataPtrByPID(uint dwPID, SGuildMemberData[] ppData);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool GetMemberDataPtrByName(string c_szName, SGuildMemberData[] ppData);
		public uint GetGuildMemberLevelSummary()
		{
			return m_dwMemberLevelSummary;
		}

		public uint GetGuildMemberLevelAverage()
		{
			return m_dwMemberLevelAverage;
		}

		public uint GetGuildExperienceSummary()
		{
			return m_dwMemberExperienceSummary;
		}

		public SGuildSkillData GetGuildSkillDataRef()
		{
			return m_GuildSkillData;
		}

		public bool GetGuildName(uint dwID, string pstrGuildName)
		{
		...
		public bool HasGuildLand()
		{
			return m_GuildInfo.bHasLand;
		}

		public void StartGuildWar(uint dwEnemyGuildID)
		{
			int i;
		...
		public void EndGuildWar(uint dwEnemyGuildID)
		{
		...
		public uint GetEnemyGuildID(uint dwIndex)
		{
		...
		protected void __CalculateLevelAverage()
		{
...
//Original Metin2 CPlus Line: TGuildMemberData & rGuildMemberData = *itor;
		...
		protected void __Initialize()
		{
			...
			ZeroMemory(m_adwEnemyGuildID, ENEMY_GUILD_SLOT_MAX_COUNT * sizeof(uint));
		...
		protected SGulidInfo m_GuildInfo = new SGulidInfo();
		protected SortedDictionary<byte, SGuildGradeData> m_GradeDataMap = new SortedDictionary<byte, SGuildGradeData>();
		protected List<SGuildMemberData> m_GuildMemberDataVector = new List<SGuildMemberData>();
		protected List<SGuildBoardCommentData> m_GuildBoardCommentVector = new List<SGuildBoardCommentData>();
		protected SGuildSkillData m_GuildSkillData = new SGuildSkillData();
		protected SortedDictionary<uint, string> m_GuildNameMap = new SortedDictionary<uint, string>();
		protected uint[] m_adwEnemyGuildID = new uint[ENEMY_GUILD_SLOT_MAX_COUNT];

		protected uint m_dwMemberLevelSummary;
		protected uint m_dwMemberLevelAverage;
		protected uint m_dwMemberExperienceSummary;

		protected bool m_bGuildEnable;
}



public class CPythonGuild_FFindGuildMemberByPID
{
	public CPythonGuild_FFindGuildMemberByPID(uint dwSearchingPID_)
	{
		this.dwSearchingPID = dwSearchingPID_;
	}
	public int functorMethod(SGuildMemberData rGuildMemberData)
	{
		return rGuildMemberData.dwPID == dwSearchingPID ? 1 : 0;
	}

	public uint dwSearchingPID;
}

public class CPythonGuild_FFindGuildMemberByName
{
	public CPythonGuild_FFindGuildMemberByName(string c_szSearchingName)
	{
		this.strSearchingName = c_szSearchingName;
	}
	public int functorMethod(SGuildMemberData rGuildMemberData)
	{
		return 0 == strSearchingName.compare(rGuildMemberData.strName.c_str()) ? 1 : 0;
	}
...
public class CPythonGuild_SLessMemberGrade
{
	public bool functorMethod(SGuildMemberData rleft, SGuildMemberData rright)
	{
