...
public class ClientV8ExtensionHandler : CefV8Handler
{
	public ClientV8ExtensionHandler(CefRefPtr<CefApp> app)
	{
		this.app = app;
	}

	public bool Execute(in CefString name, CefRefPtr<CefV8Value> @object, in CefV8ValueList arguments, CefRefPtr<CefV8Value> retval, CefString exception)
	{
	...
	private CefRefPtr<CefApp> app = new CefRefPtr<CefApp>();
