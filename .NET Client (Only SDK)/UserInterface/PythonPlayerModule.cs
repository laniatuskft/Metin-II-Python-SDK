...
public class CBeltInventoryHelper
{

//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
	private static byte[] GetBeltGradeByRefineLevel_beltGradeByLevelTable = {0, 1, 1, 2, 2, 3, 4, 5, 6, 7};

	public static byte GetBeltGradeByRefineLevel(int refineLevel)
	{
...
//		static byte beltGradeByLevelTable[] = { 0, 1, 1, 2, 2, 3, 4, 5, 6, 7};
		...
		return GetBeltGradeByRefineLevel_beltGradeByLevelTable[refineLevel];
	}

//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
	private static byte[] GetAvailableRuleTableByGrade_availableRuleByGrade = Arrays.PadValueTypeArrayWithDefaultInstances(c_Belt_Inventory_Slot_Count, new byte[] {1, 2, 4, 6, 3, 3, 4, 6, 5, 5, 5, 6, 7, 7, 7, 7});

//# Laniatus Games Studio Inc. | WARN: C# has no equivalent to methods returning pointers to value types:
//Original Metin2 CPlus Line: static const byte* GetAvailableRuleTableByGrade()
	public static byte GetAvailableRuleTableByGrade()
	{
//# Laniatus Games Studio Inc. |: This static local variable declaration (not allowed in C#) has been moved just prior to the method:
//		static byte availableRuleByGrade[c_Belt_Inventory_Slot_Count] = { 1, 2, 4, 6, 3, 3, 4, 6, 5, 5, 5, 6, 7, 7, 7, 7 };

		return GetAvailableRuleTableByGrade_availableRuleByGrade;
	}

	public static bool IsAvailableCell(ushort cell, int beltGrade)
	{
		byte[] ruleTable = GetAvailableRuleTableByGrade();
