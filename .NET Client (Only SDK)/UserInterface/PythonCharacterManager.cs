...
public class CPythonCharacterManager : CSingleton<CPythonCharacterManager>, IAbstractCharacterManager, IObjectManager
{

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following type could not be found:
//		class CharacterIterator;

		public CPythonCharacterManager()
		{
			__Initialize();
		}
		...
		public virtual void AdjustCollisionWithOtherObjects(CActorInstance pInst)
		{
			if (!pInst.IsPC())
			{
				return;
			...
			for (CPythonCharacterManager.CharacterIterator LaniatusDefVariables = rkChrMgr.CharacterInstanceBegin(); LaniatusDefVariables != rkChrMgr.CharacterInstanceEnd();++i)
			{
				...
				{
					TPixelPosition curPos = new TPixelPosition();
		...
		public void EnableSortRendering(bool isEnable)
		{
		}

		public bool IsRegisteredVID(uint dwVID)
		{
		...
		public bool IsAliveVID(uint dwVID)
		{
			return m_kAliveInstMap.find(dwVID) != m_kAliveInstMap.end();
		}

		public bool IsDeadVID(uint dwVID)
		{
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private bool IsCacheMode_s_isOldCacheMode = false;
...
//			static bool s_isOldCacheMode=false;
			...
			bool isCacheMode = IsCacheMode_s_isOldCacheMode;
			if (IsCacheMode_s_isOldCacheMode)
			{
			...
			IsCacheMode_s_isOldCacheMode = isCacheMode;

			return isCacheMode;
		}

		public bool OLD_GetPickedInstanceVID(ref uint pdwPickedActorID)
		{
			if (!m_pkInstPick)
			{
				return false;
		...
		public CInstanceBase OLD_GetPickedInstancePtr()
		{
			return m_pkInstPick;
		}

		public D3DXVECTOR2 OLD_GetPickedInstPosReference()
		{
			return m_v2PickedInstProjPos;
		}

		public CInstanceBase FindClickableInstancePtr()
		{
			return null;
		}
		...
		public void ChangeGVG(uint dwSrcGuildID, uint dwDstGuildID)
		{
			TCharacterInstanceMap.iterator itor = new TCharacterInstanceMap.iterator();
			for (itor = m_kAliveInstMap.begin(); itor != m_kAliveInstMap.end(); itor++)
			{
				CInstanceBase pInstance = itor.second;

				uint dwInstanceGuildID = pInstance.GetGuildID();
		...
		public void GetInfo(string pstInfo)
		{
		...
		public void ClearMainInstance()
		{
			m_pkInstMain = null;
		}

		public bool SetMainInstance(uint dwVID)
		{
		...
		public CInstanceBase GetMainInstancePtr()
		{
			return m_pkInstMain;
		}

//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SCRIPT_SetAffect(uint dwVID, uint eAffect, bool isVisible);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void SetEmoticon(uint dwVID, uint eEmoticon);
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		bool IsPossibleEmoticon(uint dwVID);
		public void ShowPointEffect(uint ePoint, uint dwVID)
		{
		...
		public bool RegisterPointEffect(uint ePoint, string c_szFileName)
		{
...
//		void DestroyDeviceObjects();
		...
		public void Update()
		{
			...
			uint dwDeadInstCount = 0;
			uint dwForceVisibleInstCount = 0;
			...
			while (m_kAliveInstMap.end() != i)
			{
				...
				if (pkInstMain != null)
				{
					int nDistance = pkInstEach.NEW_GetDistanceFromDestInstance(pkInstMain);
		...
		public void Render()
		{
			...
			if (pkPickedInst != null)
			{
				_D3DVECTOR c_rv3Position = pkPickedInst.GetGraphicThingInstanceRef().GetPosition();
		...
		public void RenderShadowMainInstance()
		{
			CInstanceBase pkInstMain = GetMainInstancePtr();
			if (pkInstMain != null)
			{
		...
		public void RenderShadowAllInstances()
		{
		...
		public CInstanceBase CreateInstance(in CInstanceBase.SCreateData c_rkCreateData)
		{
		...
		public CInstanceBase RegisterInstance(uint VirtualID)
		{
		...
		public void DeleteInstance(uint dwDelVID)
		{
		...
		public void DeleteInstanceByFade(uint dwVID)
		{
...
//# Laniatus Games Studio Inc. | TODO TASK: The implementation of the following method could not be found:
//		void DeleteVehicleInstance(uint VirtualID);

		public void DestroyAliveInstanceMap()
		{
			for (TCharacterInstanceMap.iterator LaniatusDefVariables = m_kAliveInstMap.begin(); LaniatusDefVariables != m_kAliveInstMap.end(); ++i)
			{
		...
		public void DestroyDeadInstanceList()
		{
			std::for_each(m_kDeadInstList.begin(), m_kDeadInstList.end(), CInstanceBase.Delete);
			m_kDeadInstList.clear();
		}

		public CharacterIterator CharacterInstanceBegin()
		{
			return new CharacterIterator(m_kAliveInstMap.begin());
		}
		public CharacterIterator CharacterInstanceEnd()
		{
			return new CharacterIterator(m_kAliveInstMap.end());
		}

		public void SelectInstance(uint VirtualID)
		{
			TCharacterInstanceMap.iterator itor = m_kAliveInstMap.find(VirtualID);
		...
		public CInstanceBase GetSelectedInstancePtr()
		{
			return m_pkInstBind;
		}

		public CInstanceBase GetInstancePtr(uint VirtualID)
		{
			TCharacterInstanceMap.iterator itor = m_kAliveInstMap.find(VirtualID);
		...
		public CInstanceBase GetInstancePtrByName(string name)
		{
			TCharacterInstanceMap.iterator itor = new TCharacterInstanceMap.iterator();
		...
		public CInstanceBase GetCloseInstance(CInstanceBase pInstance)
		{
			...
			for (; itor != m_kAliveInstMap.end(); ++itor)
			{
				...
				uint dwVirtualNumber = pTargetInstance.GetVirtualNumber();
		...
		public void RefreshAllPCTextTail()
		{
		...
		public void RefreshAllGuildMark()
		{
			CPythonCharacterManager.CharacterIterator itor = CharacterInstanceBegin();
			CPythonCharacterManager.CharacterIterator itorEnd = CharacterInstanceEnd();
			for (; itor != itorEnd; ++itor)
...
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memset' has no equivalent in C#:
		...
		protected void __DeleteBlendOutInstance(CInstanceBase pkInstDel)
		{
		...
		protected void __NEW_Pick()
		{
			__UpdateSortPickedActorList();

			CInstanceBase pkInstMain = GetMainInstancePtr();
			{
				List<CInstanceBase>.Enumerator f;
				for (f = m_kVct_pkInstPicked.begin(); f.MoveNext();)
				{
					CInstanceBase pkInstEach = f.Current;
		...
		protected void __UpdateSortPickedActorList()
		{
			__UpdatePickedActorList();
			__SortPickedActorList();
		}

		protected void __UpdatePickedActorList()
		{
			m_kVct_pkInstPicked.clear();

			TCharacterInstanceMap.iterator LaniatusDefVariables = new TCharacterInstanceMap.iterator();
			for (i = m_kAliveInstMap.begin(); LaniatusDefVariables != m_kAliveInstMap.end(); ++i)
			{
		...
		protected void __SortPickedActorList()
		{
			CCamera pCamera = CCameraManager.Instance().GetCurrentCamera();
			_D3DVECTOR c_rv3EyePos = pCamera.GetEye();

			CInstanceBase_SLessCameraDistance kLess = new CInstanceBase_SLessCameraDistance();
...
//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private List<CInstanceBase> __RenderSortedAliveActorList_s_kVct_pkInstAliveSort = new List<CInstanceBase>();

		protected void __RenderSortedAliveActorList()
		{
//# Laniatus Games Studio Inc. |: This static local variable declaration (not allowed in C#) has been moved just prior to the method:
//			static System.Collections.Generic.List<CInstanceBase*> s_kVct_pkInstAliveSort;
			__RenderSortedAliveActorList_s_kVct_pkInstAliveSort.clear();

			TCharacterInstanceMap rkMap_pkInstAlive = m_kAliveInstMap;
			TCharacterInstanceMap.iterator LaniatusDefVariables = new TCharacterInstanceMap.iterator();
			for (i = rkMap_pkInstAlive.begin(); LaniatusDefVariables != rkMap_pkInstAlive.end(); ++i)
			{
				__RenderSortedAliveActorList_s_kVct_pkInstAliveSort.push_back(i.second);
			}

			std::sort(__RenderSortedAliveActorList_s_kVct_pkInstAliveSort.begin(), __RenderSortedAliveActorList_s_kVct_pkInstAliveSort.end(), LessCharacterInstancePtrRenderOrder());
			std::for_each(__RenderSortedAliveActorList_s_kVct_pkInstAliveSort.begin(), __RenderSortedAliveActorList_s_kVct_pkInstAliveSort.end(), FCharacterInstanceRender());
			std::for_each(__RenderSortedAliveActorList_s_kVct_pkInstAliveSort.begin(), __RenderSortedAliveActorList_s_kVct_pkInstAliveSort.end(), FCharacterInstanceRenderTrace());
		}

//# Laniatus Games Studio Inc. |: This was formerly a static local variable declaration (not allowed in C#):
		private List<CInstanceBase> __RenderSortedDeadActorList_s_kVct_pkInstDeadSort = new List<CInstanceBase>();

		protected void __RenderSortedDeadActorList()
		{
//# Laniatus Games Studio Inc. |: This static local variable declaration (not allowed in C#) has been moved just prior to the method:
//			static System.Collections.Generic.List<CInstanceBase*> s_kVct_pkInstDeadSort;
			__RenderSortedDeadActorList_s_kVct_pkInstDeadSort.clear();

			TCharacterInstanceList rkLst_pkInstDead = m_kDeadInstList;
			TCharacterInstanceList.iterator LaniatusDefVariables = new TCharacterInstanceList.iterator();
			for (i = rkLst_pkInstDead.begin(); LaniatusDefVariables != rkLst_pkInstDead.end(); ++i)
			{
				__RenderSortedDeadActorList_s_kVct_pkInstDeadSort.push_back(*i);
			}

			std::sort(__RenderSortedDeadActorList_s_kVct_pkInstDeadSort.begin(), __RenderSortedDeadActorList_s_kVct_pkInstDeadSort.end(), LessCharacterInstancePtrRenderOrder());
			std::for_each(__RenderSortedDeadActorList_s_kVct_pkInstDeadSort.begin(), __RenderSortedDeadActorList_s_kVct_pkInstDeadSort.end(), FCharacterInstanceRender());

		}

		protected CInstanceBase m_pkInstMain;
		protected CInstanceBase m_pkInstPick;
		protected CInstanceBase m_pkInstBind;
		protected D3DXVECTOR2 m_v2PickedInstProjPos = new D3DXVECTOR2();

		protected SortedDictionary<uint, CInstanceBase > m_kAliveInstMap = new SortedDictionary<uint, CInstanceBase >();
		protected LinkedList<CInstanceBase > m_kDeadInstList = new LinkedList<CInstanceBase >();

		protected List<CInstanceBase> m_kVct_pkInstPicked = new List<CInstanceBase>();

		protected uint[] m_adwPointEffect = new uint[POINT_MAX_NUM];

		public void UpdateShowMonsterEffects(bool show)
		{
			TCharacterInstanceMap.iterator itor = m_kAliveInstMap.begin();
			for (; itor != m_kAliveInstMap.end(); ++itor)
			{
				...
				pTargetInstance.SetShowMonsterEffects(show);
			}
		}
		...
		public class CharacterIterator
		{
			...
			public CharacterIterator(in TCharacterInstanceMap.iterator it)
			{
				this.m_it = it;
			}

			public CInstanceBase Indirection ()
			{
				return m_it.second;
			}

			public static CharacterIterator operator ++(CharacterIterator ImpliedObject)
			{
				++m_it;
				return ImpliedObject;
			}

			public static CharacterIterator operator ++(int UnnamedParameter)
			{
...
//Original Metin2 CPlus Line: return new_it;
				return new CharacterIterator(new_it);
			}

//# Laniatus Games Studio Inc. |: This 'CopyFrom' method was converted from the original copy assignment operator:
//Original Metin2 CPlus Line: inline CharacterIterator & operator = (const CharacterIterator & rhs)
			public CharacterIterator CopyFrom (in CharacterIterator rhs)
			{
				m_it = rhs.m_it;
				return (this);
			}
...
//Original Metin2 CPlus Line: inline bool operator == (const CharacterIterator & rhs) const
			public static bool operator == (CharacterIterator ImpliedObject, in CharacterIterator rhs)
			{
...
//Original Metin2 CPlus Line: inline bool operator != (const CharacterIterator & rhs) const
			public static bool operator != (CharacterIterator ImpliedObject, in CharacterIterator rhs)
			{
				...
				private TCharacterInstanceMap.iterator m_it = new TCharacterInstanceMap.iterator();
		}
}

public class FCharacterManagerCharacterInstanceUpdate
{
	public void functorMethod(in Tuple<uint,CInstanceBase > cr_Pair)
	{
		cr_Pair.Item2.Update();
	}
}

public class FCharacterManagerCharacterInstanceDeform
{
	public void functorMethod(in Tuple<uint,CInstanceBase > cr_Pair)
	{
		cr_Pair.Item2.Deform();
	}
}
public class FCharacterManagerCharacterInstanceListDeform
{
	public void functorMethod(CInstanceBase pInstance)
	{
		pInstance.Deform();
	}
}

public class LessCharacterInstancePtrRenderOrder
{
	public bool functorMethod(CInstanceBase pkLeft, CInstanceBase pkRight)
	{
		return pkLeft.LessRenderOrder(pkRight);
	}
}

public class FCharacterManagerCharacterInstanceRender
{
	public void functorMethod(in Tuple<uint,CInstanceBase > cr_Pair)
	{
		cr_Pair.Item2.Render();
		cr_Pair.Item2.RenderTrace();
	}
}
public class FCharacterInstanceRender
{
	public void functorMethod(CInstanceBase pInstance)
	{
		pInstance.Render();
...
public class FCharacterInstanceRenderTrace
{
	public void functorMethod(CInstanceBase pInstance)
	{
...
public class FCharacterManagerCharacterInstanceRenderToShadowMap
{
	public void functorMethod(in Tuple<uint,CInstanceBase > cr_Pair)
	{
		cr_Pair.Item2.RenderToShadowMap();
	}
}

public class FCharacterManagerCharacterInstanceRenderCollision
{
	public void functorMethod(in Tuple<uint,CInstanceBase > cr_Pair)
	{
		cr_Pair.Item2.RenderCollision();
	}
}

public class CInstanceBase_SLessCameraDistance
{
	public TPixelPosition m_kPPosEye = new TPixelPosition();

	public bool functorMethod(CInstanceBase pkInstLeft, CInstanceBase pkInstRight)
	{
