...
public class CPythonSafeBox : CSingleton<CPythonSafeBox>
{
		public const int SAFEBOX_SLOT_X_COUNT = 5;
		public const int SAFEBOX_SLOT_Y_COUNT = 9;
		public const int SAFEBOX_PAGE_SIZE = SAFEBOX_SLOT_X_COUNT * SAFEBOX_SLOT_Y_COUNT;

		public CPythonSafeBox()
		{
			m_dwMoney = 0;
		}
		...
		public void OpenSafeBox(int iSize)
		{
			m_dwMoney = 0;
		...
		public void SetItemData(uint dwSlotIndex, in TItemData rItemInstance)
		{
		...
		public void DelItemData(uint dwSlotIndex)
		{
			if (dwSlotIndex >= m_ItemInstanceVector.size())
			{
		...
		public void SetMoney(uint dwMoney)
		{
			m_dwMoney = dwMoney;
		}
		...
		public bool GetSlotItemID(uint dwSlotIndex, ref uint pdwItemID)
		{
			if (dwSlotIndex >= m_ItemInstanceVector.size())
			{
		...
		public int GetCurrentSafeBoxSize()
		{
			return m_ItemInstanceVector.size();
		}

		public bool GetItemDataPtr(uint dwSlotIndex, TItemData[] ppInstance)
		{
			if (dwSlotIndex >= m_ItemInstanceVector.size())
			{
			...
			ppInstance[0] = &m_ItemInstanceVector[dwSlotIndex];

			return true;
		}

		public void OpenMall(int iSize)
		{
		...
		public void SetMallItemData(uint dwSlotIndex, in TItemData rItemData)
		{
		...
		public void DelMallItemData(uint dwSlotIndex)
		{
			if (dwSlotIndex >= m_MallItemInstanceVector.size())
			{
		...
		public bool GetMallItemDataPtr(uint dwSlotIndex, TItemData[] ppInstance)
		{
			if (dwSlotIndex >= m_MallItemInstanceVector.size())
			{
			...
			ppInstance[0] = &m_MallItemInstanceVector[dwSlotIndex];

			return true;
		}

		public bool GetSlotMallItemID(uint dwSlotIndex, ref uint pdwItemID)
		{
			if (dwSlotIndex >= m_MallItemInstanceVector.size())
			{
				TraceError("CPythonSafeBox::GetMallSlotItemID(dwSlotIndex=%d) - Strange slot index", dwSlotIndex);
		...
		public uint GetMallSize()
		{
			return (uint)m_MallItemInstanceVector.size();
		}

		protected List<TItemData> m_ItemInstanceVector = new List<TItemData>();
		protected List<TItemData> m_MallItemInstanceVector = new List<TItemData>();
		protected uint m_dwMoney;
}