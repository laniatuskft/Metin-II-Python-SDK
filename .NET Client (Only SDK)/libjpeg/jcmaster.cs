...
public class my_comp_master
{
  public jpeg_comp_master pub = new jpeg_comp_master(); // public fields

  public c_pass_type pass_type = new c_pass_type(); // the type of the current pass
