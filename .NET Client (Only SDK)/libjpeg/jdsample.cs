...
public class my_upsampler
{
  public jpeg_upsampler pub = new jpeg_upsampler(); // public fields
   ...
   */
  public JSAMPARRAY[] color_buf = Arrays.InitializeWithDefaultInstances<JSAMPARRAY>(DefineConstants.MAX_COMPONENTS);

  /* Per-component upsampling method pointers */
  public upsample1_ptr[] methods = Arrays.InitializeWithDefaultInstances<upsample1_ptr>(DefineConstants.MAX_COMPONENTS);

  public int next_row_out; // counts rows emitted from color_buf
  public uint rows_to_go; // counts rows remaining in image

  /* Height of an input row group for each component. */
  public int[] rowgroup_height = new int[DefineConstants.MAX_COMPONENTS];

  /* These arrays save pixel expansion factors so that int_expand need not
   * recompute them each time.  They are unused for other upsampling methods.
   */
  public short[] h_expand = new short[DefineConstants.MAX_COMPONENTS];
  public short[] v_expand = new short[DefineConstants.MAX_COMPONENTS];
}