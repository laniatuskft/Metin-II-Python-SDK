...
{
  public jpeg_d_main_controller pub = new jpeg_d_main_controller(); // public fields
  ...
  public boolean buffer_full = new boolean(); // Have we gotten an iMCU row from decoder?

  /* These are the master pointers to the funny-order pointer lists. */
  public JSAMPIMAGE[] xbuffer = Arrays.InitializeWithDefaultInstances<JSAMPIMAGE>(2); // pointers to weird pointer lists
