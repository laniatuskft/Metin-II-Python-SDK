...
{
  public jpeg_d_coef_controller pub = new jpeg_d_coef_controller(); // public fields
   ...
   */
  public JBLOCKROW[] MCU_buffer = Arrays.InitializeWithDefaultInstances<JBLOCKROW>(DefineConstants.D_MAX_BLOCKS_IN_MCU);

#if D_MULTISCAN_FILES_SUPPORTED
  /* In multi-pass modes, we need a virtual block array for each component. */
  public jvirt_barray_ptr[] whole_image = Arrays.InitializeWithDefaultInstances<jvirt_barray_ptr>(DefineConstants.MAX_COMPONENTS);
#endif
...
//Original Metin2 CPlus Line: int * coef_bits_latch;
