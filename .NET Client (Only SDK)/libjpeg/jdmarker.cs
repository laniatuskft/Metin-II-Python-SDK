...
public class my_marker_reader
{
  public jpeg_marker_reader pub = new jpeg_marker_reader(); // public fields

  /* Application-overridable marker processing methods */
  public jpeg_marker_parser_method process_COM = new jpeg_marker_parser_method();
  public jpeg_marker_parser_method[] process_APPn = Arrays.InitializeWithDefaultInstances<jpeg_marker_parser_method>(16);
  ...
  public jpeg_saved_marker_ptr cur_marker = new jpeg_saved_marker_ptr(); // NULL if not processing a marker
