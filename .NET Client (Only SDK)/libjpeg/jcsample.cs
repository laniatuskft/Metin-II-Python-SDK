...
public class my_downsampler
{
  public jpeg_downsampler pub = new jpeg_downsampler(); // public fields

  /* Downsampling method pointers, one per component */
  public downsample1_ptr[] methods = Arrays.InitializeWithDefaultInstances<downsample1_ptr>(DefineConstants.MAX_COMPONENTS);
