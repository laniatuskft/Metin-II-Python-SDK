...
public class my_decomp_master
{
  public jpeg_decomp_master pub = new jpeg_decomp_master(); // public fields

  public int pass_number; // # of passes completed

  public boolean using_merged_upsample = new boolean(); // TRUE if using merged upsample/cconvert
