...
public class arith_entropy_encoder
{
  ...
  public int[] dc_context = new int[DefineConstants.MAX_COMPS_IN_SCAN]; // context index for DC conditioning
...
//Original Metin2 CPlus Line: byte * dc_stats[DefineConstants.NUM_ARITH_TBLS];
  public byte[] dc_stats = {null};
//# Laniatus Games Studio Inc. | TODO TASK: C# does not have an equivalent to pointers to value types:
//Original Metin2 CPlus Line: byte * ac_stats[DefineConstants.NUM_ARITH_TBLS];
  public byte[] ac_stats = {null};

  /* Statistics bin for coding with fixed probability 0.5 */
  public byte[] fixed_bin = new byte[4];
}
