...
public class my_post_controller
{
  public jpeg_d_post_controller pub = new jpeg_d_post_controller(); // public fields
   ...
   */
  public jvirt_sarray_ptr whole_image = new jvirt_sarray_ptr(); // virtual array, or NULL if one-pass
  public JSAMPARRAY buffer = new JSAMPARRAY(); // strip buffer, or current strip of virtual
