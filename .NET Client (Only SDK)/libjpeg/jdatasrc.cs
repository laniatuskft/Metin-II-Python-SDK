...
public class my_source_mgr
{
  public jpeg_source_mgr pub = new jpeg_source_mgr(); // public fields

  public FILE infile; // source stream
  public JOCTET buffer; // start of buffer
  public boolean start_of_file = new boolean(); // have we gotten any data yet?
}