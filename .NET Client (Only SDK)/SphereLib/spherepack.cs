...
public class SpherePackCallback
{
	...
	public virtual void VisibilityCallback(in Frustum f, SpherePack sphere, ViewState state)
	{
	}

	public virtual void RayTraceCallback(in Vector3d p1, in Vector3d dir, float distance, in Vector3d sect, SpherePack sphere)
	{
	}

	public virtual void RangeTestCallback(in Vector3d searchpos, float distance, SpherePack sphere, ViewState state)
	{
	}

	public virtual void PointTest2dCallback(in Vector3d searchpos, SpherePack sphere, ViewState state)
	{
	}
...
public class SpherePack : Sphere
{
	public SpherePack()
	{
		mUserData = 0;
	...
	public void Init(SpherePackFactory factory, in Vector3d pos, float radius, object userdata, bool isSphere)
	{
		IS_SPHERE = isSphere;
		mUserData = userdata;
		mParent = 0;
	...
	public void SetSpherePackFlag(SpherePackFlag flag)
	{
		mFlags |= flag;
	}
	public void ClearSpherePackFlag(SpherePackFlag flag)
	{
		mFlags &= ~flag;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool HasSpherePackFlag(SpherePackFlag flag) const
	...
	public void SetParent(SpherePack pack)
	{
		mParent = pack;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: SpherePack * GetParent() const
	public SpherePack GetParent()
	{
		return mParent;
	}

	public void NewPos(in Vector3d pos)
	{
		mCenter = pos;
	...
	public void NewPosRadius(in Vector3d pos, float radius)
	{
		mCenter = pos;
	...
	public void AddChild(SpherePack pack)
	{
		...
		Debug.Assert(radius <= GetRadius() + 0.0001f);
#endif
	}

	public void SetNextSibling(SpherePack child)
	{
		mNextSibling = child;
	}
	public void SetPrevSibling(SpherePack child)
	{
		mPrevSibling = child;
	}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: SpherePack * _GetNextSibling() const
	public SpherePack _GetNextSibling()
	{
		return mNextSibling;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: SpherePack * _GetPrevSibling() const
	public SpherePack _GetPrevSibling()
	{
		return mPrevSibling;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: SpherePack * GetChildren() const
	public SpherePack GetChildren()
	{
		return mChildren;
	}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: SpherePack * GetNext() const
	public SpherePack GetNext()
	{
		return mNext;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: SpherePack * GetPrevious() const
	public SpherePack GetPrevious()
	{
		return mPrevious;
	}

	public void SetNext(SpherePack pack)
	{
		mNext = pack;
	}
	public void SetPrevious(SpherePack pack)
	{
		mPrevious = pack;
	}

//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: object* GetUserData() const
	public object GetUserData()
	{
		return mUserData;
	}
	public void SetUserData(object data, bool isSphere)
	{
		mUserData = data;
		IS_SPHERE = isSphere;
	}
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: float DistanceSquared(const SpherePack *pack) const
	public float DistanceSquared(SpherePack pack)
	{
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const Vector3d& GetPos() const
		...
		if (!HasSpherePackFlag(SPF_ROOTNODE))
		{
			...
			if (!sphere.IS_SPHERE)
			{
				puts("SpherePack::Render");
					...
					if (link != null && !link.HasSpherePackFlag(SPF_ROOTNODE))
					{
						DrawLine((int)mCenter.x, (int)mCenter.y, (int)link.mCenter.x, (int)link.mCenter.y, link.GetColor());
					}
				}
				else
				{
		...
		if (count != 0)
		{
...
#if __STATIC_RANGE__
			Debug.Assert(total.IsInStaticRange());
#endif
			mCenter = total;
			float maxradius = 0F;
			...
			while (pack != null)
			{
				...
				if (radius > maxradius)
				{
					...
					{
#if __STATIC_RANGE__
						Debug.Assert(oldpos.IsInStaticRange());
#endif
						mCenter = oldpos;
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: int GetChildCount() const
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: uint GetColor() const
	...
	public void SetFifo1(SpherePack[] fifo)
	{
		mFifo1 = fifo;
	}

	public void SetFifo2(SpherePack[] fifo)
	{
		mFifo2 = fifo;
	}
	...
	public void VisibilityTest(in Frustum f, SpherePackCallback callback, ViewState state)
	{
	...
	public void RayTrace(in Vector3d p1, in Vector3d dir, float distance, SpherePackCallback callback)
	{
		bool hit = false;
	...
	public void RangeTest(in Vector3d p, float distance, SpherePackCallback callback, ViewState state)
	{
	...
	public void PointTest2d(in Vector3d p, SpherePackCallback callback, ViewState state)
	{
		if (state == VS_PARTIAL)
		{
...
//			extern bool MAPOUTDOOR_GET_HEIGHT_TRACE;
	...
	private SpherePack mNext;
	private SpherePack mPrevious;

	private SpherePack mParent;
	private SpherePack mChildren;

	private SpherePack mNextSibling;
	private SpherePack mPrevSibling;

	private SpherePack[] mFifo1;
	private SpherePack[] mFifo2;
	...
	private SpherePackFactory mFactory;
#if DEMO
	private uint mColor;
#endif
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: int GetCount() const
	public int GetCount()
	{
		return mCount;
	}
...
public class SpherePackFactory : SpherePackCallback
{
	...
	public SpherePackFactory(int maxspheres, float rootsize, float leafsize, float gravy)
	{
		...
		mSpheres.Set(maxspheres);

		Vector3d p = new Vector3d(0,0,0);

		mRoot = mSpheres.GetFreeLink();
	...
	{
		{
			...
			for (int LaniatusDefVariables = 0; LaniatusDefVariables < maxrecompute; ++i)
			{
...

		{
			...
			for (int LaniatusDefVariables = 0; LaniatusDefVariables < maxintegrate; ++i)
			{
				...
				{
					Integrate(pack,mRoot,mMaxRootSize);
				}
				else
				{
					Integrate(pack,mLeaf,mMaxLeafSize);
				}
			}
		}
	...
	public SpherePack AddSphere_(in Vector3d pos, float radius, object userdata, bool isSphere, int flags = SPF_LEAF_TREE)
	{
		...
		if (pack != null)
		{
			if ((flags & SPF_ROOT_TREE) != 0)
			{
				pack.Init(this,pos,radius,userdata, isSphere);
				pack.SetSpherePackFlag(SPF_ROOT_TREE);
				AddIntegrate(pack);
			}
			else
			{
				pack.Init(this,pos,radius,userdata, isSphere);
				pack.SetSpherePackFlag(SPF_LEAF_TREE);
				AddIntegrate(pack);
			}
		}
	...
	public void AddIntegrate(SpherePack pack)
	{
		if (pack.HasSpherePackFlag(SPF_ROOT_TREE))
		{
			mRoot.AddChild(pack);
		...
		pack.SetSpherePackFlag(SPF_INTEGRATE);
		SpherePack[] fifo = mIntegrate.Push(pack);
		pack.SetFifo2(fifo);
	}

	public void AddRecompute(SpherePack recompute)
	{
		if (!recompute.HasSpherePackFlag(SPF_RECOMPUTE))
		{
			if (recompute.GetChildCount())
			{
				recompute.SetSpherePackFlag(SPF_RECOMPUTE);
	...
	public void Integrate(SpherePack pack, SpherePack supersphere, float node_size)
	{
		...
		SpherePack nearest1 = null;
		float neardist1 = 1e38f;

		SpherePack nearest2 = null;
		float neardist2 = 1e38f;
		...
		else
		{
			...
			if (newsphere)
			{
				Debug.Assert(supersphere.HasSpherePackFlag(SPF_ROOTNODE));
				pack.Unlink();
				...
				if (parent.HasSpherePackFlag(SPF_LEAF_TREE))
				{
					...
					parent.SetUserData(link, true);
				}

			}
		}

		pack.ClearSpherePackFlag(SPF_INTEGRATE);
	}
	...
	public void FrustumTest(in Frustum f, SpherePackCallback callback)
	{
		mCallback = callback;
		mRoot.VisibilityTest(f,this,VS_PARTIAL);
	}

	public void RayTrace(in Vector3d p1, in Vector3d p2, SpherePackCallback callback)
	{
	...
	public void RangeTest(in Vector3d center, float radius, SpherePackCallback callback)
	{
#if __STATIC_RANGE__
		if (!center.IsInStaticRange())
		{
			TraceError("SpherePackFactory::RangeTest - RANGE ERROR %f, %f, %f", center.x, center.y, center.z);
			Debug.Assert("SpherePackFactory::RangeTest - RANGE ERROR");
			return;
		}
#endif
		mCallback = callback;
	...
	public void PointTest2d(in Vector3d center, SpherePackCallback callback)
	{
#if __STATIC_RANGE__
		if (!center.IsInStaticRange())
		{
			TraceError("SpherePackFactory::RangeTest2d - RANGE ERROR %f, %f, %f", center.x, center.y, center.z);
			Debug.Assert("SpherePackFactory::RangeTest2d - RANGE ERROR");
			return;
		}
#endif
		mCallback = callback;
...
//		extern bool MAPOUTDOOR_GET_HEIGHT_TRACE;
	...
	public virtual void RangeTestCallback(in Vector3d p, float distance, SpherePack sphere, ViewState state)
	{
#if SPHERELIB_STRICT
		if (!sphere.IS_SPHERE)
		{
	...
	public virtual void PointTest2dCallback(in Vector3d p, SpherePack sphere, ViewState state)
	{
#if SPHERELIB_STRICT
		if (!sphere.IS_SPHERE)
		{
	...
	private SpherePack mRoot;
	private SpherePack mLeaf;
	private SpherePackCallback mCallback;

	private Pool< SpherePack > mSpheres = new Pool< SpherePack >();

	private SpherePackFifo mIntegrate;
	private SpherePackFifo mRecompute;

#if DEMO
	private const int MAXCOLORS = 12;
	private int mColorCount;
	private uint[] mColors = new uint[MAXCOLORS];
#endif

	private float mMaxRootSize;
	private float mMaxLeafSize;
	private float mSuperSphereGravy;
}