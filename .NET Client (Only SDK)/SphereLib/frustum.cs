...
{
		public void BuildViewFrustum(D3DXMATRIX mat)
		{
		...
		public void BuildViewFrustum2(D3DXMATRIX mat, float fNear, float fFar, float fFov, float fAspect, in D3DXVECTOR3 vCamera, in D3DXVECTOR3 vLook)
		{
			float fViewLen = fFar - fNear;
			float fH = fViewLen * Math.Tan(fFov * 0.5f);
			float fW = fH * fAspect;
			D3DXVECTOR3 P = new D3DXVECTOR3(0.0f, 0.0f, fNear + fViewLen * 0.5f);
			D3DXVECTOR3 Q = new D3DXVECTOR3(fW, fH, fViewLen);
			D3DXVECTOR3 PQ = P - Q;
...
//Original Metin2 CPlus Line: ViewState ViewVolumeTest(const Vector3d &c_v3Center, const float c_fRadius) const
		public ViewState ViewVolumeTest(in Vector3d c_v3Center, in float c_fRadius)
		{
			if (m_bUsingSphere)
			{
				D3DXVECTOR3 v = new D3DXVECTOR3(c_v3Center.x - m_v3Center.x, c_v3Center.y - m_v3Center.y, c_v3Center.z - m_v3Center.z);
		...
		private bool m_bUsingSphere;
		private D3DXVECTOR3 m_v3Center = new D3DXVECTOR3();
		private float m_fRadius;
		private D3DXPLANE[] m_plane = Arrays.InitializeWithDefaultInstances<D3DXPLANE>(6);
}