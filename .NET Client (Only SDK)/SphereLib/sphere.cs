...
//Original Metin2 CPlus Line: virtual int GetVertexCount() const = 0;
	public abstract int GetVertexCount();
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: virtual bool GetVertex(int i,Vector3d &vect) const = 0;
	public abstract bool GetVertex(int i, Vector3d vect);
}
...
public class Sphere
{
	public Sphere()
	{
		this.mCenter = Vector3d(0.0f, 0.0f, 0.0f);
		this.mRadius = 0.0f;
		this.mRadius2 = 0.0f;
	}

	public Sphere(in Vector3d center, float radius)
	{
		this.mCenter = center;
		this.mRadius = radius;
	...
	public void Set(in Vector3d center, float radius)
	{
#if __STATIC_RANGE__
		Debug.Assert(center.IsInStaticRange());
#endif
		mCenter = center;
		mRadius = radius;
	...
	public void Compute(in SphereInterface source)
	{
	  ...
	  xmin.Set(DefineConstants.BIGNUMBER,DefineConstants.BIGNUMBER,DefineConstants.BIGNUMBER);
	  xmax.Set(-DefineConstants.BIGNUMBER,-DefineConstants.BIGNUMBER,-DefineConstants.BIGNUMBER);
	  ymin.Set(DefineConstants.BIGNUMBER,DefineConstants.BIGNUMBER,DefineConstants.BIGNUMBER);
	  ymax.Set(-DefineConstants.BIGNUMBER,-DefineConstants.BIGNUMBER,-DefineConstants.BIGNUMBER);
	  zmin.Set(DefineConstants.BIGNUMBER,DefineConstants.BIGNUMBER,DefineConstants.BIGNUMBER);
	  zmax.Set(-DefineConstants.BIGNUMBER,-DefineConstants.BIGNUMBER,-DefineConstants.BIGNUMBER);
...
//Original Metin2 CPlus Line: xmin = caller_p;
			  xmin.CopyFrom(caller_p);
		  }
		  if (caller_p.GetX() > xmax.GetX())
		  {
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: xmax = caller_p;
			  xmax.CopyFrom(caller_p);
		  }
		  if (caller_p.GetY() < ymin.GetY())
		  {
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: ymin = caller_p;
			  ymin.CopyFrom(caller_p);
		  }
		  if (caller_p.GetY() > ymax.GetY())
		  {
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: ymax = caller_p;
			  ymax.CopyFrom(caller_p);
		  }
		  if (caller_p.GetZ() < zmin.GetZ())
		  {
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: zmin = caller_p;
			  zmin.CopyFrom(caller_p);
		  }
		  if (caller_p.GetZ() > zmax.GetZ())
		  {
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: zmax = caller_p;
			  zmax.CopyFrom(caller_p);
		  }
	  }
...
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: dia1 = xmin;
	  dia1.CopyFrom(xmin);
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: dia2 = xmax;
	  dia2.CopyFrom(xmax);
	  float maxspan = xspan;
	  ...
	  if (yspan > maxspan)
	  {
		  maxspan = yspan;
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: dia1 = ymin;
		  dia1.CopyFrom(ymin);
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: dia2 = ymax;
		  dia2.CopyFrom(ymax);
	  }
	  ...
	  {
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: dia1 = zmin;
		  dia1.CopyFrom(zmin);
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: dia2 = zmax;
		  dia2.CopyFrom(zmax);
	  }
	  ...
	  for (int j = 0; j < count; j++)
	  {
		...
		source.GetVertex(j,caller_p);
		  ...
		  {
			  float old_to_p = Math.Sqrt(old_to_p_sq);
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: float GetRadius() const
	public float GetRadius()
	{
		return mRadius;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: float GetRadius2() const
	public float GetRadius2()
	{
		return mRadius2;
	}
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: const Vector3d& GetCenter() const
	public Vector3d GetCenter()
	{
		return mCenter;
	}

	public bool RayIntersection(in Vector3d rayOrigin, in Vector3d V, float distance, Vector3d intersect)
	{
	  ...
	  if (hit)
	  {
		...
		{
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: *intersect = sect;
			intersect.CopyFrom(sect);
		}
		return true;
	  }
	  return false;
	...
	public bool RayIntersection(in Vector3d rayOrigin, in Vector3d dir, Vector3d intersect)
	{
...
//# Laniatus Games Studio Inc. | TODO TASK: The following line was determined to be a copy assignment (rather than a reference assignment) - this should be verified and a 'CopyFrom' method should be created:
//Original Metin2 CPlus Line: *intersect = rayOrigin + V*(v-d);
		  intersect.CopyFrom(rayOrigin + V * (v - d));
	...
	public bool RayIntersectionInFront(in Vector3d rayOrigin, in Vector3d V, Vector3d intersect)
	{
	  Vector3d sect = new Vector3d();
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool InSphereXY(const Vector3d &pos,float distance) const
	public bool InSphereXY(in Vector3d pos, float distance)
	{
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool InSphere(const Vector3d &pos,float distance) const
	public bool InSphere(in Vector3d pos, float distance)
	{
		float dx = pos.x - mCenter.x;
		float dy = pos.y - mCenter.y;
	...
	protected Vector3d mCenter = new Vector3d();
...
//# Laniatus Games Studio Inc. | WARN: 'const' methods are not available in C#:
//Original Metin2 CPlus Line: bool Vector3d::IsInStaticRange() const
