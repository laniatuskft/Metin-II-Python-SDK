...
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PyFrame_Check(op) ((op)->ob_type == &PyFrame_Type)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
//Original Metin2 CPlus Line: #define PyFrame_IsRestricted(f) ((f)->f_builtins != (f)->f_tstate->interp->builtins)
//# Laniatus Games Studio Inc. |: The following #define macro was replaced in-line:
...
public class CPythonLauncher : CSingleton<CPythonLauncher>
{
		public CPythonLauncher()
		{
			Py_Initialize();
		}
		...
		public bool Create(string c_szProgramName = "eter.python")
		{
			NANOBEGIN Py_SetProgramName = new NANOBEGIN((string)c_szProgramName);
#if DEBUG
			PyEval_SetTrace(TraceFunc, null);
#endif
			m_poModule = PyImport_AddModule((string) "__main__");
		...
		private delegate int pFuncDelegate(PyObject obj, PyFrameObject f, int what, PyObject arg);

		public void SetTraceFunc(pFuncDelegate pFunc)
		{
			PyEval_SetTrace(pFunc, null);
		}

		public bool RunLine(string c_szSrc)
		{
			PyObject v = PyRun_String((string) c_szSrc, Py_file_input, m_poDic, m_poDic);
		...
		public bool RunFile(string c_szFileName)
		{
			string acBufData = null;
			uint dwBufSize = 0;

			{
				...
				acBufData = new string(new char[dwBufSize - 1]);
//# Laniatus Games Studio Inc. | TODO TASK: The memory management function 'memcpy' has no equivalent in C#:
		...
		public bool RunMemoryTextFile(string c_szFileName, uint uFileSize, object c_pvFileData)
		{
			NANOBEGIN const char * c_pcFileData = (string)c_pvFileData;

			string stConvFileData = "";
...
//Original Metin2 CPlus Line: const char* c_pcConvFileData=stConvFileData.c_str();
			char c_pcConvFileData = stConvFileData;
			NANOEND return RunLine(c_pcConvFileData);
		}

		public bool RunCompiledFile(string c_szFileName)
		{
			NANOBEGIN FILE * fp = fopen(c_szFileName, "rb");
		...
		protected PyObject m_poModule;
		protected PyObject m_poDic;
}