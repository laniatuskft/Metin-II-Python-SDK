class DefineConstants:
    ALLOCATOR_DETAIL_HEADER = "fifo_allocator.h"
    DBGALLOC_LOG_FILENAME = "dbgalloc.log"
    DBGALLOC_REPORT_FILENAME = "dbgalloc_report.log"
    False = 0
    SIGUSR1 = 30
    SIGUSR2 = 31
    INVALID_SOCKET = -1
    ...
    MAX_EXP_DELTA_OF_LEV = 31
    ARROUND_COORD_MAX_NUM = 161
    CUBE_MAX_NUM = 24
    CUBE_MAX_DISTANCE = 1000
    MAX_EFFECT_FILE_NAME = 128
    MAX_ALLOW_USER = 4096
    MAX_INPUT_LEN = 65536
    HANDSHAKE_RETRY_LIMIT = 32
    MAX_BLEND_ITEM_VALUE = 5
    GUILD_SYMBOL_FILENAME = "guild_symbol.tga"
    POLYMORPH_LG_SKILL_ID = 129
    POLYMORPH_BOOK_ID = 50322
    MD5_HASHBYTES = 16
    MAX_REASON_LEN = 128
    MAX_STAT = 90
    OXEVENT_MAP_INDEX = 113
    DEFAULT_PACKET_BUFFER_SIZE = 65536
    SEQUENCE_MAX_NUM = 32768
    __MINILZO_H_INCLUDED = 1
    MINILZO_VERSION = 0x2090
    LZO1X_MEM_DECOMPRESS = 0
    MAPNAME_DEFAULT = "none"
    COMBO_HACK_ALLOWABLE_MS = 100
    LG_HEADER_CG_STATE_CHECKER = 1
    NUM_LOCALES = 2
    OLD_MARK_INDEX_FILENAME = "guild_mark.idx"
    OLD_MARK_DATA_FILENAME = "guild_mark.tga"
    __LZO_IN_MINILZO = 1
    LZO_LIBC_FREESTANDING = 1
    LZO_OS_FREESTANDING = 1
    __LZODEFS_H_INCLUDED = 1
    _ALL_SOURCE = 1
    ...
    LZO_0xffffUL = 65535
    LZO_0xffffffffUL = 4294967295
    LZO_CFG_USE_COUNTER = 1
    MSDOS = 1
    _MSDOS = 1
    __DOS__ = 1
    _PTRDIFF_T_DEFINED = 1
    __LZO_RENAME_A = 1
    __LZO_RENAME_B = 1
    LZO_BROKEN_CDECL_ALT_SYNTAX = 1
    LZO_BROKEN_INTEGRAL_CONSTANTS = 1
    LZO_BROKEN_INTEGRAL_PROMOTION = 1
    LZO_BROKEN_SIZEOF = 1
    LZO_BROKEN_SIGNED_RIGHT_SHIFT = 1
    __STDC_CONSTANT_MACROS = 1
    __STDC_LIMIT_MACROS = 1
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_INFO_OS = "freestanding"
    LZO_INFO_OS = "embedded"
    LZO_INFO_OS = "cygwin"
    LZO_INFO_OS = "emx"
    LZO_INFO_OS = "beos"
    LZO_INFO_OS = "lynxos"
    ...
    LZO_OS_VMS = 1
    LZO_OS_CONSOLE = 1
    LZO_OS_CONSOLE_PS2 = 1
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_INFO_OS_CONSOLE = "ps2"
    LZO_INFO_OS_CONSOLE = "psp"
    LZO_OS_CONSOLE_PSP = 1
    LZO_OS_POSIX_AIX = 1
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_INFO_OS_POSIX = "aix"
    LZO_INFO_OS_POSIX = "freebsd"
    LZO_INFO_OS_POSIX = "hpux"
    LZO_INFO_OS_POSIX = "interix"
    LZO_INFO_OS_POSIX = "irix"
    LZO_INFO_OS_POSIX = "linux"
    LZO_INFO_OS_POSIX = "darwin_iphone"
    LZO_INFO_OS_POSIX = "darwin"
    LZO_INFO_OS_POSIX = "minix"
    LZO_INFO_OS_POSIX = "netbsd"
    LZO_INFO_OS_POSIX = "openbsd"
    LZO_INFO_OS_POSIX = "osf"
    LZO_INFO_OS_POSIX = "solaris"
    LZO_INFO_OS_POSIX = "sunos"
    LZO_INFO_OS_POSIX = "ultrix"
    LZO_INFO_OS_POSIX = "unicos"
    LZO_INFO_OS_POSIX = "unknown"
    LZO_OS_POSIX_FREEBSD = 1
    LZO_OS_POSIX_HPUX = 1
    LZO_OS_POSIX_INTERIX = 1
    LZO_OS_POSIX_IRIX = 1
    LZO_OS_POSIX_LINUX = 1
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_OS_POSIX_DARWIN = 1040
    LZO_OS_POSIX_DARWIN = 1
    LZO_OS_POSIX_MINIX = 1
    LZO_OS_POSIX_NETBSD = 1
    LZO_OS_POSIX_OPENBSD = 1
    LZO_OS_POSIX_OSF = 1
    LZO_OS_POSIX_SOLARIS = 1
    LZO_OS_POSIX_SUNOS = 1
    LZO_OS_POSIX_ULTRIX = 1
    LZO_OS_POSIX_UNICOS = 1
    LZO_OS_POSIX_UNKNOWN = 1
    LZO_CC_CILLY = 1
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_INFO_CC = "Cilly"
    LZO_INFO_CC = "sdcc"
    LZO_INFO_CC = "Pathscale C"
    LZO_INFO_CC = "Intel C"
    LZO_INFO_CC = "Pelles C"
    LZO_INFO_CC = "ARM C Compiler"
    LZO_INFO_CC = "clang"
    LZO_INFO_CC = "llvm-gcc"
    LZO_INFO_CC = "Amsterdam Compiler Kit C"
    LZO_INFO_CC = "Aztec C"
    LZO_INFO_CC = "CodeGear C"
    LZO_INFO_CC = "Borland C"
    LZO_INFO_CC = "Cray C"
    LZO_INFO_CC = "Digital Mars C"
    LZO_INFO_CC = "DEC C"
    LZO_INFO_CC = "Green Hills C"
    LZO_INFO_CC = "MetaWare High C"
    LZO_INFO_CC = "HP aCC"
    LZO_INFO_CC = "IAR C"
    LZO_INFO_CC = "IBM C"
    LZO_INFO_CC = "Keil C"
    LZO_INFO_CC = "lcc-win32"
    LZO_INFO_CC = "lcc"
    LZO_INFO_CC = "Metrowerks C"
    LZO_INFO_CC = "Microway NDP C"
    LZO_INFO_CC = "Pacific C"
    LZO_INFO_CC = "Portland Group PGI C"
    LZO_INFO_CC = "Pure C"
    LZO_INFO_CC = "Symantec C"
    LZO_INFO_CC = "SunPro C"
    LZO_INFO_CC = "Tiny C"
    LZO_INFO_CC = "TopSpeed C"
    LZO_INFO_CC = "Watcom C"
    LZO_INFO_CC = "Turbo C"
    LZO_INFO_CC = "Zortech C"
    LZO_INFO_CC = "gcc"
    LZO_INFO_CC = "Microsoft C"
    LZO_INFO_CC = "unknown"
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_INFO_CCVER = "unknown"
    LZO_INFO_CCVER = "0x310"
    LZO_CC_SDCC = 1
    LZO_CC_PELLESC = 1
    LZO_CC_CLANG = 0x010000
    LZO_CC_ACK = 1
    LZO_CC_AZTECC = 1
    LZO_CC_CODEGEARC = 1
    LZO_CC_BORLANDC = 1
...
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    ...
    LZO_INFO_ARCH = "m32r"
    LZO_INFO_ARCH = "m68k"
    LZO_INFO_ARCH = "mcs251"
    LZO_INFO_ARCH = "mcs51"
    LZO_INFO_ARCH = "mips"
    LZO_INFO_ARCH = "msp430"
    LZO_INFO_ARCH = "powerpc"
    LZO_INFO_ARCH = "s390"
    LZO_INFO_ARCH = "sh"
    LZO_INFO_ARCH = "sparc"
    LZO_INFO_ARCH = "spu"
    LZO_INFO_ARCH = "z80"
    LZO_INFO_ARCH = "cray_sv1"
    LZO_INFO_ARCH = "cray_t90"
    LZO_INFO_ARCH = "cray_ymp"
    LZO_INFO_ARCH = "cray_xmp"
    LZO_INFO_ARCH = "unknown"
    LZO_ARCH_I086 = 1
    LZO_ARCH_ARM64 = 1
    LZO_ARCH_ALPHA = 1
    LZO_ARCH_AMD64 = 1
    ...
    LZO_ARCH_CRAY_XMP = 1
    LZO_ARCH_UNKNOWN = 1
    LZO_ARCH_ARM_THUMB2 = 1
    LZO_ARCH_I086PM = 1
    LZO_ARCH_X64 = 1
    LZO_ARCH_AARCH64 = 1
    LZO_ARCH_X86 = 1
    LZO_TARGET_FEATURE_SSE2 = 1
    LZO_TARGET_FEATURE_SSSE3 = 1
    LZO_TARGET_FEATURE_SSE4_2 = 1
    LZO_TARGET_FEATURE_AVX = 1
    LZO_TARGET_FEATURE_AVX2 = 1
    LZO_TARGET_FEATURE_NEON = 1
    LZO_MM_TINY = 1
    LZO_MM_HUGE = 1
    LZO_MM_SMALL = 1
    LZO_MM_MEDIUM = 1
    LZO_MM_COMPACT = 1
    LZO_MM_LARGE = 1
    LZO_HAVE_MM_HUGE_PTR = 1
    LZO_HAVE_MM_HUGE_ARRAY = 1
    LZO_MM_AHSHIFT = 12
    LZO_MM_XTINY = 1
    LZO_MM_XSMALL = 1
    LZO_MM_PVP = 1
...
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    ...
    lzo_has_extension = 0
## Laniatus Games Studio Inc. | ROLE FOR THE DEVELOPMENT DEPARTMENT: The following #define constant was defined in different ways:
    LZO_CFG_USE_NEW_STYLE_CASTS = 0
    LZO_CFG_USE_NEW_STYLE_CASTS = 1
    __lzo_HAVE_inline = 1
    __lzo_HAVE_forceinline = 1
    __lzo_HAVE_noinline = 1
    __lzo_HAVE_c99_extern_inline = 1
    __lzo_HAVE_may_alias = 1
    __lzo_HAVE_noreturn = 1
    __lzo_HAVE_nothrow = 1
    __lzo_HAVE_restrict = 1
    __lzo_HAVE_alignof = 1
    __lzo_HAVE_constructor = 1
    __lzo_HAVE_destructor = 1
    __lzo_HAVE_likely = 1
    __lzo_HAVE_very_likely = 1
    __lzo_HAVE_unlikely = 1
    __lzo_HAVE_very_unlikely = 1
    __lzo_HAVE_unreachable = 1
    IMAGEDESC_ORIGIN_MASK = 0x30
    IMAGEDESC_TOPLEFT = 0x20
    IMAGEDESC_BOTLEFT = 0x00
    IMAGEDESC_BOTRIGHT = 0x10
    IMAGEDESC_TOPRIGHT = 0x30